...
CssOverview.CSSOverviewCompletedView = class extends UI.PanelWithSidebar {
  constructor(controller, target) {
    ...
    this._mediaQueryGrid = new DataGrid.SortableDataGrid(ls`Media Query`, this._mediaQueryColumns);
    ...
    this._unusedRulesGrid = new DataGrid.SortableDataGrid(ls`Unused Rules`, this._unusedRulesColumns);
    ...
    this._elementGrid = new DataGrid.SortableDataGrid(ls`Element`, this._elementGridColumns);
