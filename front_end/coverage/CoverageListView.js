...
export function coverageTypeToString(type) {
  ...
  if (type & CoverageType.CSS) {
    types.push(i18n.i18n.getLocalizedString(str_, UIStrings.css));
  }
  if (type & CoverageType.JavaScriptPerFunction) {
    types.push(i18n.i18n.getLocalizedString(str_, UIStrings.jsPerFunction));
  } else if (type & CoverageType.JavaScript) {
    types.push(i18n.i18n.getLocalizedString(str_, UIStrings.jsPerBlock));
  }
  return types.join('+');
}
  ...
  createCell(columnId) {
    ...
    switch (columnId) {
      ...
      case 'size': {
        ...
        const sizeAccessibleName = (this._coverageInfo.size() === 1) ?
            ...
            i18n.i18n.getLocalizedString(
                str_, UIStrings.sBytes, {THIS__COVERAGEINFO_SIZE_______: this._coverageInfo.size() || 0});
      ...
      case 'unusedSize': {
        ...
        const unusedPercentFormatted = i18n.i18n.getLocalizedString(str_, UIStrings.percentPlaceholder, {
          THIS__PERCENTAGESTRING_THIS__COVERAGEINFO_UNUSEDPERCENTAGE___:
              this._percentageString(this._coverageInfo.unusedPercentage())
        });
        unusedPercentsSpan.textContent = unusedPercentFormatted;
        const unusedAccessibleName = (unusedSize === 1) ?
            i18n.i18n.getLocalizedString(str_, UIStrings.byteS, {UNUSEDPERCENTFORMATTED: unusedPercentFormatted}) :
            i18n.i18n.getLocalizedString(
                str_, UIStrings.sBytesS, {UNUSEDSIZE: unusedSize, UNUSEDPERCENTFORMATED: unusedPercentFormatted});
        ...
        if (this._coverageInfo.unusedSize() > 0) {
          ...
          if (this._coverageInfo.type() & CoverageType.JavaScriptPerFunction) {
            unusedSizeBar.title = i18n.i18n.getLocalizedString(
                str_, UIStrings.sBytesSBelongToFunctionsThatHave,
                {THIS__COVERAGEINFO_UNUSEDSIZE__: this._coverageInfo.unusedSize(), UNUSEDPERCENT: unusedPercent});
          } else if (this._coverageInfo.type() & CoverageType.JavaScript) {
            unusedSizeBar.title = i18n.i18n.getLocalizedString(
                str_, UIStrings.sBytesSBelongToBlocksOf,
                {THIS__COVERAGEINFO_UNUSEDSIZE__: this._coverageInfo.unusedSize(), UNUSEDPERCENT: unusedPercent});
          }
        }
        if (this._coverageInfo.usedSize() > 0) {
          ...
          if (this._coverageInfo.type() & CoverageType.JavaScriptPerFunction) {
            usedSizeBar.title = i18n.i18n.getLocalizedString(
                str_, UIStrings.sBytesSBelongToFunctionsThatHaveExecuted,
                {THIS__COVERAGEINFO_USEDSIZE__: this._coverageInfo.usedSize(), UNUSEDPERCENT: unusedPercent});
          } else if (this._coverageInfo.type() & CoverageType.JavaScript) {
            usedSizeBar.title = i18n.i18n.getLocalizedString(
                str_, UIStrings.sBytesSBelongToBlocksOfJavascript,
                {THIS__COVERAGEINFO_USEDSIZE__: this._coverageInfo.usedSize(), UNUSEDPERCENT: unusedPercent});
          }
        }
        this.setCellAccessibleName(
            i18n.i18n.getLocalizedString(
                str_, UIStrings.sOfFileUnusedSOfFileUsed, {UNUSEDPERCENT: unusedPercent, USEDPERCENT: usedPercent}),
            cell, columnId);
      }
    }
    return cell;
