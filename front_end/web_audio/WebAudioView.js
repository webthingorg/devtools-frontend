...
export class WebAudioView extends UI.ThrottledWidget {
  constructor() {
    ...
    this._contentContainer = this.contentElement.createChild('div', 'web-audio-content-container');

    // Creates the detail view.
    this._detailViewContainer = this._contentContainer.createChild('div', 'vbox flex-auto');
