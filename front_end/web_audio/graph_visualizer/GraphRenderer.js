...
export class GraphRenderer {
   ...
   * @param {?WebAudio.GraphVisualizer.GraphView} graph - The model of graph.
   */
  ...
  initialize() {
    WebAudio.GraphVisualizer.enablePanZoom(this.canvas);
  }
  ...
  zoomToFitAll() {
    ...
    const margin = WebAudio.GraphVisualizer.GraphStyles.GraphMargin;
    const zoomLevel =
    ...
    const zoomedPadding = WebAudio.GraphVisualizer.GraphStyles.GraphPadding * zoomLevel;
  ...
  _relayout() {
    ...
    WebAudio.GraphVisualizer
        .computeLayout(this.graph, {
          ...
          marginX: WebAudio.GraphVisualizer.GraphStyles.GraphPadding,
          marginY: WebAudio.GraphVisualizer.GraphStyles.GraphPadding,
          useWorker: true,
        })
  ...
  _render(layoutMetadata) {
    ...
    requestAnimationFrame(() => {
      ...
      WebAudio.GraphVisualizer.GraphRendererUtility.draw(this.canvas, this.graph);
    });
  }
}
 ...
 */
const computeLayout = (graph, option) => {
 ...
 * @return {!LayoutWorker}
 */
WebAudio.GraphVisualizer.getLayoutWorker = () => {
...
// reset it.
WebAudio.GraphVisualizer.minZoomLevel = 0.1;
WebAudio.GraphVisualizer.maxZoomLevel = 20;
WebAudio.GraphVisualizer.defaultMinZoomLevel = 0.1;
 ...
 * @constructor
 */
WebAudio.GraphVisualizer.GraphRenderer = GraphRenderer;

WebAudio.GraphVisualizer.computeLayout = computeLayout;
WebAudio.GraphVisualizer.getLayoutWorker = getLayoutWorker;
WebAudio.GraphVisualizer.enablePanZoom = enablePanZoom;
