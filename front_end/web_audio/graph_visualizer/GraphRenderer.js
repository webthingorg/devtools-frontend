...
WebAudio.GraphVisualizer.GraphRenderer = class {
  /**
 ...
 */
WebAudio.GraphVisualizer.computeLayout = (graph, option) => {
 ...
 * @return {!Object}
 */
function getLayoutMetadata(glGraph, graph, option) {
 ...
 */
WebAudio.GraphVisualizer.enablePanZoom = function(canvas) {
