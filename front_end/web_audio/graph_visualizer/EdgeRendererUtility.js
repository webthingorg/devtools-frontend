...
// Render edge onto Canvas.
WebAudio.GraphVisualizer.EdgeRendererUtility = {};
 ...
 * @return {!Fabric.Group}
 */
WebAudio.GraphVisualizer.EdgeRendererUtility.draw = (canvas, edge, graph, option) => {
 ...
 * @return {!Fabric.Group}
 */
WebAudio.GraphVisualizer.EdgeRendererUtility.update = (edgeGroup, edge, graph) => {
 ...
 * @return {number}
 */
WebAudio.GraphVisualizer.round = (x, precision) => {
 ...
 */
WebAudio.GraphVisualizer.roundPoint = (point, precision) => {
  const f = Math.pow(10, precision || 0);
 ...
 * @return {number}
 */
WebAudio.GraphVisualizer.calculateAngleRadian = (from, to) => {
  // Inverse y-axis.
 ...
 * @return {number}
 */
WebAudio.GraphVisualizer.calculateDistance = (p1, p2) => {
  const dx = p1.x - p2.x;
  const dy = p1.y - p2.y;
 ...
 * @return {!WebAudio.GraphVisualizer.Point}
 */
WebAudio.GraphVisualizer.getPointByDistance = (from, to, distance) => {
 ...
 * @return {!WebAudio.GraphVisualizer.Point}
 */
WebAudio.GraphVisualizer.getPointByRatio = (from, to, ratio) => {
  return {
