 ...
 * @return {!Fabric.Group}
 */
WebAudio.GraphVisualizer.NodeRendererUtility.update = (nodeGroup, node, graph) => {
  const size = node.size;
 ...
 */
WebAudio.GraphVisualizer.NodeRendererUtility.buildPortsConnectionInfo = (graph, node) => {
