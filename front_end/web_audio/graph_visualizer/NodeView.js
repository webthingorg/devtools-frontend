...
import {calculateParamPortXY, calculateInputPortXY, calculateOutputPortXY} from './NodeRendererUtility.js';
...
export class NodeView {
  ...
  _setupOutputPorts() {
    for (let i = 0; i < this.numberOfOutputs; i++) {
      ...
      const {x, y} =
          calculateOutputPortXY(i, this.size, this.numberOfOutputs);
