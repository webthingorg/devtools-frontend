...
export class DOMDebuggerModel extends SDKModel {
   ...
   * @return {?{type: !DOMBreakpoint.Type, node: !DOMNode, targetNode: ?SDK.DOMNode, insertion: boolean}}
   */
  resolveDOMBreakpointData(auxData) {
    ...
    let targetNode = null;
    let insertion = false;
    if (type === DOMBreakpoint.Type.SubtreeModified) {
  ...
  _documentUpdated() {
    ...
    /**
     * @param {!{type: !DOMBreakpoint.Type, enabled: boolean}} breakpoint
     * @param {?number} nodeId
