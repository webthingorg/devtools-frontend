...
export class OverlayModel extends SDKModel {
  ...
  highlightGridInPersistentOverlay(nodeId) {
    ...
    this.dispatchEventToListeners(Events.PersistentGridOverlayEnabled, nodeId);
  }
  ...
  hideGridInPersistentOverlay(nodeId) {
    ...
    this.dispatchEventToListeners(Events.PersistentGridOverlayDisabled, nodeId);
  }
...
export const Events = {
  ...
  PersistentGridOverlayEnabled: Symbol('PersistentGridOverlayEnabled'),
  PersistentGridOverlayDisabled: Symbol('PersistentGridOverlayDisabled'),
};
