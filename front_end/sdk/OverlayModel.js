...
class DefaultPersistentFlexHighlighter {
  ...
  _buildFlexContainerHighlightConfig(nodeId) {
    ...
    return {
      containerBorder: {color: {r: 127, g: 32, b: 210}, pattern: Protocol.Overlay.LineStylePattern.Dashed},
      itemSeparator: {color: {r: 127, g: 32, b: 210}, pattern: Protocol.Overlay.LineStylePattern.Dotted},
      lineSeparator: {color: {r: 127, g: 32, b: 210}, pattern: Protocol.Overlay.LineStylePattern.Dashed}
    };
  }
