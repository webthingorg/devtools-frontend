...
class DefaultPersistentGridHighlighter {
  ...
  _buildGridHighlightConfig() {
    const showGridBorder = true;
    const gridBorderDashed = true;
    const showGridLines = true;
    const gridLinesDashed = true;
    const showGridRowGaps = true;
    const showGridColumnGaps = true;
    ...
    const showNegativeLineNumbers = this._showGridLineLabelsSetting.get() === 'lineNumbers';
