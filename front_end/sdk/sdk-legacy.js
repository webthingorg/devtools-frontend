...
/** @type {function({target: !SDKModule.SDKModel.Target, waitingForDebugger: boolean})|undefined} */
SDK.ChildTargetManager._attachCallback;

/**
 * @type {!SDKModule.ConsoleModel.ConsoleModel}
 */
SDK.consoleModel;

/** @type {!SDKModule.DOMDebuggerModel.DOMDebuggerManager} */
self.SDK.domDebuggerManager;

/**
 * @type {!SDKModule.NetworkManager.MultitargetNetworkManager}
 */
