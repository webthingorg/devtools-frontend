...
/** @typedef {{location: ?SDKModule.DebuggerModel.Location, functionName: string}} */
SDK.DebuggerModel.FunctionDetails;

/** @typedef {{
 *    breakpointId: ?Protocol.Debugger.BreakpointId,
 *    locations: !Array<!SDKModule.DebuggerModel.Location>
 *  }}
 */
...
// FIXME: The ordering of the constructor invocations is important, as they
// rely on each other. For example, `SDK.consoleModel` depends on `SDk.targetManager`
