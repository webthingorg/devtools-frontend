...
export class SameSiteCookieIssue extends Issue {
  ...
  isCausedByThirdParty() {
    ...
    if (!topFrame || !this._issueDetails.cookieUrl) {
      return false;
    }

    const parsedCookieUrl = Common.ParsedURL.ParsedURL.fromString(this._issueDetails.cookieUrl);
    if (!parsedCookieUrl) {
      return false;
    }
    ...
    return !parsedCookieUrl.domain().includes(topFrame.domainAndRegistry);
  }
}
