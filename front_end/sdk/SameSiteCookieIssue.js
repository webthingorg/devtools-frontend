...
export class SameSiteCookieIssue extends Issue {
  ...
  /**
   * Calculates an issue code from a reason and an operation.
   * This is not done in the constructor as a single backend reported issue can result
   * in multiple frontend issues.
   *
...
const issueDescriptions = new Map([
  [
    'SameSiteCookieIssue::ExcludeSameSiteUnspecifiedTreatedAsLax::ReadCookie', {
      title: ls`A cookie was not sent, because the cookie's 'SameSite' attribute was defaulted 'SameSite=Lax'`,
      message: () => textMessageWithResolutions(
          ls
          `A cookie was defaulted to 'SameSite=Lax' because the cookie's 'SameSite' attribute was not set or invalid. This cookie was not sent because the default behavior for 'SameSite=Lax' prevents this cookie from beeing sent in cross-site requests.`,
          [
            ls`If this cookie is intended for third parties, mark the cookie as 'SameSite=None; Secure'.`,
            ls
            `If this cookie is not intended for third parties, consider explicitly marking the cookie as 'SameSite=Strict' or 'SameSite=Lax' to make your intent clear and provide a consistent experience across browsers.`,
          ]),
  ...
  [
    'SameSiteCookieIssue::WarnSameSiteNoneInsecure::SetCookie', {
      title: ls
      `A cookie will be blocked in a future version of Chrome, because the cookie specified 'SameSite=None' without 'Secure'`,
      message: () => textMessageWithResolutions(
          ls
