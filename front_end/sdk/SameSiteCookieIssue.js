...
const sameSiteUnspecifiedErrorSet = {
  title:
      ls`Indicate whether a cookie is inteded to be set in a cross-site context by specifying its SameSite attribute`,
  message: () => textMessageWithResolutions(
...
const sameSiteUnspecifiedWarnSet = {
  title: ls`Indicate whether a cookie is inteded to be set in cross-site context by specifying its SameSite attribute`,
  message: () => textMessageWithResolutions(
