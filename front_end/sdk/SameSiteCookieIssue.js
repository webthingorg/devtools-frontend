...
const resolutionsSet = [
  ls`Specify |SameSite=None| and |Secure| if the cookie is inteded to be set in cross-site contexts. Note that only cookies sent over HTTPS may use the |Secure| attribute.`,
