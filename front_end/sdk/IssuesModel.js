...
import {connect as connectWithIssue, disconnect as disconnectFromIssue} from './RelatedIssue.js';
    ...
    if (resources.requests) {
      for (const resourceRequest of resources.requests) {
        ...
        if (request) {
          ...
          connectWithIssue(request, issue.getCategory(), issue);
    ...
    if (resources.requests) {
      for (const resourceRequest of resources.requests) {
        ...
        if (request) {
          ...
          disconnectFromIssue(request, issue.getCategory(), issue);
        }
      }
    }
  }
