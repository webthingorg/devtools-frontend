...
const cspTrustedTypesSinkViolation = {
  ...
  links: [{
    ...
    linkTitle: ls`Learn more: Trusted Types - Fix violation`
  }],
};
...
const cspTrustedTypesPolicyViolation = {
  ...
  issueKind: IssueKind.BreakingChange,
  links: [{
    link: 'https://w3c.github.io/webappsec-trusted-types/dist/spec/#trusted-types-csp-directive',
    linkTitle: ls`Learn more: Trusted Types - Policy violation`
  }],
};
