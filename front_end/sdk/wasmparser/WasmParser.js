...
['i32.trunc_s:sat/f32', 'i32.trunc_u:sat/f32', 'i32.trunc_s:sat/f64', 'i32.trunc_u:sat/f64', 'i64.trunc_s:sat/f32',
 'i64.trunc_u:sat/f32', 'i64.trunc_s:sat/f64', 'i64.trunc_u:sat/f64']
    .forEach((s, i) => {
      OperatorCodeNames[0xfc00 | i] = s;
    });
['v128.load', 'v128.store', 'v128.const', 'v8x16.shuffle', 'i8x16.splat', 'i8x16.extract_lane_s',
 'i8x16.extract_lane_u', 'i8x16.replace_lane', 'i16x8.splat', 'i16x8.extract_lane_s', 'i16x8.extract_lane_u',
 'i16x8.replace_lane', 'i32x4.splat', 'i32x4.extract_lane', 'i32x4.replace_lane', 'i64x2.splat', 'i64x2.extract_lane',
 'i64x2.replace_lane', 'f32x4.splat', 'f32x4.extract_lane', 'f32x4.replace_lane', 'f64x2.splat', 'f64x2.extract_lane',
 'f64x2.replace_lane', 'i8x16.eq', 'i8x16.ne', 'i8x16.lt_s', 'i8x16.lt_u', 'i8x16.gt_s', 'i8x16.gt_u', 'i8x16.le_s',
 'i8x16.le_u', 'i8x16.ge_s', 'i8x16.ge_u', 'i16x8.eq', 'i16x8.ne', 'i16x8.lt_s', 'i16x8.lt_u', 'i16x8.gt_s',
 'i16x8.gt_u', 'i16x8.le_s', 'i16x8.le_u', 'i16x8.ge_s', 'i16x8.ge_u', 'i32x4.eq', 'i32x4.ne', 'i32x4.lt_s',
 'i32x4.lt_u', 'i32x4.gt_s', 'i32x4.gt_u', 'i32x4.le_s', 'i32x4.le_u', 'i32x4.ge_s', 'i32x4.ge_u', undefined, null,
 null, null, null, null, null, null, null, null, 'f32x4.eq', 'f32x4.ne', 'f32x4.lt', 'f32x4.gt', 'f32x4.le', 'f32x4.ge',
 'f64x2.eq', 'f64x2.ne', 'f64x2.lt', 'f64x2.gt', 'f64x2.le', 'f64x2.ge', 'v128.not', 'v128.and', 'v128.or', 'v128.xor',
 'v128.bitselect', 'i8x16.neg', 'i8x16.any_true', 'i8x16.all_true', 'i8x16.shl', 'i8x16.shr_s', 'i8x16.shr_u',
 'i8x16.add', 'i8x16.add_saturate_s', 'i8x16.add_saturate_u', 'i8x16.sub', 'i8x16.sub_saturate_s',
 'i8x16.sub_saturate_u', 'i8x16.mul', null, null, null, null, 'i16x8.neg', 'i16x8.any_true', 'i16x8.all_true',
 'i16x8.shl', 'i16x8.shr_s', 'i16x8.shr_u', 'i16x8.add', 'i16x8.add_saturate_s', 'i16x8.add_saturate_u', 'i16x8.sub',
 'i16x8.sub_saturate_s', 'i16x8.sub_saturate_u', 'i16x8.mul', null, null, null, null, 'i32x4.neg', 'i32x4.any_true',
 'i32x4.all_true', 'i32x4.shl', 'i32x4.shr_s', 'i32x4.shr_u', 'i32x4.add', null, null, 'i32x4.sub', null, null,
 'i32x4.mul', null, null, null, null, 'i64x2.neg', 'i64x2.any_true', 'i64x2.all_true', 'i64x2.shl', 'i64x2.shr_s',
 'i64x2.shr_u', 'i64x2.add', null, null, 'i64x2.sub', null, null, null, null, null, null, null, 'f32x4.abs',
 'f32x4.neg', 'f32x4.sqrt', null, null, 'f32x4.add', 'f32x4.sub', 'f32x4.mul', 'f32x4.div', 'f32x4.min', 'f32x4.max',
 'f64x2.abs', 'f64x2.neg', 'f64x2.sqrt', null, null, 'f64x2.add', 'f64x2.sub', 'f64x2.mul', 'f64x2.div', 'f64x2.min',
 'f64x2.max', 'i32x4.trunc_s/f32x4:sat', 'i32x4.trunc_u/f32x4:sat', 'i64x2.trunc_s/f64x2:sat',
 'i64x2.trunc_u/f64x2:sat', 'f32x4.convert_s/i32x4', 'f32x4.convert_u/i32x4', 'f64x2.convert_s/i64x2',
 'f64x2.convert_u/i64x2']
    .forEach((s, i) => {
      OperatorCodeNames[0xfd00 | i] = s;
    });
['atomic.wake', 'i32.atomic.wait', 'i64.atomic.wait', undefined, undefined, undefined, undefined, undefined, undefined,
 undefined, undefined, undefined, undefined, undefined, undefined, undefined, 'i32.atomic.load', 'i64.atomic.load',
 'i32.atomic.load8_u', 'i32.atomic.load16_u', 'i64.atomic.load8_u', 'i64.atomic.load16_u', 'i64.atomic.load32_u',
 'i32.atomic.store', 'i64.atomic.store', 'i32.atomic.store8', 'i32.atomic.store16', 'i64.atomic.store8',
 'i64.atomic.store16', 'i64.atomic.store32', 'i32.atomic.rmw.add', 'i64.atomic.rmw.add', 'i32.atomic.rmw8_u.add',
 'i32.atomic.rmw16_u.add', 'i64.atomic.rmw8_u.add', 'i64.atomic.rmw16_u.add', 'i64.atomic.rmw32_u.add',
 'i32.atomic.rmw.sub', 'i64.atomic.rmw.sub', 'i32.atomic.rmw8_u.sub', 'i32.atomic.rmw16_u.sub', 'i64.atomic.rmw8_u.sub',
 'i64.atomic.rmw16_u.sub', 'i64.atomic.rmw32_u.sub', 'i32.atomic.rmw.and', 'i64.atomic.rmw.and',
 'i32.atomic.rmw8_u.and', 'i32.atomic.rmw16_u.and', 'i64.atomic.rmw8_u.and', 'i64.atomic.rmw16_u.and',
 'i64.atomic.rmw32_u.and', 'i32.atomic.rmw.or', 'i64.atomic.rmw.or', 'i32.atomic.rmw8_u.or', 'i32.atomic.rmw16_u.or',
 'i64.atomic.rmw8_u.or', 'i64.atomic.rmw16_u.or', 'i64.atomic.rmw32_u.or', 'i32.atomic.rmw.xor', 'i64.atomic.rmw.xor',
 'i32.atomic.rmw8_u.xor', 'i32.atomic.rmw16_u.xor', 'i64.atomic.rmw8_u.xor', 'i64.atomic.rmw16_u.xor',
 'i64.atomic.rmw32_u.xor', 'i32.atomic.rmw.xchg', 'i64.atomic.rmw.xchg', 'i32.atomic.rmw8_u.xchg',
 'i32.atomic.rmw16_u.xchg', 'i64.atomic.rmw8_u.xchg', 'i64.atomic.rmw16_u.xchg', 'i64.atomic.rmw32_u.xchg',
 'i32.atomic.rmw.cmpxchg', 'i64.atomic.rmw.cmpxchg', 'i32.atomic.rmw8_u.cmpxchg', 'i32.atomic.rmw16_u.cmpxchg',
 'i64.atomic.rmw8_u.cmpxchg', 'i64.atomic.rmw16_u.cmpxchg', 'i64.atomic.rmw32_u.cmpxchg']
    .forEach((s, i) => {
...
export class Int64 {
  ...
  toString() {
    let low = (this._data[0] | (this._data[1] << 8) | (this._data[2] << 16) | (this._data[3] << 24)) >>> 0;
    let high = (this._data[4] | (this._data[5] << 8) | (this._data[6] << 16) | (this._data[7] << 24)) >>> 0;
    if (low === 0 && high === 0) {
      return '0';
    }
    let sign = false;
    ...
    const buf = [];
    while (high > 0) {
      const t = ((high % 10) * 4294967296) + low;
...
export class BinaryReader {
  ...
  readUint16() {
    const b1 = this._data[this._pos++];
    const b2 = this._data[this._pos++];
    return b1 | (b2 << 8);
  }
  readInt32() {
    const b1 = this._data[this._pos++];
    const b2 = this._data[this._pos++];
    const b3 = this._data[this._pos++];
    const b4 = this._data[this._pos++];
  ...
  peekInt32() {
    const b1 = this._data[this._pos];
    const b2 = this._data[this._pos + 1];
    const b3 = this._data[this._pos + 2];
    const b4 = this._data[this._pos + 3];
    return b1 | (b2 << 8) | (b3 << 16) | (b4 << 24);
  }
  peekUint32() {
  ...
  readStringBytes() {
    const length = this.readVarUint32() >>> 0;
    return this.readBytes(length);
  }
  readBytes(length) {
    const result = this._data.subarray(this._pos, this._pos + length);
    this._pos += length;
  ...
  hasStringBytes() {
    ...
    const pos = this._pos;
    const length = this.readVarUint32() >>> 0;
    const result = this.hasBytes(length);
    this._pos = pos;
    return result;
  }
  hasSectionPayload() {
  ...
  readFuncType() {
    ...
    const paramCount = this.readVarUint32() >>> 0;
    const paramTypes = new Int8Array(paramCount);
    for (var i = 0; i < paramCount; i++) {
      paramTypes[i] = this.readVarInt7();
    }
    const returnCount = this.readVarUint1();
    const returnTypes = new Int8Array(returnCount);
    for (var i = 0; i < returnCount; i++) {
      returnTypes[i] = this.readVarInt7();
    }
    return {form: form, params: paramTypes, returns: returnTypes};
  }
  readResizableLimits(maxPresent) {
    const initial = this.readVarUint32() >>> 0;
    let maximum;
    if (maxPresent) {
  ...
  readTableType() {
    ...
    const flags = this.readVarUint32() >>> 0;
    const limits = this.readResizableLimits(!!(flags & 0x01));
  ...
  readGlobalType() {
    ...
    const pos = this._pos;
    const contentType = this.readVarInt7();
    if (!this.hasVarIntBytes()) {
      this._pos = pos;
      return null;
    }
    const mutability = this.readVarUint1();
  ...
  readImportEntry() {
    ...
    const module = this.readStringBytes();
    const field = this.readStringBytes();
    ...
    this.result = {module: module, field: field, kind: kind, funcTypeIndex: funcTypeIndex, type: type};
    this._sectionEntriesLeft--;
    return true;
  }
  readExportEntry() {
    ...
    const field = this.readStringBytes();
    const kind = this.readUint8();
    const index = this.readVarUint32() >>> 0;
  ...
  readFunctionEntry() {
    ...
    const typeIndex = this.readVarUint32() >>> 0;
  ...
  readDataEntryBody() {
    ...
    this.result = {data: this.readStringBytes()};
    return true;
  }
  ...
  readMemoryImmediate() {
    const flags = this.readVarUint32() >>> 0;
    const offset = this.readVarUint32() >>> 0;
  ...
  readNameMap() {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const name = this.readStringBytes();
  ...
  readNameEntry() {
    ...
    const type = this.readVarUint7();
    if (!this.hasVarIntBytes()) {
      this._pos = pos;
      return false;
    }
    const payloadLength = this.readVarUint32();
    ...
    switch (type) {
      case 0 /* Module */:
        result = {type: type, moduleName: this.readStringBytes()};
        break;
      case 1 /* Function */:
        result = {type: type, names: this.readNameMap()};
        break;
      case 2 /* Local */:
        ...
        for (let i = 0; i < funcsLength; i++) {
          ...
          funcs.push({index: funcIndex, locals: this.readNameMap()});
        }
        result = {type: type, funcs: funcs};
        break;
      default:
  ...
  readLinkingEntry() {
    ...
    const pos = this._pos;
    const type = this.readVarUint32() >>> 0;
    let index;
    switch (type) {
      case 1 /* StackPointer */:
        if (!this.hasVarIntBytes()) {
  ...
  readSourceMappingURL() {
    ...
    const url = this.readStringBytes();
  ...
  readRelocEntry() {
    ...
    this.result = {type: type, offset: offset, index: index, addend: addend};
    this._sectionEntriesLeft--;
    return true;
  }
  readCodeOperator_0xfc() {
    const code = this._data[this._pos++] | 0xfc00;
    switch (code) {
  ...
  readCodeOperator_0xfd() {
    ...
    const code = this._data[this._pos++] | 0xfd00;
    let memoryAddress;
    let literal;
    let lineIndex;
    let lines;
  ...
  readCodeOperator_0xfe() {
    ...
    const code = this._data[this._pos++] | 0xfe00;
    let memoryAddress;
    switch (code) {
  ...
  readCodeOperator() {
    if (this.state === 30 /* CODE_OPERATOR */ && this._pos >= this._functionRange.end) {
      this.skipFunctionBody();
      return this.read();
    } else if (this.state === 26 /* INIT_EXPRESSION_OPERATOR */ && this.result && this.result.code === 11 /* end */) {
    ...
    const code = this._data[this._pos++];
    let blockType, brDepth, brTable, funcIndex, typeIndex, localIndex, globalIndex, memoryAddress, literal, reserved;
    switch (code) {
      case 2 /* block */:
      case 3 /* loop */:
      case 4 /* if */:
  ...
  readFunctionBody() {
    ...
    const pos = this._pos;
    const size = this.readVarUint32() >>> 0;
    const bodyEnd = this._pos + size;
    if (!this.hasVarIntBytes()) {
      this._pos = pos;
      return false;
    }
    const localCount = this.readVarUint32() >>> 0;
    const locals = [];
    for (let i = 0; i < localCount; i++) {
      ...
      const count = this.readVarUint32() >>> 0;
      if (!this.hasVarIntBytes()) {
        this._pos = pos;
        return false;
      }
  ...
  readSectionHeader() {
    ...
    if (this._pos < this._length - 4) {
      const magicNumber = this.peekInt32();
    ...
    const sectionStart = this._pos;
    const id = this.readVarUint7();
    if (!this.hasVarIntBytes()) {
      this._pos = sectionStart;
      return false;
    }
    const payloadLength = this.readVarUint32() >>> 0;
    let name = null;
    const payloadEnd = this._pos + payloadLength;
    if (id == 0) {
      if (!this.hasStringBytes()) {
        this._pos = sectionStart;
        return false;
  ...
  readSectionRawData() {
    const payloadLength = this._sectionRange.end - this._sectionRange.start;
    if (!this.hasBytes(payloadLength)) {
      return false;
    }
  ...
  readSectionBody() {
    ...
    const currentSection = this.result;
  ...
  skipSection() {
    if (this.state === -1 /* ERROR */ || this.state === 0 /* INITIAL */ || this.state === 4 /* END_SECTION */ ||
        this.state === 1 /* BEGIN_WASM */ || this.state === 2 /* END_WASM */) {
      return;
    }
    this.state = 5 /* SKIPPING_SECTION */;
  }
  skipFunctionBody() {
    if (this.state !== 28 /* BEGIN_FUNCTION_BODY */ && this.state !== 30 /* CODE_OPERATOR */) {
      return;
    }
...
if (!bytesToString) {
  bytesToString = b => {
    const str = String.fromCharCode.apply(null, b);
...
SDK.WasmParser = {};
SDK.WasmParser.BinaryReader = BinaryReader;
