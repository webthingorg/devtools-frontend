...
export class OverlayPersistentHighlighter {
  ...
  /**
   *
   * @param {!Map<number, !Protocol.Overlay.GridHighlightConfig>|!Map<number, !Protocol.Overlay.FlexContainerHighlightConfig>|!!Map<number, !Protocol.Overlay.ScrollSnapContainerHighlightConfig>} highlights
