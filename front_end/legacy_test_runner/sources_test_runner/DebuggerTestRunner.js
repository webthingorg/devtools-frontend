...
SourcesTestRunner.waitUntilPausedAndDumpStackAndResume = function(callback, options) {
  ...
  TestRunner.addSniffer(
      SourcesModule.SourcesPanel.SourcesPanel.prototype, 'updateDebuggerButtonsAndStatusForTest', setStatus);
  let caption;
  let callFrames;
  let asyncStackTrace;
...
SourcesTestRunner.waitForScriptSource = function(scriptName, callback, contentType) {
  ...
  TestRunner.addSniffer(
      SourcesModule.SourcesView.SourcesView.prototype, 'addUISourceCode',
...
SourcesTestRunner.scopeChainSections = function() {
  return SourcesModule.ScopeChainSidebarPane.ScopeChainSidebarPane.instance().treeOutline.rootElement().children();
};
...
SourcesTestRunner.debuggerPlugin = function(sourceFrame) {
  return sourceFrame.plugins.find(plugin => plugin instanceof SourcesModule.DebuggerPlugin.DebuggerPlugin);
};
