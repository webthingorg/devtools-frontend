...
/**
 * @param {!SourcesModule.NavigatorView.NavigatorView} navigatorView
...
SourcesTestRunner.dumpNavigatorView = function(navigatorView, dumpIcons) {
  ...
  function dumpNavigatorTreeElement(prefix, treeElement) {
    ...
    if (treeElement.nodeType === SourcesModule.NavigatorView.NavigatorView.Types.FileSystem ||
        treeElement.nodeType === SourcesModule.NavigatorView.NavigatorView.Types.FileSystemFolder) {
...
/**
 * @param {!SourcesModule.NavigatorView.NavigatorView} view
 */
...
SourcesTestRunner.dumpNavigatorViewInMode = function(view, mode) {
  TestRunner.addResult(
      view instanceof SourcesModule.SourcesNavigator.NetworkNavigatorView ? 'Sources:' : 'Content Scripts:');
