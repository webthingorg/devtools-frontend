...
BindingsTestRunner.AutomappingTest = function(workspace) {
  ...
  this.automapping =
      new Persistence.Automapping(this.workspace, this.onStatusAdded.bind(this), this.onStatusRemoved.bind(this));
  TestRunner.addSniffer(this.automapping, 'onBindingFailedForTest', this.onBindingFailed.bind(this), true);
  TestRunner.addSniffer(this.automapping, 'onSweepHappenedForTest', this.onSweepHappened.bind(this), true);
};
