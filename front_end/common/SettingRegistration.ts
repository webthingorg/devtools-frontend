...
export const SettingCategoryObject = {
  ...
  APPEARANCE: i18nLazyString(UIStrings.appearance),
  ...
  PERSISTENCE: i18nLazyString(UIStrings.persistence),
  DEBUGGER: i18nLazyString(UIStrings.debugger),
  GLOBAL: i18nLazyString(UIStrings.global),
  RENDERING: i18nLazyString(UIStrings.rendering),
  GRID: i18nLazyString(UIStrings.grid),
  MOBILE: i18nLazyString(UIStrings.mobile),
  EMULATION: i18nLazyString(UIStrings.emulation),
