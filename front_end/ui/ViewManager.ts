...
export class ViewManager {
  ...
  async resolveLocation(location?: string): Promise<_Location | null> {
    if (!location) {
      return /** @type {!Promise<?_Location>} */ Promise.resolve(null) as Promise<_Location | null>;
    }
    ...
    if (registeredResolvers.length) {
      ...
      return /** @type {?_Location} */ resolver.resolveLocation(location) as _Location | null;
    }
...
export class _ExpandableContainerWidget extends VBox {
  ...
  constructor(view: View) {
    ...
    this.registerRequiredCSS('ui/viewContainers.css', { enableLegacyPatching: false });
...
class _Location {
  ...
  showView(view: View, insertBefore?: View | null, userGesture?: boolean, omitFocus?: boolean, shouldSelectTab?: boolean): Promise<void> {
...
export class _TabbedLocation extends _Location implements TabbedViewLocation {
  ...
  async showView(view: View, insertBefore?: View | null, userGesture?: boolean, omitFocus?: boolean, shouldSelectTab: boolean | undefined = true): Promise<void> {
...
class _StackLocation extends _Location implements ViewLocation {
  ...
  appendView(view: View, insertBefore?: View | null): void {
    ...
    if (!container) {
      ...
      let beforeElement: (import("/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/ui/Widget").WidgetElement | null) | null = null;
      if (insertBefore) {
