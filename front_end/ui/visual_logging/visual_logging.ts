...
import type * as Common from '../../core/common/common.js'; // eslint-disable-line @typescript-eslint/no-unused-vars
import type * as UI from '../legacy/legacy.js';             // eslint-disable-line @typescript-eslint/no-unused-vars
 ...
 *
 * Ideally the `action`s context should match the ID of an {@link UI.ActionRegistration.Action}.
 */
 ...
 * inputs fields.
 *
 * For text fields that control {@link Common.Settings.Setting}s, make sure to use the name of the
 ...
 *
 * For toggles that control {@link Common.Settings.Setting}s, make sure to use the name of the
