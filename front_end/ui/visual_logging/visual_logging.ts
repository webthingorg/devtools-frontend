...
const colorCode = LoggingConfig.makeConfigStringBuilder.bind(null, 'colorCode');
...
const paletteColor = LoggingConfig.makeConfigStringBuilder.bind(null, 'paletteColor');
