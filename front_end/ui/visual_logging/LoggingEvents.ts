...
export function logClick(loggable: Loggable, event: Event, options?: {doubleClick?: boolean}): void {
  void (async () => {
    const loggingState = getLoggingState(loggable);
    if (!loggingState) {
      return;
...
export function logKeyDown(
    event: Event|null, context?: string, codes?: string[], keyboardLogThrottler?: Common.Throttler.Throttler): void {
  void (async () => {
