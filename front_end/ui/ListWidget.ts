...
export class Editor {
  ...
  control(name: string): HTMLInputElement | HTMLSelectElement {
    return /** @type {!HTMLInputElement|!HTMLSelectElement} */ this._controlByName.get(name) as HTMLInputElement | HTMLSelectElement;
  }
