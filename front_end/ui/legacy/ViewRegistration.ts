...
const UIStrings = {
  /**
   *@description The tag for the location Element.
   */
  elements: 'Elements',
  /**
   *@description The tag for the location Drawer.
   */
  drawer: 'Drawer',
  /**
   *@description The tag for the location Drawer sidebar.
   */
  drawer_sidebar: 'Drawer sidebar',
  /**
   *@description The tag for the location Pannel.
   */
  panel: 'Panel',
  /**
   *@description The tag for the location Network.
   */
  network: 'Network',
  /**
   *@description The tag for the location Settings.
   */
  settings: 'Settings',
  /**
   *@description The tag for the location Sources.
   */
  sources: 'Sources',
};
...
export function getLocalizedViewLocationCategory(category: ViewLocationCategory): string|
