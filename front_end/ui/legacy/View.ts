...
export class SimpleView extends VBox implements View {
  ...
  readonly #viewId: Platform.StringUtilities.KebabString;

  constructor(
      title: Platform.UIString.LocalizedString, isWebComponent?: boolean,
      viewId?: Platform.StringUtilities.KebabString) {
