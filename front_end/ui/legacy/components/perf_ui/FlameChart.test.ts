    ...
    describe('coordinatesToGroupIndexAndHoverType', () => {
      ...
      it('returns the correct group index and the icon type for given coordinates', () => {
        ...
        assert.deepEqual(
            ...
            {groupIndex: 0, hoverType: PerfUI.FlameChart.HoverType.EDIT_BUTTON});
        ...
        assert.deepEqual(
            chartInstance.coordinatesToGroupIndexAndHoverType(/* HEADER_LEFT_PADDING */ 6, 17),
            {groupIndex: 0, hoverType: PerfUI.FlameChart.HoverType.UP_BUTTON});
        // Second icon (Down)
        assert.deepEqual(
            chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE */ 22, 17),
            {groupIndex: 0, hoverType: PerfUI.FlameChart.HoverType.DOWN_BUTTON});
        // Third icon (Hide)
        assert.deepEqual(
            chartInstance.coordinatesToGroupIndexAndHoverType(
                /* HEADER_LEFT_PADDING + EDIT_BUTTON_SIZE * 2 */ 38, 17),
            {groupIndex: 0, hoverType: PerfUI.FlameChart.HoverType.HIDE_BUTTON});
        ...
        assert.deepEqual(
            ...
            {groupIndex: 0, hoverType: PerfUI.FlameChart.HoverType.SAVE_BUTTON});
