...
describeWithEnvironment('FilmStripView', function() {
  ...
  it('generates frames and timestamps', async function() {
    ...
    const filmStrip = await renderView(Trace.Extras.FilmStrip.fromTraceData(parsedTrace));
  ...
  describe('FilmStripView Dialog', function() {
    async function renderDialogWithTraceEngine(filmStrip: Trace.Extras.FilmStrip.Data, selectedFrameIndex: number):
