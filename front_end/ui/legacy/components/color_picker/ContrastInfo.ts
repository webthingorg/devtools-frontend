...
export class ContrastInfo extends Common.ObjectWrapper.ObjectWrapper<EventTypes> {
  ...
  private colorFormatInternal: Common.Color.ColorType|undefined;
  ...
  setColor(fgColor: Common.Color.Legacy, colorFormat?: Common.Color.ColorType): void {
  ...
  colorFormat(): Common.Color.ColorType|undefined {
