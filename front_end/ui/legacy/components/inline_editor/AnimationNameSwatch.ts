...
export class AnimationNameSwatch extends HTMLElement {
  static readonly litTagName = LitHtml.literal`devtools-animationname-swatch`;
...
ComponentHelpers.CustomElements.defineComponent('devtools-animationname-swatch', AnimationNameSwatch);

declare global {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  interface HTMLElementTagNameMap {
    'devtools-animationname-swatch': AnimationNameSwatch;
  }
}
