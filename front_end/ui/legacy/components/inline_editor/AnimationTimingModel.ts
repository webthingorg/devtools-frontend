...
export type AnimationTimingModel = CSSLinearEasingModel|UI.Geometry.CubicBezier;

export namespace AnimationTimingModel {
  export function parse(text: string): AnimationTimingModel|null {
