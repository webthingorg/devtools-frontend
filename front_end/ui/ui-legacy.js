...
UI.ARIAUtils = UIModule.ARIAUtils.ARIAUtils;
...
UI.Fragment._textMarker = UIModule.Fragment._textMarker;
UI.Fragment._attributeMarker = UIModule.Fragment._attributeMarker;
 ...
 * @type {number}
 */
UI.Geometry._Eps = UIModule.Geometry._Eps;
...
/** @type {!Set<!GlassPane>} */
UI.GlassPane._panes = UIModule.GlassPane._panes;
...
UI.Tooltip._symbol = UIModule.Tooltip._symbol;
...
UI.measuredScrollbarWidth = UIModule.UIUtils.measuredScrollbarWidth;
UI.createShadowRootWithCoreStyles = UIModule.UIUtils.createShadowRootWithCoreStyles;
...
UI.registerCustomElement = UIModule.UIUtils.registerCustomElement;
...
UI.appendStyle = UIModule.UIUtils.appendStyle;
...
/** @public */
UI.View.widgetSymbol = UIModule.View._widgetSymbol;
...
/** @constructor */
UI.ViewManager._ContainerWidget = UIModule.ViewManager._ContainerWidget;

/** @constructor */
UI.ViewManager._ExpandableContainerWidget = UIModule.ViewManager._ExpandableContainerWidget;

/** @constructor */
UI.ViewManager._TabbedLocation = UIModule.ViewManager._TabbedLocation;
