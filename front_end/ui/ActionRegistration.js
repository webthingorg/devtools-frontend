...
export class PreRegisteredAction extends Common.ObjectWrapper.ObjectWrapper {
  ...
  constructor(actionRegistration) {
    ...
    /** @type {boolean} */
    this._toggled = false;
    /** @type {!Array<function(new:Object, ...*):void>} */
    this._contextTypes = [];
  }
  ...
  /**
   * @return {!Array<function(new:Object, ...*):void>}
   */
  contextTypes() {
  ...
  /**
 * @param {!Array<function(new:Object, ...*):void>} contextTypes
 */
  addContextTypes(contextTypes) {
    this._contextTypes = [...this._contextTypes, ...contextTypes];
  }
  /**
   * @return {boolean}
   */
