...
// The first typedef is to properly support the 'optional' properties of Descriptor in TypeScript.
// The second typedef is for closure, as it is the only form of @typedef that Closure supports.
// @ts-ignore
