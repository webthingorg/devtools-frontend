...
export class Tooltip {
  ...
  constructor(doc: Document) {
    ...
    this._shadowRoot = createShadowRootWithCoreStyles(this.element, { cssFile: 'ui/tooltip.css', enableLegacyPatching: true, delegatesFocus: undefined });
    this._tooltipElement = (this._shadowRoot.createChild('div', 'tooltip') as HTMLElement);
  ...
  static install(element: Element, tooltipContent: string | Element | null, actionId?: string, options?: TooltipOptions | null): void {
    ...
    element.addEventListener('focus', /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ (/** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ /** @param {!Event} event */ event: Event) => {
      // @ts-ignore crbug.com/1150762: HTMLElement#title magic override.
