...
export class ListControl {
  ...
  constructor(model, delegate, mode) {
    ...
    this._model = model;
    this._model.addEventListener(Events.ItemsReplaced, this._replacedItemsInRange, this);
    /** @type {!Map<T, !Element>} */
  ...
  setModel(model) {
    ...
    this._model.removeEventListener(Events.ItemsReplaced, this._replacedItemsInRange, this);
    this._model = model;
    this._model.addEventListener(Events.ItemsReplaced, this._replacedItemsInRange, this);
