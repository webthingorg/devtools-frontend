...
import {ActionRegistry, Binding} from './ActionRegistry.js';  // eslint-disable-line no-unused-vars
import {getRegisteredActionExtensions} from './ActionRegistryUtils';
  ...
  _registerBindings() {
    ...
    const unionOfActionExtension = [
      ...
      ...getRegisteredActionExtensions().map(registeredAction => {
        return {actionId: registeredAction.actionId, bindings: registeredAction.bindings};
      })
    ];
