...
export class TextPrompt extends HTMLElement {
  ...
  private render(): void {
    const output = LitHtml.html`
      ...
      <span class="text-prompt-input"><input aria-label=${this.ariaLabelText} spellcheck="false" @keydown=${
        this.onKeyDown} @input=${this.onInput}/><span class='suggestion' suggestion=" ${
