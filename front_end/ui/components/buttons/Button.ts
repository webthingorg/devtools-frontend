...
export class Button extends HTMLElement {
  ...
  set data(data: ButtonData) {
    ...
    console.log(
        'IN BUTTON CONSTRUCTOR TON HAS VALUE?: ', data.toggleOnClick !== undefined, ' VALUE IS: ', data.toggleOnClick);
  ...
  set toggleOnClick(toggleOnClick: boolean) {
    console.log('TOGGLE ON CLICK IS: ', toggleOnClick, ' ICON IS: ', this.#props.iconName);
