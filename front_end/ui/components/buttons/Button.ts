...
export class Button extends HTMLElement {
  ...
  private render(): void {
    ...
    const classes = {
      ...
      spinner: Boolean(this.props.spinner),
    };
    // clang-format off
    LitHtml.render(
      LitHtml.html`
        <button .disabled=${this.props.disabled} class=${LitHtml.Directives.classMap(classes)}>
          ...
          ${this.props.spinner ?
            ((this.props.disabled) ? LitHtml.html`<span class='spinner-component disabled'></span>`
            : LitHtml.html`<span class='spinner-component'></span>`)  : ''}
