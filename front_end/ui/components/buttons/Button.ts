...
export class Button extends HTMLElement {
  ...
  #render(): void {
    ...
    LitHtml.render(
      LitHtml.html`
        <button title=${LitHtml.Directives.ifDefined(this.#props.title)} .disabled=${this.#props.disabled} class=${LitHtml.Directives.classMap(classes)} aria-pressed=${this.#props.pressed !== undefined ? this.#props.pressed : ''} jslog=${LitHtml.Directives.ifDefined(jslog)}>
          ${hasIcon
            ? LitHtml.html`
