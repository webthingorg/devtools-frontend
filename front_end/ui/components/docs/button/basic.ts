...
primaryButton.variant = Buttons.Button.Variant.PRIMARY;
...
secondaryButton.variant = Buttons.Button.Variant.SECONDARY;
appendButton(secondaryButton);

// Primary Icon
const primaryIconButton = new Buttons.Button.Button();
primaryIconButton.innerText = 'Click me';
primaryIconButton.variant = Buttons.Button.Variant.PRIMARY;
primaryIconButton.iconUrl = testIcon;
...
secondaryIconButton.variant = Buttons.Button.Variant.SECONDARY;
secondaryIconButton.iconUrl = testIcon;
