...
export class TreeOutline extends HTMLElement {
  ...
  private processArrowKeyNavigation(key: Platform.KeyboardUtilities.ArrowKey, currentDOMNode: HTMLLIElement): void {
  ...
  private onTreeKeyDown(event: KeyboardEvent): void {
    ...
    if (event.key === 'Home' || event.key === 'End') {
      ...
      this.processArrowKeyNavigation(event.key, event.target);
