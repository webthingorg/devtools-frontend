...
import {getLoggingConfig, LoggingConfig, needsLogging} from './LoggingConfig.js';
import {logImpressions} from './LoggingEvents.js';
import {getLoggingState, LoggingState} from './LoggingState.js';
...
function observeMutations(root: Node) {
