...
export class DataGrid extends HTMLElement {
  ...
  #onResizePointerMove(event: PointerEvent): void {
    ...
    const minCellWidthPercentage = 100 * MIN_CELL_WIDTH / this.#currentResize.parentWidth;
    const manCellWidthPercentage = (this.#currentResize.leftCellColInitialPercentageWidth +
                                    this.#currentResize.rightCellColInitialPercentageWidth) -
        minCellWidthPercentage;
    ...
    const newLeftColumnPercentage = Platform.NumberUtilities.clamp(
        this.#currentResize.leftCellColInitialPercentageWidth + percentageDelta, minCellWidthPercentage,
        manCellWidthPercentage);
    const newRightColumnPercentage = Platform.NumberUtilities.clamp(
        this.#currentResize.rightCellColInitialPercentageWidth - percentageDelta, minCellWidthPercentage,
        manCellWidthPercentage);
