...
import {baseConfiguration, dummyDarkTheme, dummyLightTheme, dynamicSetting, DynamicSetting, themeSelection} from './config.js';
...
export class TextEditor extends HTMLElement {
  ...
  #createEditor(): CodeMirror.EditorView {
    ...
    ThemeSupport.ThemeSupport.instance().addEventListener(ThemeSupport.ThemeChangeEvent.eventName, () => {
      const currentTheme =
          ThemeSupport.ThemeSupport.instance().themeName() === 'dark' ? dummyDarkTheme : dummyLightTheme;
