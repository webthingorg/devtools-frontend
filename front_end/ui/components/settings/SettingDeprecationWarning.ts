...
export class SettingDeprecationWarning extends HTMLElement {
  static readonly litTagName = LitHtml.literal`setting-deprecation-warning`;
...
ComponentHelpers.CustomElements.defineComponent('setting-deprecation-warning', SettingDeprecationWarning);

declare global {
  interface HTMLElementTagNameMap {
    'setting-deprecation-warning': SettingDeprecationWarning;
  }
}
