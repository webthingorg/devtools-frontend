...
const closeButtonImage = new URL('../../images/close_icon.svg', import.meta.url).toString();
const questionButtonImage = new URL('../../images/question_icon.svg', import.meta.url).toString();
