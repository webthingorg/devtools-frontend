...
const UIStrings = {
  ...
  */
   ...
   */
  removeHighlight: 'Remove memory highlight',
};
const str_ =
...
export interface LinearMemoryViewerHighlightRowData {
...
export class LinearMemoryHighlightChipList extends HTMLElement {
  ...
  set data(data: LinearMemoryViewerHighlightRowData) {
  ...
  #createChip(highlightInfo: HighlightInfo): LitHtml.TemplateResult {
    ...
    return html`
      <div class="highlight-chip">
        ...
        <button class="remove-highlight-button" data-button=${DeleteHighlightChipEvent.eventName} title=${
        i18nString(UIStrings.removeHighlight)}
