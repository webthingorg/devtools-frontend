...
export class LinearMemoryInspectorController extends SDK.TargetManager.SDKModelObserver<SDK.RuntimeModel.RuntimeModel> {
  ...
  // The returned type description corresponds to the type of the highlighted memory
  // the user sees. For pointers, the user sees the first-level pointed to object,
  // so the type description matches that.
