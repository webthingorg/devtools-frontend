...
export class DataGrid extends HTMLElement {
  ...
  private onResizeMouseDown(event: MouseEvent) {
    ...
    const positionOfLeftCell: CellPosition = [window.parseInt(cellColumnIndex, 10), window.parseInt(cellRowIndex, 10)];
    ...
    this.currentResize = {
      leftCellCol,
      rightCellCol,
      leftCellColInitialPercentageWidth: window.parseInt(leftCellCol.style.width, 10),
      rightCellColInitialPercentageWidth: window.parseInt(rightCellCol.style.width, 10),
