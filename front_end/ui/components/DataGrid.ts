...
import {calculateColumnWidthPercentageFromWeighting, Column, getRowEntryForColumnId, handleArrowKeyNavigation, Row, SortState} from './DataGridUtils.js';
...
export class DataGrid extends HTMLElement {
  ...
  private focusCell([newColumnIndex, newRowIndex]: readonly[number, number]) {
  ...
  private onTableKeyDown(event: KeyboardEvent) {
    ...
    const nextFocusedCell = handleArrowKeyNavigation({
      key: key as 'ArrowLeft' | 'ArrowRight' | 'ArrowUp' | 'ArrowDown',
