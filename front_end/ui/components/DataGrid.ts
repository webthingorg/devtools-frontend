...
export class DataGrid extends HTMLElement {
  ...
  constructor() {
    ...
    this.onResizePointerUp = this.onResizePointerUp.bind(this);
  ...
  private onResizePointerDown(event: PointerEvent) {
    ...
    resizerElement.addEventListener('pointermove', this.onResizePointerMove);
  }
  ...
  private onResizePointerUp(event: PointerEvent) {
    ...
    resizer.removeEventListener('pointermove', this.onResizePointerMove);
