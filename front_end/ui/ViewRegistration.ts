...
import {PreRegisteredView} from './ViewManager.js';  // eslint-disable-line no-unused-vars
...
export interface ViewRegistration {
  experiment?: Root.Runtime.ExperimentName, condition?: Root.Runtime.ConditionName, title: string,
      persistence?: ViewPersistence, id: string, location?: ViewLocationValues, hasToolbar?: boolean,
