...
export class CategorizedBreakpointsSidebarPane extends UI.Widget.VBox {
   ...
   * @param {string} requiredCSS
   * @param {string} viewId
   * @param {!SDK.DebuggerModel.BreakReason} detailsPausedReason
   */
  constructor(categories, breakpoints, requiredCSS, viewId, detailsPausedReason) {
    super(true);
    this._categoriesTreeOutline = new UI.TreeOutline.TreeOutlineInShadow();
    this._categoriesTreeOutline.registerRequiredCSS(requiredCSS, {enableLegacyPatching: true});
