...
UI.ViewManager.registerViewExtension({
  ...
  localizableTitle: 'Event Listener Breakpoints',
...
UI.ViewManager.registerViewExtension({
  ...
  location: UI.ViewManager.ViewLocationValues.SOURCES_SIDEBAR_BOTTOM,
  localizableTitle: 'CSP Violation Breakpoints',
...
UI.ViewManager.registerViewExtension({
  ...
  location: UI.ViewManager.ViewLocationValues.SOURCES_SIDEBAR_BOTTOM,
  localizableTitle: 'XHR/fetch Breakpoints',
...
UI.ViewManager.registerViewExtension({
  ...
  location: UI.ViewManager.ViewLocationValues.SOURCES_SIDEBAR_BOTTOM,
  localizableTitle: 'DOM Breakpoints',
...
UI.ViewManager.registerViewExtension({
  ...
  location: UI.ViewManager.ViewLocationValues.SOURCES_SIDEBAR_BOTTOM,
  localizableTitle: 'Global Listeners',
