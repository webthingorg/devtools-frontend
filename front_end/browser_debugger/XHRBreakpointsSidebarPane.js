...
export class XHRBreakpointsSidebarPane extends UI.VBox {
  ...
  _checkboxClicked(url, checked) {
    ...
    const wasFocusedByKeyboard = UI.elementIsFocusedByKeyboard(this._breakpointElements.get(url).checkboxElement);
    ...
    if (wasFocusedByKeyboard) {
      UI.markAsFocusedByKeyboard(this._breakpointElements.get(url).checkboxElement);
    }
  }
