 ...
 * @unrestricted
 */
export class AXNodePropertyTreePropertyElement extends Accessibility.AXNodePropertyTreeElement {
  /**
   * @param {!Protocol.Accessibility.AXProperty} property
   * @param {!Accessibility.AccessibilityNode} axNode
   */
 ...
 * @unrestricted
 */
export class AXValueSourceTreeElement extends Accessibility.AXNodePropertyTreeElement {
  /**
 ...
 * @unrestricted
 */
export class AXNodeIgnoredReasonTreeElement extends Accessibility.AXNodePropertyTreeElement {
  /**
   * @param {!Protocol.Accessibility.AXProperty} property
   * @param {!Accessibility.AccessibilityNode} axNode
   */
 ...
 * @constructor
 */
Accessibility.AccessibilityNodeView = AccessibilityNodeView;
