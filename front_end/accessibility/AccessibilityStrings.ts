...
export const AXAttributes = {
  ...
  'atomic': {
    name: ls`Atomic (live regions)`,
    description:
        ls`If this element may receive live updates, whether the entire live region should be presented to the user on changes, or only changed nodes.`,
    group: 'AXLiveRegionAttributes',
  },
  'relevant': {
  ...
  'busy': {
    ...
    description:
        ls`Whether this element or its subtree are currently being updated (and thus may be in an inconsistent state).`,
    group: 'AXLiveRegionAttributes',
  },
  'root': {
  ...
  'checked': {
    name: ls`Checked`,
    description:
        ls`Whether this checkbox, radio button or tree item is checked, unchecked, or mixed (e.g. has both checked and un-checked children).`,
  ...
  'activedescendant': {
    ...
    description:
        ls`The descendant of this element which is active; i.e. the element to which focus should be delegated.`,
    group: 'AXRelationshipAttributes',
  },
  'flowto': {
    name: ls`Flows to`,
    description:
        ls`Element to which the user may choose to navigate after this one, instead of the next element in the DOM order.`,
    group: 'AXRelationshipAttributes',
  },
  'controls': {
    name: ls`Controls`,
  ...
  'owns': {
    name: ls`Owns`,
    description:
        ls`Element or elements which should be considered descendants of this element, despite not being descendants in the DOM.`,
    group: 'AXRelationshipAttributes',
  },
  ...
  'role': {
    name: ls`Role`,
    description:
        ls`Indicates the purpose of this element, such as a user interface idiom for a widget, or structural role within a document.`,
    group: 'Default',
  },
  'value': {
    name: ls`Value`,
    description:
        ls`The value of this element; this may be user-provided or developer-provided, depending on the element.`,
    group: 'Default',
  },
...
export const AXNativeSourceTypes = {
  ...
  'rubyannotation': {name: ls`From ruby annotation`, description: ls`Value from native HTML ruby annotation.`},
