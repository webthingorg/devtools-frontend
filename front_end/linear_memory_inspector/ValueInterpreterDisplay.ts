    ...
    return html`
      ${isNumber(type) ?
        html`
          ...
          <label title=${i18nString(UIStrings.changeValueTypeMode)}>
            <select data-mode-settings="true"  class="chrome-select" @change=${this.onValueTypeModeChange.bind(this, type)}>
