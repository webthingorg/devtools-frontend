    ...
    const result = html`
      ...
      <div class="navigator">
        <div class="navigator-item">
          ${this.createButton('ic_undo_16x16_icon', ls`Go back in address history`, new HistoryNavigationEvent(Navigation.Backward), Button.HistoryBack)}
          ${this.createButton('ic_redo_16x16_icon', ls`Go forward in address history`, new HistoryNavigationEvent(Navigation.Forward), Button.HistoryForward)}
        </div>
        <div class="navigator-item">
