...
export {Endianness, ValueType, ValueTypeMode};
...
export class LinearMemoryValueInterpreter extends HTMLElement {
  ...
  private value = new ArrayBuffer(0);
      ...
      <div class="value-interpreter">
        <div class="settings-toolbar">
          <button class="settings-button">
            ...
            <devtools-icon .data=${
            {iconName: 'dropdown_7x6_icon', color: 'rgb(110 110 110)', width: '7px'} as Elements.Icon.IconWithName}>
              </devtools-icon>
          </button>
          <button class="settings-button">
            <devtools-icon
              .data=${
            {iconName: 'settings_14x14_icon', color: 'rgb(110 110 110)', width: '14px'} as Elements.Icon.IconWithName}>
            </devtools-icon>
          </button>
        </div>
