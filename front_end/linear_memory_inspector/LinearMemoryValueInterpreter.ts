...
import {Endianness, VALUE_INTEPRETER_MAX_NUM_BYTES, ValueType, ValueTypeMode} from './ValueInterpreterDisplayUtils.js';

export {Endianness, VALUE_INTEPRETER_MAX_NUM_BYTES, ValueType, ValueTypeMode};
