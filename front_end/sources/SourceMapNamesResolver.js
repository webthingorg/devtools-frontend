...
export const _resolveScope = function(scope) {
  ...
  function onIdentifiers(identifiers) {
    ...
    return Promise.all(promises).then(() => _scopeResolvedForTest()).then(() => namesMapping);
  }
...
export const _scopeResolvedForTest = function() {};
...
Sources.SourceMapNamesResolver._scopeResolvedForTest = _scopeResolvedForTest;
