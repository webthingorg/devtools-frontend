...
Sources.SourceFormatter.ScriptMapping = class {
  ...
  uiLocationToRawLocations(uiSourceCode, lineNumber, columnNumber) {
    ...
    if (formatData.originalSourceCode.contentType().isScript()) {
      ...
      const rawLocations = Bindings.debuggerWorkspaceBinding.uiLocationToRawLocationsForSourceFormatter(
  ...
  _scriptsForUISourceCode(uiSourceCode) {
    ...
    if (uiSourceCode.contentType().isScript()) {
      const rawLocations =
          Bindings.debuggerWorkspaceBinding.uiLocationToRawLocationsForSourceFormatter(uiSourceCode, 0, 0);
