...
const str_ = i18n.i18n.registerUIStrings('sources/ThreadsSidebarPane.ts', UIStrings);
const i18nString = i18n.i18n.getLocalizedString.bind(undefined, str_);
let threadsSidebarPaneInstance: ThreadsSidebarPane;

export class ThreadsSidebarPane extends UI.Widget.VBox implements SDK.SDKModel.SDKModelObserver, UI.ListControl.ListDelegate {
  ...
  heightForItem(debuggerModel: SDK.DebuggerModel.DebuggerModel): number {
    console.assert(false); // Should not be called.
    return 0;
  }

  isItemSelectable(debuggerModel: SDK.DebuggerModel.DebuggerModel): boolean {
    return true;
  }

  selectedItemChanged(from: SDK.DebuggerModel.DebuggerModel | null, to: SDK.DebuggerModel.DebuggerModel | null, fromElement: Element | null, toElement: Element | null): void {
