...
import {accessibilityNodeRenderer, sdkNodeToAXTreeNode} from './AccessibilityTreeUtils.js';
...
export class AccessibilityTreeView extends UI.Widget.VBox {
  ...
  private treeData: Components.TreeOutlineUtils.TreeNode<SDK.AccessibilityModel.AccessibilityNode>[] = [];
