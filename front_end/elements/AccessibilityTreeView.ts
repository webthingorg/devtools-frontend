...
export class AccessibilityTreeView extends UI.Widget.VBox {
  ...
  private async refreshAccessibilityTree() {
    this.treeView.data = {
      message: 'hello world',
    };
    ...
    // console.log(accessibilityModel);
    if (!accessibilityModel) {
      return;
    }
    accessibilityModel.test();
    // accessibilityModel.clear();
    // SDK.AccessibilityModel.AccessibilityModel.requestPartialAXTree();
