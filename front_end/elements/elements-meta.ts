...
UI.ActionRegistry.registerActionExtension({
  actionId: UI.ActionRegistry.ActionId.ELEMENTS_HIDE_ELEMENT,
  category: UI.ActionRegistry.ActionCategory.ELEMENTS,
  title: 'Hide element',
  async loadActionDelegate() {
    const Elements = await loadElementsModule();
    return Root.Runtime.Runtime.instance().sharedInstance(Elements.ElementsPanel.ElementsActionDelegate);
  },
