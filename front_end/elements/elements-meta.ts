...
import type {ElementsActionDelegate} from './ElementsPanel.js';
...
UI.ActionRegistryUtils.registerActionExtension({
...
declare global {
  interface ActionIdMap {
    'elements.hide-element': ElementsActionDelegate;
  }
}
