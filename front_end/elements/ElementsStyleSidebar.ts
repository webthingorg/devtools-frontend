...
class SelectorChangeEvent extends Event {
  constructor(public newSelector: string) {
...
class NameChangeEvent extends Event {
  constructor(public property: SDK.CSSProperty.CSSProperty, public newName: string) {
...
class ValueChangeEvent extends Event {
  constructor(public property: SDK.CSSProperty.CSSProperty, public newValue: string) {
...
class RuleEffectChange extends Event {
  constructor(public property: SDK.CSSProperty.CSSProperty, public newEffectStatus: boolean) {
...
class ElementsStyleSidebar extends HTMLElement {
  ...
  private fireRuleEffectChangeEvent(property: SDK.CSSProperty.CSSProperty) {
    return (event: Event) => {
      this.dispatchEvent(new RuleEffectChange(property, (event.target as HTMLInputElement).checked));
    };
  }
