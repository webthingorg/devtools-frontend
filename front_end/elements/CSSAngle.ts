...
export class CSSAngle extends HTMLElement {
  ...
  private renderPopover() {
    ...
    // TODO(changhaohan): for now we ignore values with "url"; when we refactor
    // CSS value parsine we should properly apply atomic contextual background
    // in this case: https://crbug.com/1143010
