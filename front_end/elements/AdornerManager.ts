...
export class AdornerManager {
  ...
  private settingStore: Common.Settings.Setting<AdornerSetting[]>;

  constructor(settingStore: Common.Settings.Setting<AdornerSetting[]>) {
  ...
  getSettings(): ReadonlyMap<string, boolean> {
    return this.adornerSettings as ReadonlyMap<string, boolean>;
  }
