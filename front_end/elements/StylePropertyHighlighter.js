...
export class StylePropertyHighlighter {
  ...
  /**
   * Expand all shorthands, find the give property, scroll to it and highlight it.
   ...
   * return the tree element with the callback returns a truthy value.
   * @param {!function():boolean} compareCb
   * @return {TreeElement}
   */
