...
import {Event} from './MediaModel.js';  // eslint-disable-line no-unused-vars
...
const MessageLevelMap = new Map([
  ['error', MessageLevelBitfield.Error],
  ['warning', MessageLevelBitfield.Warning],
  ['info', MessageLevelBitfield.Info],
  ['debug', MessageLevelBitfield.Debug],
]);
