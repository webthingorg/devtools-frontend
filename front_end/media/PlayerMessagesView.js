 ...
 * @enum {number}
 */
export const MessageLevelBitfield = {
  Error: 1 << 0,
  Warning: 1 << 1,
  Info: 1 << 2,
  Debug: 1 << 3,
...
export class PlayerMessagesView extends UI.Widget.VBox {
  ...
  _createDropdown() {
    ...
    /** @type {!UI.SoftDropDown.SoftDropDown.Delegate<!SelectableLevel>} **/
...
/**
 * @implements {UI.SoftDropDown.SoftDropDown.Delegate<!SelectableLevel>}
 */
export class MessageLevelSelector extends Common.Object {
