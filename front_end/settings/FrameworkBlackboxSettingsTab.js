...
export const UIStrings = {
  ...
  *@example {ad.*?} ITEM_PATTERN
  */
  blackboxScriptsWhoseNamesMatchS: 'Blackbox scripts whose names match \'{ITEM_PATTERN}\'',
  /**
  *@description Aria accessible name in Framework Blackbox Settings Tab of the Settings
  */
  pattern: 'Pattern',
...
export class FrameworkBlackboxSettingsTab extends UI.Widget.VBox {
  constructor() {
    ...
    header.textContent = i18n.i18n.getLocalizedString(str_, UIStrings.frameworkBlackboxing);
    UI.ARIAUtils.markAsHeading(header, 1);
    this.contentElement.createChild('div', 'intro').textContent =
        i18n.i18n.getLocalizedString(str_, UIStrings.debuggerWillSkipThroughThe);
    ...
    blackboxContentScripts.appendChild(UI.SettingsUI.createSettingCheckbox(
        i18n.i18n.getLocalizedString(str_, UIStrings.blackboxContentScripts),
        Common.Settings.Settings.instance().moduleSetting('skipContentScripts'), true));
    blackboxContentScripts.title = i18n.i18n.getLocalizedString(str_, UIStrings.blackboxContentScriptsExtension);

    this._blackboxLabel = i18n.i18n.getLocalizedString(str_, UIStrings.blackbox);
    this._disabledLabel = i18n.i18n.getLocalizedString(str_, UIStrings.disabled);
    ...
    placeholder.textContent = i18n.i18n.getLocalizedString(str_, UIStrings.noBlackboxedPatterns);
    this._list.setEmptyPlaceholder(placeholder);
    this._list.show(this.contentElement);
    const addPatternButton = UI.UIUtils.createTextButton(
        i18n.i18n.getLocalizedString(str_, UIStrings.addPattern), this._addButtonClicked.bind(this), 'add-button');
    UI.ARIAUtils.setAccessibleName(addPatternButton, i18n.i18n.getLocalizedString(str_, UIStrings.addFilenamePattern));
  ...
  renderItem(item, editable) {
    ...
    pattern.title = i18n.i18n.getLocalizedString(str_, UIStrings.blackboxScriptsWhoseNamesMatchS, {PH1: item.pattern});
  ...
  _createEditor() {
    ...
    titles.createChild('div', 'blackbox-pattern').textContent = i18n.i18n.getLocalizedString(str_, UIStrings.pattern);
    titles.createChild('div', 'blackbox-separator blackbox-separator-invisible');
    titles.createChild('div', 'blackbox-behavior').textContent = i18n.i18n.getLocalizedString(str_, UIStrings.behavior);
    ...
    UI.ARIAUtils.setAccessibleName(pattern, i18n.i18n.getLocalizedString(str_, UIStrings.pattern));
    ...
    UI.ARIAUtils.setAccessibleName(behavior, i18n.i18n.getLocalizedString(str_, UIStrings.behavior));
    ...
    function patternValidator(item, index, input) {
      ...
      if (!pattern.length) {
        return {valid: false, errorMessage: i18n.i18n.getLocalizedString(str_, UIStrings.patternCannotBeEmpty)};
      }

      for (let i = 0; i < patterns.length; ++i) {
        if (i !== index && patterns[i].pattern === pattern) {
          return {valid: false, errorMessage: i18n.i18n.getLocalizedString(str_, UIStrings.patternAlreadyExists)};
        }
      }
      ...
      if (!regex) {
        return {valid: false, errorMessage: i18n.i18n.getLocalizedString(str_, UIStrings.patternMustBeAValidRegular)};
      }
      return {valid: true};
    }
