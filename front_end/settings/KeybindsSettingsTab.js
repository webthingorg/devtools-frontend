...
import {createControlForSetting} from '../ui/SettingsUI.js';
...
export class KeybindsSettingsTab extends VBox {
  constructor() {
    ...
    this.contentElement.appendChild(createControlForSetting(keybindsSetSetting));
...
let KeybindItem;  // eslint-disable-line no-unused-vars
