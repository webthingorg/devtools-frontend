...
export const UIStrings = {
  ...
  */
  ...
  /**
  *@description Label for a button in the settings pane that resets all shortcuts to defaults
  */
  ...
  *@example {Start/stop recording} ACTION_TITLE__
  */
  thisShortcutIsInUseByS: 'This shortcut is in use by {ACTION_TITLE__}.',
};
...
export class KeybindsSettingsTab extends UI.Widget.VBox {
  constructor() {
    ...
    this.contentElement.appendChild(
        UI.UIUtils.createTextButton(i18n.i18n.getLocalizedString(str_, UIStrings.restoreDefaultShortcuts), () => {
...
export class ShortcutListItem {
  ...
  _createEmptyInfo() {
    if (UI.ShortcutRegistry.ShortcutRegistry.instance().actionHasDefaultShortcut(this._item.id())) {
      ...
      UI.ARIAUtils.setAccessibleName(icon, i18n.i18n.getLocalizedString(str_, UIStrings.shortcutModified));
  ...
  _setupEditor() {
    ...
    addShortcutLink.textContent = i18n.i18n.getLocalizedString(str_, UIStrings.addAShortcut);
    ...
    UI.ARIAUtils.setAccessibleName(this._confirmButton, i18n.i18n.getLocalizedString(str_, UIStrings.confirmChanges));
    ...
    UI.ARIAUtils.setAccessibleName(cancelButton, i18n.i18n.getLocalizedString(str_, UIStrings.discardChanges));
  ...
  _createShortcutRow(shortcut, index) {
    ...
    if (this._isEditing) {
      ...
      UI.ARIAUtils.setAccessibleName(deleteButton, i18n.i18n.getLocalizedString(str_, UIStrings.removeShortcut));
    } else {
  ...
  _createEditButton() {
    ...
    UI.ARIAUtils.setAccessibleName(editButton, i18n.i18n.getLocalizedString(str_, UIStrings.editShortcut));
    return editButton;
  }
    ...
    this._shortcutInputs.forEach((shortcutInput, shortcut) => {
      ...
      if (UI.KeyboardShortcut.KeyboardShortcut.isModifier(userDescriptors[0].key)) {
        ...
        this._errorMessageElement.textContent =
            i18n.i18n.getLocalizedString(str_, UIStrings.shortcutsCannotContainOnly);
        return;
      }
      ...
      if (conflicts.length) {
        ...
        this._errorMessageElement.textContent =
            i18n.i18n.getLocalizedString(str_, UIStrings.thisShortcutIsInUseByS, {PH1: action.title()});
        return;
      }
