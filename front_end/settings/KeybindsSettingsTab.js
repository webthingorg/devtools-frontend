...
export const UIStrings = {
  ...
  */
  customKeyboardShortcuts: 'Custom keyboard shortcuts',
  /**
...
export class KeybindsSettingsTab extends UI.Widget.VBox {
  constructor() {
    ...
    header.createChild('h1').textContent = Common.i18n.getLocalizedString(str_, UIStrings.customKeyboardShortcuts);
    ...
    listHeader.createChild('div', 'keybinds-list-text').textContent =
        Common.i18n.getLocalizedString(str_, UIStrings.action);
    listHeader.createChild('div', 'keybinds-list-text').textContent =
        Common.i18n.getLocalizedString(str_, UIStrings.keyboardInput);
