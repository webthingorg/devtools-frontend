...
class AffectedResourcesView {
   ...
   * @param {number} count
   */
  setAffectedResourceCounter(count) {
    this._affectedResourcesCount = count;
    this._affectedResourcesCounter.textContent = `${count} ${this.getResourceName(count)}`;
...
class AffectedCookiesView extends AffectedResourcesView {
  ...
  constructor(parent, issue) {
    super(parent, {singular: 'cookie', plural: 'cookies'});
  ...
  _appendAffectedCookies(cookies) {
    ...
    this.setAffectedResourceCounter(count);
  }
