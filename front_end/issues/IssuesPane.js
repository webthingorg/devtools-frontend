...
export class IssuesPaneImpl extends UI.VBox {
  constructor() {
    ...
    this._model.addEventListener(SDK.IssuesModel.IssuesModel.Events.IssueAdded, this._issueAdded, this);
    this._model.addEventListener(SDK.IssuesModel.IssuesModel.Events.AllIssuesCleared, this._issuesCleared, this);
