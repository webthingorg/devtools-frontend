...
class IssueView extends UI.Widget {
  ...
  appendAffectedCookies() {
    ...
    this._affectedCookiesCounter = createElementWithClass('span', '');
    this._affectedCookiesCounter.innerText = '0';
    label.prepend(this._affectedCookiesCounter);
  ...
  appendAffectedCookie(cookie) {
    this._affectedCookiesCounter.innerText = this._issue.numberOfCookies();
