...
import {getMarkdownLink} from './markdownLinks.js';
 ...
 * Parsed links from markdown are not directly rendered, instead they have to be added to the <key, link> map in markdownLinks.ts.
