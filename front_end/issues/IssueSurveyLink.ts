...
export interface IssueSurveyLinkData {
  trigger: string;
  canShowSurvey:
      (trigger: string, callback: (result: Host.InspectorFrontendHostAPI.CanShowSurveyResult) => void) => void;
  showSurvey: (trigger: string, callback: (result: Host.InspectorFrontendHostAPI.ShowSurveyResult) => void) => void;
}
...
export class IssueSurveyLink extends HTMLElement {
  ...
  private canShowSurvey:
      (trigger: string,
       callback: (result: Host.InspectorFrontendHostAPI.CanShowSurveyResult) => void) => void = () => {};
  private showSurvey:
      (trigger: string, callback: (result: Host.InspectorFrontendHostAPI.ShowSurveyResult) => void) => void = () => {};
