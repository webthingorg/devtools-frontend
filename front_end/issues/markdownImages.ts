...
/*
  To use icons/images in markdown, add key here and use the added key in markdown.
  Available icons are in front_end\ui\Icon.js
  @example markdown
  Device emulation icon is [Device](deviceEmulationIcon)
*/
