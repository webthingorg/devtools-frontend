...
/*
  ...
  use the added key in markdown. This is only exported for tests, and it should not be
  imported in any component, instead add link in map and use getMarkdownLink to get the appropriate link.
  @example markdown
