...
export class CSPViolationsListView extends UI.Widget.VBox {
  constructor() {
    ...
    this.table.data = {
      columns: [
        {id: 'f1', title: 'Source Code', sortable: false, widthWeighting: 1, visible: true, hideable: false},
        {id: 'f2', title: 'Violated Directive', sortable: false, widthWeighting: 1, visible: true, hideable: false},
        {id: 'f3', title: 'Category', sortable: false, widthWeighting: 1, visible: true, hideable: false},
        {id: 'f4', title: 'Status', sortable: false, widthWeighting: 1, visible: true, hideable: false}
      ],
      rows: [],
  ...
  addIssue(issue) {
    ...
    const newIssue = {
      cells: [
        ...
        {columnId: 'f2', value: issue.details().violatedDirective},
        {columnId: 'f3', value: issue.code(), title: category, renderer: () => category},
        {columnId: 'f4', value: status}
      ]
    };
