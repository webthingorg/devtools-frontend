...
import {Angle, AngleUnit, getAngleFromRadians, getNewAngleFromUIEvent, getNextUnit, getRadiansFromAngle, parseText, roundAngleByUnit} from './CSSAngleUtils.js';
...
export class CSSAngle extends HTMLElement {
  ...
  private onKeydown(event: KeyboardEvent): void {
    ...
    switch (event.key) {
      ...
      case 'ArrowUp':
      case 'ArrowDown': {
        const newAngle = getNewAngleFromUIEvent(this.angle, event);
        if (newAngle) {
