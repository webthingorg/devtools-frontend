...
const lineHeightKeyValues = ['', 'normal'];
const fontWeightKeyValues = ['', 'normal', 'bold', 'bolder', 'lighter'];
const letterSpacingKeyValues = ['', 'normal'];

export const GlobalValues = ['inherit', 'initial', 'unset'];

fontSizeKeyValues.push(...GlobalValues);
lineHeightKeyValues.push(...GlobalValues);
fontWeightKeyValues.push(...GlobalValues);
letterSpacingKeyValues.push(...GlobalValues);
...
export const FontSizeStaticParams = {
  ...
  keyValuesArray: fontSizeKeyValues,
...
export const LineHeightStaticParams = {
  ...
  keyValuesArray: lineHeightKeyValues,
...
export const FontWeightStaticParams = {
  ...
  unitsArray: null,
  keyValuesArray: fontWeightKeyValues,
...
export const LetterSpacingStaticParams = {
  ...
  keyValuesArray: letterSpacingKeyValues,
