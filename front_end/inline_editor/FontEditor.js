...
export class FontEditor extends UI.VBox {
  constructor() {
    ...
    this._fontSizeSlider = this._createSlider(fontSizeField, ls`Font Size`);
    this._fontSizeTextInput = this._createTextInput(fontSizeField);

    const fontWeightField = this.contentElement.createChild('div', 'shadow-editor-field shadow-editor-flex-field');
    this._fontWeightSlider = this._createSlider(fontWeightField, ls`Font Weight`);
    this._fontWeightTextInput = this._createTextInput(fontWeightField);

    const lineHeightField = this.contentElement.createChild('div', 'shadow-editor-field shadow-editor-flex-field');
    this._lineHeightSlider = this._createSlider(lineHeightField, ls`Line Height`);
    this._lineHeightTextInput = this._createTextInput(lineHeightField);
  ...
  // ============================================== Shadow Editor specific functions
