...
export class FontEditor extends UI.VBox {
  ...
  constructor(propertyMap) {
    ...
    this._lineHeightInputs = {
      slider: this._createSlider(lineHeightField, ls`Line Height`, 0, 2, lineHeightInitialValue, lineHeightStep),
    ...
    const resetButton = UI.createTextButton('Reset Changes', () => {
...
/**
 * @typedef {{slider: !Element, textInput: !Element, unitInput: ?Element}}
 */
