...
class FontPropertyInputs {
  ...
  _createSliderInput(field, label) {
    const min = (this._propertyInfo.value && !isNaN(this._propertyInfo.value)) ? Math.min(this._rangeMap.get(this._units).min, this._propertyInfo.value) :
                                           this._rangeMap.get(this._units).min;
    const max = (this._propertyInfo.value && !isNaN(this._propertyInfo.value)) ? Math.max(this._rangeMap.get(this._units).max, this._propertyInfo.value) :
