...
export class FontEditor extends UI.VBox {
  ...
  constructor(propertyMap) {
    ...
    const resetButton = UI.createTextButton('Reset', this._reset.bind(this), 'font-reset-button', true);
  ...
  _createSelector(field, label, options, current) {
    const selectInput = UI.createSelect(label, options);
    selectInput.value = current;
    const selectLabel = UI.createLabel(label, 'shadow-editor-label', selectInput);
