...
export class FontEditor extends UI.Widget.VBox {
  ...
  constructor(propertyMap, computedFontArray) {
    ...
    const letterSpacingDefaultUnits = letterSpacingPropertyInfo.units ? letterSpacingPropertyInfo.units : 'px';
  ...
  _onSliderInput(event) {
    ...
    switch (event.currentTarget) {
      case this._fontSizeInputs.slider:
        ...
        this._updatePropertyValue('font-size', value + this._fontSizeInputs.unitInput.value);
        break;
      case this._fontWeightInputs.slider:
        this._fontWeightInputs.textInput.value = value;
        this._updatePropertyValue('font-weight', value);
        break;
      case this._lineHeightInputs.slider:
        this._lineHeightInputs.textInput.value = value;
        this._updatePropertyValue('line-height', value + this._lineHeightInputs.unitInput.value);
        break;
      case this._letterSpacingInputs.slider:
        this._letterSpacingInputs.textInput.value = value;
        this._updatePropertyValue('letter-spacing', value + this._letterSpacingInputs.unitInput.value);
        break;
    }
  }
  ...
  _onTextInput(event) {
    ...
    switch (event.currentTarget) {
      case this._fontSizeInputs.textInput:
        ...
        this._updatePropertyValue('font-size', value + units);
        break;
      ...
      case this._lineHeightInputs.textInput:
        ...
        this._updatePropertyValue('line-height', value + units);
        break;
      case this._letterSpacingInputs.textInput:
        ...
        this._updatePropertyValue('letter-spacing', value + units);
        break;
    }
  }
    ...
    switch (event.currentTarget) {
      case this._fontSizeInputs.unitInput:
        if (this._fontSizeInputs.textInput.value) {
          const prevUnit = this._fontSizeInputs.units;
          this._updatePropertyUnits('font-size', newUnit, prevUnit);
        }
        this._fontSizeInputs.units = newUnit;
        break;
      case this._lineHeightInputs.unitInput:
        if (this._lineHeightInputs.textInput.value) {
          const prevUnit = this._lineHeightInputs.units;
          this._updatePropertyUnits('line-height', newUnit, prevUnit);
        }
        this._lineHeightInputs.units = newUnit;
        break;
      case this._letterSpacingInputs.unitInput:
        if (this._letterSpacingInputs.textInput.value) {
          const prevUnit = this._letterSpacingInputs.units;
          this._updatePropertyUnits('letter-spacing', newUnit, prevUnit);
        }
        this._letterSpacingInputs.units = newUnit;
        break;
    }
  }
  ...
  _updatePropertyUnits(propertyName, newUnit, prevUnit) {
    this.dispatchEventToListeners(Events.FontUnitChanged, {propertyName, newUnit, prevUnit});
  }

  // _unitConversion(start, end, currentValue) {
  //   if (start === 'px') {
  //     if (end === 'em') {
...
export const Events = {
  ...
  FontUnitChanged: Symbol('FontUnitChanged'),
