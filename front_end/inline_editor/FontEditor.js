...
/**
 * @typedef {{name: string, slider: !HTMLInputElement, textBoxInput: !HTMLInputElement, unitInput: HTMLInputElement | undefined, units: string | undefined}}
 */
...
class FontPropertyInputs {
  ...
  constructor(propertyName, label, field, propertyInfo, staticParams, updateCallback, resizeCallback, hasUnits) {
    ...
    if (this._hasUnits && this._staticParams.unitsArray) {
      ...
      this._addedUnit = this._staticParams.unitsArray.includes(this._units) ? false : true;
