...
export class FontEditor extends UI.Widget.VBox {
  /**
   * @param {!Map<string, string|undefined>} propertyMap
  ...
  constructor(propertyMap, computedFontArray) {
    ...
    // this._fontsList = [
    //   '', 'Arial', {text: 'Comic Sans MS', value: '\'Comic Sans MS\''},
    //   {text: 'Courier New', value: '\'Courier New\''}, 'Helvetica',
    //   'Impact', {text: 'Times New Roman', value: '\'Times New Roman\''},
    //   'Verdana'
    // ];
    ...
    // let splicedArray = this._splitComputedFontArray(computedFontArray);
    // this._fontsList.splice(1, 0, ...splicedArray);
    ...
    // Show Font Example
    // const previewTextSection = this.contentElement.createChild('div', 'font-section');
    // previewTextSection.classList.add('font-section');
    // previewTextSection.createChild('h2', 'font-section-header').textContent = ls`Preview Text`;

    // const textPreviewInput = previewTextSection.createChild('input', 'fonts-input');
    // textPreviewInput.placeholder = 'Sample Text';
    // this._previewText = previewTextSection.createChild('p', 'preview-text');
    // this._previewText.innerHTML = ls`Sample Text`;
    // this._previewText.style.setProperty('font-size', fontSizeNumericValue + fontSizeUnitValue);
    // this._previewText.style.setProperty('line-height', lineHeightNumericValue + lineHeightUnitValue);
    // this._previewText.style.setProperty('font-weight', fontWeightInitialValue);
    // this._previewText.style.setProperty('letter-spacing', letterSpacingNumericValue + letterSpacingUnitValue);

    // textPreviewInput.type = 'text';

    // textPreviewInput.addEventListener('input', () => {
    //   this._previewText.innerHTML = textPreviewInput.value;
    //   this.dispatchEventToListeners(Events.FontEditorResized);
    // });
    // this.contentElement.appendChild(previewTextSection);
  ...
  _updateProperty(propertyName, value) {
    ...
    // this._previewText.style.setProperty(propertyName, value);
    // if (lastClick >= (Date.now() - resizeDelay)) {
    //   return;
    // }
    // lastClick = Date.now();
    // this.dispatchEventToListeners(Events.FontEditorResized);
...
/**
 * @typedef {{name: string, slider: !Element, textInput: !Element, unitInput: Element | undefined, initialValue: string | undefined, initialUnits: string | undefined}}
 */
