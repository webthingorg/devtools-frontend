...
export const config = {
  'attributes': [
    {'enum': null, 'type': 'IDREF', 'name': 'aria-activedescendant'},
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-atomic'},
    {'default': 'none', 'enum': ['inline', 'list', 'both', 'none'], 'type': 'token', 'name': 'aria-autocomplete'},
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-busy'},
    {'default': 'undefined', 'enum': ['true', 'false', 'mixed', 'undefined'], 'type': 'token', 'name': 'aria-checked'},
    {'enum': null, 'type': 'integer', 'name': 'aria-colcount'},
    {'enum': null, 'type': 'integer', 'name': 'aria-colindex'},
    {'enum': null, 'type': 'integer', 'name': 'aria-colspan'},
    {'enum': null, 'type': 'IDREF_list', 'name': 'aria-controls'},
    {
      'default': 'false',
    ...
    {'enum': null, 'type': 'IDREF_list', 'name': 'aria-describedby'},
    {'enum': null, 'type': 'string', 'name': 'aria-description'},
    {'enum': null, 'type': 'IDREF', 'name': 'aria-details'},
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-disabled'},
    {
      'default': 'none',
    ...
    {'enum': null, 'type': 'IDREF', 'name': 'aria-errormessage'},
    {'default': 'undefined', 'enum': ['true', 'false', 'undefined'], 'type': 'token', 'name': 'aria-expanded'},
    {'enum': null, 'type': 'IDREF_list', 'name': 'aria-flowto'},
    ...
    {'enum': null, 'type': 'string', 'name': 'aria-keyshortcuts'},
    {'enum': null, 'type': 'string', 'name': 'aria-label'},
    {'enum': null, 'type': 'IDREF_list', 'name': 'aria-labelledby'},
    {'enum': null, 'type': 'IDREF_list', 'name': 'aria-labeledby'},
    {'enum': null, 'type': 'integer', 'name': 'aria-level'},
    {'default': 'off', 'enum': ['off', 'polite', 'assertive'], 'type': 'token', 'name': 'aria-live'},
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-modal'},
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-multiline'},
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-multiselectable'},
    {
      'default': 'undefined',
    ...
    {'enum': null, 'type': 'IDREF_list', 'name': 'aria-owns'},
    {'enum': null, 'type': 'string', 'name': 'aria-placeholder'},
    {'enum': null, 'type': 'integer', 'name': 'aria-posinset'},
    {'default': 'undefined', 'enum': ['true', 'false', 'mixed', 'undefined'], 'type': 'token', 'name': 'aria-pressed'},
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-readonly'},
    {
    ...
    {'default': 'false', 'enum': null, 'type': 'boolean', 'name': 'aria-required'},
    {'enum': null, 'type': 'string', 'name': 'aria-roledescription'},
    {'enum': null, 'type': 'integer', 'name': 'aria-rowcount'},
    {'enum': null, 'type': 'integer', 'name': 'aria-rowindex'},
    {'enum': null, 'type': 'integer', 'name': 'aria-rowspan'},
    {'default': 'undefined', 'enum': ['true', 'false', 'undefined'], 'type': 'token', 'name': 'aria-selected'},
    {'enum': null, 'type': 'integer', 'name': 'aria-setsize'},
    {'default': 'none', 'enum': ['ascending', 'descending', 'none', 'other'], 'type': 'token', 'name': 'aria-sort'},
    {'enum': null, 'type': 'decimal', 'name': 'aria-valuemax'},
    {'enum': null, 'type': 'decimal', 'name': 'aria-valuemin'},
    {'enum': null, 'type': 'decimal', 'name': 'aria-valuenow'},
    {'enum': null, 'type': 'string', 'name': 'aria-valuetext'}
  ],
  'roles': [
    {
