...
export function registerCommands(inspectorBackend) {
  ...
  inspectorBackend.registerEvent('Storage.interestGroupAccess', ['type', 'ownerOrigin', 'name']);
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
      ...
      ['details_json']);
  inspectorBackend.registerCommand('Storage.trackInterestGroupStorage', [], []);
  inspectorBackend.registerCommand('Storage.untrackInterestGroupStorage', [], []);
