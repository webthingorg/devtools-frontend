...
export function registerCommands(inspectorBackend) {
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "playbackRate", type: "number", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "Animation.setTiming",
  ...
  inspectorBackend.registerEnum("Audits.CookieOperation", {
    SetCookie: "SetCookie",
  ...
  inspectorBackend.registerEnum("Audits.HeavyAdResolutionStatus", {
    HeavyAdBlocked: "HeavyAdBlocked",
    HeavyAdWarning: "HeavyAdWarning",
  });
  inspectorBackend.registerEnum("Audits.HeavyAdReason", {
  ...
  inspectorBackend.registerEnum("Audits.SharedArrayBufferIssueType", {
    TransferIssue: "TransferIssue",
    CreationIssue: "CreationIssue",
  });
  inspectorBackend.registerEnum("Audits.TwaQualityEnforcementViolationType", {
  ...
  inspectorBackend.registerEnum("Audits.GenericIssueErrorType", {
  ...
  inspectorBackend.registerEnum("Audits.ClientHintIssueReason", {
  ...
  inspectorBackend.registerEnum("Audits.GetEncodedResponseRequestEncoding", {
    Webp: "webp",
    Jpeg: "jpeg",
    Png: "png",
  });
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "reportAAA", type: "boolean", optional: true }],
    []
  );
  ...
  inspectorBackend.registerEvent("BackgroundService.recordingStateChanged", [
    "isRecording",
    "service",
  ]);
  ...
  // Browser.
  inspectorBackend.registerEnum("Browser.WindowState", {
    Normal: "normal",
    Minimized: "minimized",
    Maximized: "maximized",
  ...
  inspectorBackend.registerEnum("Browser.PermissionSetting", {
    Granted: "granted",
    Denied: "denied",
    Prompt: "prompt",
  });
  inspectorBackend.registerEnum("Browser.BrowserCommandId", {
    OpenTabSearch: "openTabSearch",
    CloseTabSearch: "closeTabSearch",
  });
  inspectorBackend.registerEvent("Browser.downloadWillBegin", [
    "frameId",
    "guid",
    "url",
    "suggestedFilename",
  ]);
  inspectorBackend.registerEnum("Browser.DownloadProgressEventState", {
    InProgress: "inProgress",
    Completed: "completed",
    Canceled: "canceled",
  });
  inspectorBackend.registerEvent("Browser.downloadProgress", [
    "guid",
    "totalBytes",
    "receivedBytes",
    "state",
  ...
  inspectorBackend.registerEnum("Browser.SetDownloadBehaviorRequestBehavior", {
    Deny: "deny",
    Allow: "allow",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "commandId", type: "string", optional: false }],
    []
  );
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "propertiesToTrack", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [
      ...
      { name: "keyText", type: "string", optional: false },
    ],
    ["keyText"]
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    "CSS.setStyleTexts",
    [{ name: "edits", type: "object", optional: false }],
    ["styles"]
  );
  ...
  inspectorBackend.registerCommand(
    "Cast.enable",
    [{ name: "presentationUrl", type: "string", optional: true }],
    []
  );
  inspectorBackend.registerCommand("Cast.disable", [], []);
  inspectorBackend.registerCommand(
    "Cast.setSinkToUse",
    [{ name: "sinkName", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("DOM.CompatibilityMode", {
    QuirksMode: "QuirksMode",
    LimitedQuirksMode: "LimitedQuirksMode",
    NoQuirksMode: "NoQuirksMode",
  });
  inspectorBackend.registerEvent("DOM.attributeModified", [
    "nodeId",
    "name",
    "value",
  ]);
  inspectorBackend.registerEvent("DOM.attributeRemoved", ["nodeId", "name"]);
  inspectorBackend.registerEvent("DOM.characterDataModified", [
    "nodeId",
    "characterData",
  ]);
  inspectorBackend.registerEvent("DOM.childNodeCountUpdated", [
    "nodeId",
    "childNodeCount",
  ]);
  inspectorBackend.registerEvent("DOM.childNodeInserted", [
    "parentNodeId",
    "previousNodeId",
    "node",
  ]);
  inspectorBackend.registerEvent("DOM.childNodeRemoved", [
    "parentNodeId",
    "nodeId",
  ]);
  inspectorBackend.registerEvent("DOM.distributedNodesUpdated", [
    "insertionPointId",
    "distributedNodes",
  ]);
  inspectorBackend.registerEvent("DOM.documentUpdated", []);
  inspectorBackend.registerEvent("DOM.inlineStyleInvalidated", ["nodeIds"]);
  inspectorBackend.registerEvent("DOM.pseudoElementAdded", [
    "parentId",
    "pseudoElement",
  ]);
  inspectorBackend.registerEvent("DOM.topLayerElementsUpdated", []);
  inspectorBackend.registerEvent("DOM.pseudoElementRemoved", [
    "parentId",
    "pseudoElementId",
  ]);
  ...
  inspectorBackend.registerEnum("DOM.EnableRequestIncludeWhitespace", {
    None: "none",
    All: "all",
  });
  inspectorBackend.registerCommand(
    "DOM.enable",
    [{ name: "includeWhitespace", type: "string", optional: true }],
    []
  );
  inspectorBackend.registerCommand(
    "DOM.focus",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "backendNodeIds", type: "object", optional: false }],
    ["nodeIds"]
  );
  inspectorBackend.registerCommand(
    "DOM.querySelector",
  ...
  inspectorBackend.registerCommand(
    ...
    [
      { name: "files", type: "object", optional: false },
      { name: "nodeId", type: "number", optional: true },
      { name: "backendNodeId", type: "number", optional: true },
      { name: "objectId", type: "string", optional: true },
    ],
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "violationTypes", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  // DOMStorage.
  inspectorBackend.registerEvent("DOMStorage.domStorageItemAdded", [
    "storageId",
    "key",
    "newValue",
  ]);
  inspectorBackend.registerEvent("DOMStorage.domStorageItemRemoved", [
    "storageId",
    "key",
  ]);
  inspectorBackend.registerEvent("DOMStorage.domStorageItemUpdated", [
    "storageId",
    "key",
    "oldValue",
    "newValue",
  ]);
  inspectorBackend.registerEvent("DOMStorage.domStorageItemsCleared", [
    "storageId",
  ]);
  inspectorBackend.registerCommand(
    "DOMStorage.clear",
  ...
  inspectorBackend.registerCommand(
    ...
    [
      { name: "alpha", type: "number", optional: false },
      { name: "beta", type: "number", optional: false },
  ...
  inspectorBackend.registerEnum("Emulation.DisplayFeatureOrientation", {
    Vertical: "vertical",
    Horizontal: "horizontal",
  });
  inspectorBackend.registerEnum("Emulation.VirtualTimePolicy", {
    Advance: "advance",
    Pause: "pause",
  ...
  inspectorBackend.registerCommand(
    ...
    [
      ...
      { name: "mobile", type: "boolean", optional: false },
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "hidden", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "Emulation.setDocumentCookieDisabled",
    [{ name: "disabled", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerEnum(
    "Emulation.SetEmitTouchEventsForMouseRequestConfiguration",
  ...
  inspectorBackend.registerCommand(
    ...
    [
      { name: "media", type: "string", optional: true },
      { name: "features", type: "object", optional: true },
    ],
    []
  );
  inspectorBackend.registerEnum(
    "Emulation.SetEmulatedVisionDeficiencyRequestType",
    {
      None: "none",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "pageScaleFactor", type: "number", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [
      { name: "policy", type: "string", optional: false },
      { name: "budget", type: "number", optional: true },
      {
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "timezoneId", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "imageTypes", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("HeadlessExperimental.ScreenshotParamsFormat", {
    Jpeg: "jpeg",
    Png: "png",
  });
  inspectorBackend.registerEvent(
  ...
  inspectorBackend.registerCommand(
    "IO.close",
    [{ name: "handle", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "IO.read",
  ...
  inspectorBackend.registerCommand(
    ...
    [
      { name: "securityOrigin", type: "string", optional: true },
      { name: "storageKey", type: "string", optional: true },
  ...
  inspectorBackend.registerEnum("Input.MouseButton", {
    None: "none",
    Left: "left",
    Middle: "middle",
    Right: "right",
  ...
  inspectorBackend.registerEnum("Input.DispatchDragEventRequestType", {
    DragEnter: "dragEnter",
    DragOver: "dragOver",
    Drop: "drop",
  ...
  inspectorBackend.registerEnum("Input.DispatchKeyEventRequestType", {
    KeyDown: "keyDown",
    KeyUp: "keyUp",
  ...
  inspectorBackend.registerEnum("Input.DispatchMouseEventRequestPointerType", {
    Mouse: "mouse",
    Pen: "pen",
  });
  inspectorBackend.registerCommand(
    ...
    [
      ...
      { name: "modifiers", type: "number", optional: true },
      { name: "timestamp", type: "number", optional: true },
      { name: "button", type: "string", optional: true },
      ...
      { name: "tiltY", type: "number", optional: true },
  ...
  inspectorBackend.registerEnum("Input.DispatchTouchEventRequestType", {
  ...
  inspectorBackend.registerCommand(
    ...
    [
      ...
      { name: "x", type: "number", optional: false },
      { name: "y", type: "number", optional: false },
      { name: "button", type: "string", optional: false },
      { name: "timestamp", type: "number", optional: true },
      { name: "deltaX", type: "number", optional: true },
      { name: "deltaY", type: "number", optional: true },
      { name: "modifiers", type: "number", optional: true },
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "ignore", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "layerId", type: "string", optional: false }],
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "tiles", type: "object", optional: false }],
    ["snapshotId"]
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Log.LogEntryLevel", {
    Verbose: "verbose",
    Info: "info",
    Warning: "warning",
    Error: "error",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "suppressed", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Network.CookiePriority", {
    Low: "Low",
    Medium: "Medium",
    High: "High",
  });
  inspectorBackend.registerEnum("Network.CookieSourceScheme", {
    Unset: "Unset",
    NonSecure: "NonSecure",
    Secure: "Secure",
  });
  ...
  inspectorBackend.registerEnum("Network.CertificateTransparencyCompliance", {
    Unknown: "unknown",
  ...
  inspectorBackend.registerEnum("Network.ServiceWorkerResponseSource", {
    CacheStorage: "cache-storage",
    HttpCache: "http-cache",
    FallbackCode: "fallback-code",
    Network: "network",
  });
  inspectorBackend.registerEnum("Network.TrustTokenParamsRefreshPolicy", {
    UseCached: "UseCached",
    Refresh: "Refresh",
  });
  inspectorBackend.registerEnum("Network.TrustTokenOperationType", {
    Issuance: "Issuance",
    Redemption: "Redemption",
    Signing: "Signing",
  });
  inspectorBackend.registerEnum("Network.AlternateProtocolUsage", {
  ...
  inspectorBackend.registerEnum("Network.AuthChallengeSource", {
    Server: "Server",
    Proxy: "Proxy",
  });
  inspectorBackend.registerEnum("Network.AuthChallengeResponseResponse", {
    Default: "Default",
    CancelAuth: "CancelAuth",
    ProvideCredentials: "ProvideCredentials",
  });
  inspectorBackend.registerEnum("Network.InterceptionStage", {
    Request: "Request",
  ...
  inspectorBackend.registerEnum("Network.ContentEncoding", {
    Deflate: "deflate",
    Gzip: "gzip",
    Br: "br",
  });
  ...
  inspectorBackend.registerEnum("Network.IPAddressSpace", {
    Local: "Local",
    Private: "Private",
    Public: "Public",
    Unknown: "Unknown",
  ...
  inspectorBackend.registerEnum("Network.CrossOriginEmbedderPolicyValue", {
    None: "None",
    Credentialless: "Credentialless",
    RequireCorp: "RequireCorp",
  });
  inspectorBackend.registerEnum("Network.ReportStatus", {
    Queued: "Queued",
    Pending: "Pending",
    MarkedForRemoval: "MarkedForRemoval",
    Success: "Success",
  });
  inspectorBackend.registerEvent("Network.dataReceived", [
    "requestId",
    "timestamp",
    "dataLength",
    "encodedDataLength",
  ]);
  inspectorBackend.registerEvent("Network.eventSourceMessageReceived", [
    "requestId",
    "timestamp",
    "eventName",
    "eventId",
  ...
  inspectorBackend.registerEvent("Network.loadingFailed", [
    "requestId",
    "timestamp",
    "type",
    "errorText",
  ...
  inspectorBackend.registerEvent("Network.loadingFinished", [
    "requestId",
    "timestamp",
    "encodedDataLength",
  ...
  inspectorBackend.registerEvent("Network.requestServedFromCache", [
    "requestId",
  ]);
  ...
  inspectorBackend.registerEvent("Network.signedExchangeReceived", [
    "requestId",
    "info",
  ]);
  inspectorBackend.registerEvent("Network.responseReceived", [
    "requestId",
    "loaderId",
    "timestamp",
    "type",
  ...
  inspectorBackend.registerEvent("Network.webSocketClosed", [
    "requestId",
    "timestamp",
  ]);
  inspectorBackend.registerEvent("Network.webSocketCreated", [
    "requestId",
    "url",
    "initiator",
  ]);
  inspectorBackend.registerEvent("Network.webSocketFrameError", [
    "requestId",
    "timestamp",
    "errorMessage",
  ]);
  inspectorBackend.registerEvent("Network.webSocketFrameReceived", [
    "requestId",
    "timestamp",
    "response",
  ]);
  inspectorBackend.registerEvent("Network.webSocketFrameSent", [
    "requestId",
    "timestamp",
    "response",
  ]);
  inspectorBackend.registerEvent("Network.webSocketHandshakeResponseReceived", [
    "requestId",
    "timestamp",
    "response",
  ]);
  inspectorBackend.registerEvent("Network.webSocketWillSendHandshakeRequest", [
    "requestId",
    "timestamp",
    "wallTime",
    "request",
  ]);
  inspectorBackend.registerEvent("Network.webTransportCreated", [
    "transportId",
    "url",
    "timestamp",
    "initiator",
  ]);
  inspectorBackend.registerEvent("Network.webTransportConnectionEstablished", [
    "transportId",
    "timestamp",
  ]);
  inspectorBackend.registerEvent("Network.webTransportClosed", [
    "transportId",
    "timestamp",
  ]);
  ...
  inspectorBackend.registerEvent("Network.trustTokenOperationDone", [
    "status",
    "type",
    "requestId",
    "topLevelOrigin",
  ...
  inspectorBackend.registerEvent("Network.subresourceWebBundleMetadataError", [
    "requestId",
    "errorMessage",
  ]);
  inspectorBackend.registerEvent(
    "Network.subresourceWebBundleInnerResponseParsed",
    ["innerRequestId", "innerRequestURL", "bundleRequestId"]
  );
  inspectorBackend.registerEvent(
  ...
  inspectorBackend.registerEvent("Network.reportingApiReportUpdated", [
    "report",
  ]);
  inspectorBackend.registerEvent(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "encodings", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "urls", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "Network.setBypassServiceWorker",
    [{ name: "bypass", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "Network.setCacheDisabled",
    [{ name: "cacheDisabled", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "Network.setCookie",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "headers", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "patterns", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  // Overlay.
  inspectorBackend.registerEnum("Overlay.LineStylePattern", {
    Dashed: "dashed",
    Dotted: "dotted",
  });
  inspectorBackend.registerEnum("Overlay.ContrastAlgorithm", {
    Aa: "aa",
    Aaa: "aaa",
    Apca: "apca",
  });
  inspectorBackend.registerEnum("Overlay.ColorFormat", {
    Rgb: "rgb",
    Hsl: "hsl",
    Hwb: "hwb",
    Hex: "hex",
  ...
  inspectorBackend.registerEvent("Overlay.inspectNodeRequested", [
    "backendNodeId",
  ]);
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "nodeIds", type: "object", optional: false }],
    ["highlights"]
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [
      { name: "quad", type: "object", optional: false },
      { name: "color", type: "object", optional: true },
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "gridNodeHighlightConfigs", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "Overlay.setShowFlexOverlays",
    [{ name: "flexNodeHighlightConfigs", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "result", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "hingeConfig", type: "object", optional: true }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  // Page.
  inspectorBackend.registerEnum("Page.AdFrameType", {
    None: "none",
    Child: "child",
    Root: "root",
  });
  inspectorBackend.registerEnum("Page.AdFrameExplanation", {
  ...
  inspectorBackend.registerEnum("Page.CrossOriginIsolatedContextType", {
    Isolated: "Isolated",
  ...
  inspectorBackend.registerEnum("Page.OriginTrialUsageRestriction", {
    None: "None",
    Subset: "Subset",
  });
  ...
  inspectorBackend.registerEnum("Page.ClientNavigationDisposition", {
  ...
  inspectorBackend.registerEnum("Page.NavigationType", {
  ...
  inspectorBackend.registerEnum("Page.BackForwardCacheNotRestoredReasonType", {
  ...
  inspectorBackend.registerEnum("Page.FileChooserOpenedEventMode", {
    SelectSingle: "selectSingle",
    SelectMultiple: "selectMultiple",
  });
  inspectorBackend.registerEvent("Page.fileChooserOpened", [
    "frameId",
    "mode",
    "backendNodeId",
  ]);
  inspectorBackend.registerEvent("Page.frameAttached", [
    "frameId",
    "parentFrameId",
    "stack",
    "adScriptId",
  ]);
  inspectorBackend.registerEvent("Page.frameClearedScheduledNavigation", [
    "frameId",
  ]);
  inspectorBackend.registerEnum("Page.FrameDetachedEventReason", {
    Remove: "remove",
    Swap: "swap",
  });
  ...
  inspectorBackend.registerEvent("Page.frameRequestedNavigation", [
    "frameId",
    "reason",
    "url",
    "disposition",
  ]);
  inspectorBackend.registerEvent("Page.frameScheduledNavigation", [
    "frameId",
    "delay",
    "reason",
    "url",
  ...
  inspectorBackend.registerEvent("Page.downloadWillBegin", [
    "frameId",
    "guid",
    "url",
    "suggestedFilename",
  ]);
  inspectorBackend.registerEnum("Page.DownloadProgressEventState", {
    InProgress: "inProgress",
    Completed: "completed",
    Canceled: "canceled",
  });
  inspectorBackend.registerEvent("Page.downloadProgress", [
    "guid",
    "totalBytes",
    "receivedBytes",
    "state",
  ...
  inspectorBackend.registerEvent("Page.javascriptDialogOpening", [
    "url",
    "message",
    "type",
    "hasBrowserHandler",
  ...
  inspectorBackend.registerEvent("Page.lifecycleEvent", [
    "frameId",
    "loaderId",
    "name",
    "timestamp",
  ]);
  inspectorBackend.registerEvent("Page.backForwardCacheNotUsed", [
    "loaderId",
    "frameId",
    "notRestoredExplanations",
    "notRestoredExplanationsTree",
  ]);
  inspectorBackend.registerEvent("Page.prerenderAttemptCompleted", [
    "initiatingFrameId",
    "prerenderingUrl",
    "finalStatus",
    "disallowedApiMethod",
  ...
  inspectorBackend.registerEvent("Page.navigatedWithinDocument", [
    "frameId",
    "url",
  ]);
  inspectorBackend.registerEvent("Page.screencastFrame", [
    "data",
    "metadata",
    "sessionId",
  ]);
  inspectorBackend.registerEvent("Page.screencastVisibilityChanged", [
    "visible",
  ]);
  inspectorBackend.registerEvent("Page.windowOpen", [
    "url",
    "windowName",
    "windowFeatures",
    "userGesture",
  ]);
  inspectorBackend.registerEvent("Page.compilationCacheProduced", [
    "url",
    "data",
  ]);
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Page.CaptureScreenshotRequestFormat", {
    Jpeg: "jpeg",
    Png: "png",
    Webp: "webp",
  });
  ...
  inspectorBackend.registerEnum("Page.CaptureSnapshotRequestFormat", {
    MHTML: "mhtml",
  });
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "entryId", type: "number", optional: false }],
    []
  );
  inspectorBackend.registerEnum("Page.PrintToPDFRequestTransferMode", {
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "identifier", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    "Page.setFontSizes",
    [{ name: "fontSizes", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Page.SetDownloadBehaviorRequestBehavior", {
    Deny: "deny",
    Allow: "allow",
    Default: "default",
  });
  ...
  inspectorBackend.registerEnum(
    "Page.SetTouchEmulationEnabledRequestConfiguration",
    { Mobile: "mobile", Desktop: "desktop" }
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Page.StartScreencastRequestFormat", {
    Jpeg: "jpeg",
    Png: "png",
  });
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Page.SetWebLifecycleStateRequestState", {
    Frozen: "frozen",
    Active: "active",
  });
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "scripts", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Page.SetSPCTransactionModeRequestMode", {
    None: "none",
  ...
  inspectorBackend.registerEnum("Performance.EnableRequestTimeDomain", {
    TimeTicks: "timeTicks",
    ThreadTicks: "threadTicks",
  });
  inspectorBackend.registerCommand(
    "Performance.enable",
    [{ name: "timeDomain", type: "string", optional: true }],
    []
  );
  inspectorBackend.registerEnum("Performance.SetTimeDomainRequestTimeDomain", {
    TimeTicks: "timeTicks",
    ThreadTicks: "threadTicks",
  });
  inspectorBackend.registerCommand(
    "Performance.setTimeDomain",
    [{ name: "timeDomain", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand("Performance.getMetrics", [], ["metrics"]);

  // PerformanceTimeline.
  inspectorBackend.registerEvent("PerformanceTimeline.timelineEventAdded", [
    "event",
  ]);
  inspectorBackend.registerCommand(
    "PerformanceTimeline.enable",
    [{ name: "eventTypes", type: "object", optional: false }],
    []
  );

  // Security.
  inspectorBackend.registerEnum("Security.MixedContentType", {
    Blockable: "blockable",
  ...
  inspectorBackend.registerEnum("Security.SafetyTipStatus", {
    BadReputation: "badReputation",
    Lookalike: "lookalike",
  });
  inspectorBackend.registerEnum("Security.CertificateErrorAction", {
    Continue: "continue",
    Cancel: "cancel",
  });
  inspectorBackend.registerEvent("Security.certificateError", [
    "eventId",
    "errorType",
    "requestURL",
  ]);
  inspectorBackend.registerEvent("Security.visibleSecurityStateChanged", [
    "visibleSecurityState",
  ]);
  inspectorBackend.registerEvent("Security.securityStateChanged", [
    "securityState",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "override", type: "boolean", optional: false }],
    []
  );
  ...
  inspectorBackend.registerEvent("ServiceWorker.workerErrorReported", [
    "errorMessage",
  ]);
  inspectorBackend.registerEvent("ServiceWorker.workerRegistrationUpdated", [
    "registrations",
  ]);
  inspectorBackend.registerEvent("ServiceWorker.workerVersionUpdated", [
    "versions",
  ]);
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "versionId", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "scopeURL", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Storage.InterestGroupAccessType", {
    Join: "join",
    Leave: "leave",
    Update: "update",
    Bid: "bid",
  ...
  inspectorBackend.registerEvent("Storage.cacheStorageContentUpdated", [
    "origin",
    "cacheName",
  ]);
  inspectorBackend.registerEvent("Storage.cacheStorageListUpdated", ["origin"]);
  inspectorBackend.registerEvent("Storage.indexedDBContentUpdated", [
    "origin",
    "storageKey",
    "databaseName",
    "objectStoreName",
  ]);
  inspectorBackend.registerEvent("Storage.indexedDBListUpdated", [
    "origin",
    "storageKey",
  ]);
  inspectorBackend.registerEvent("Storage.interestGroupAccessed", [
    "accessTime",
    "type",
    "ownerOrigin",
    "name",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "issuerOrigin", type: "string", optional: false }],
    ["didDeleteTokens"]
  );
  inspectorBackend.registerCommand(
  ...
  // SystemInfo.
  inspectorBackend.registerEnum("SystemInfo.SubsamplingFormat", {
    Yuv420: "yuv420",
    Yuv422: "yuv422",
    Yuv444: "yuv444",
  });
  inspectorBackend.registerEnum("SystemInfo.ImageType", {
    Jpeg: "jpeg",
    Webp: "webp",
    Unknown: "unknown",
  });
  inspectorBackend.registerCommand(
    "SystemInfo.getInfo",
    [],
    ["gpu", "modelName", "modelVersion", "commandLine"]
  );
  inspectorBackend.registerCommand(
  ...
  // Target.
  inspectorBackend.registerEvent("Target.attachedToTarget", [
    "sessionId",
    "targetInfo",
    "waitingForDebugger",
  ]);
  inspectorBackend.registerEvent("Target.detachedFromTarget", [
    "sessionId",
    "targetId",
  ]);
  inspectorBackend.registerEvent("Target.receivedMessageFromTarget", [
    "sessionId",
    "message",
    "targetId",
  ]);
  ...
  inspectorBackend.registerEvent("Target.targetCrashed", [
    "targetId",
    "status",
    "errorCode",
  ]);
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "browserContextId", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [
      { name: "discover", type: "boolean", optional: false },
      { name: "filter", type: "object", optional: true },
    ],
    []
  );
  ...
  // Tethering.
  inspectorBackend.registerEvent("Tethering.accepted", [
    "port",
    "connectionId",
  ]);
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Tracing.StreamFormat", {
    Json: "json",
    Proto: "proto",
  });
  inspectorBackend.registerEnum("Tracing.StreamCompression", {
    None: "none",
    Gzip: "gzip",
  });
  inspectorBackend.registerEnum("Tracing.MemoryDumpLevelOfDetail", {
    Background: "background",
    Light: "light",
    Detailed: "detailed",
  });
  inspectorBackend.registerEnum("Tracing.TracingBackend", {
    Auto: "auto",
    Chrome: "chrome",
    System: "system",
  });
  inspectorBackend.registerEvent("Tracing.bufferUsage", [
    "percentFull",
    "eventCount",
    "value",
  ]);
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "syncId", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Tracing.StartRequestTransferMode", {
  ...
  // Fetch.
  inspectorBackend.registerEnum("Fetch.RequestStage", {
    Request: "Request",
    Response: "Response",
  });
  inspectorBackend.registerEnum("Fetch.AuthChallengeSource", {
    Server: "Server",
    Proxy: "Proxy",
  });
  inspectorBackend.registerEnum("Fetch.AuthChallengeResponseResponse", {
    Default: "Default",
    CancelAuth: "CancelAuth",
    ProvideCredentials: "ProvideCredentials",
  });
  ...
  inspectorBackend.registerEvent("Fetch.authRequired", [
    "requestId",
    "request",
    "frameId",
    "resourceType",
  ...
  // WebAudio.
  inspectorBackend.registerEnum("WebAudio.ContextType", {
    Realtime: "realtime",
    Offline: "offline",
  });
  inspectorBackend.registerEnum("WebAudio.ContextState", {
    Suspended: "suspended",
    Running: "running",
    Closed: "closed",
  });
  inspectorBackend.registerEnum("WebAudio.ChannelCountMode", {
    ClampedMax: "clamped-max",
    Explicit: "explicit",
    Max: "max",
  });
  inspectorBackend.registerEnum("WebAudio.ChannelInterpretation", {
    Discrete: "discrete",
    Speakers: "speakers",
  });
  inspectorBackend.registerEnum("WebAudio.AutomationRate", {
    ARate: "a-rate",
    KRate: "k-rate",
  });
  inspectorBackend.registerEvent("WebAudio.contextCreated", ["context"]);
  inspectorBackend.registerEvent("WebAudio.contextWillBeDestroyed", [
    "contextId",
  ]);
  ...
  inspectorBackend.registerEvent("WebAudio.audioListenerWillBeDestroyed", [
    "contextId",
    "listenerId",
  ]);
  inspectorBackend.registerEvent("WebAudio.audioNodeCreated", ["node"]);
  inspectorBackend.registerEvent("WebAudio.audioNodeWillBeDestroyed", [
    "contextId",
    "nodeId",
  ]);
  inspectorBackend.registerEvent("WebAudio.audioParamCreated", ["param"]);
  inspectorBackend.registerEvent("WebAudio.audioParamWillBeDestroyed", [
    "contextId",
    "nodeId",
    "paramId",
  ]);
  inspectorBackend.registerEvent("WebAudio.nodesConnected", [
    "contextId",
    "sourceId",
    "destinationId",
    "sourceOutputIndex",
  ...
  inspectorBackend.registerEvent("WebAudio.nodesDisconnected", [
    "contextId",
    "sourceId",
    "destinationId",
    "sourceOutputIndex",
  ...
  inspectorBackend.registerEvent("WebAudio.nodeParamConnected", [
    "contextId",
    "sourceId",
    "destinationId",
    "sourceOutputIndex",
  ]);
  inspectorBackend.registerEvent("WebAudio.nodeParamDisconnected", [
    "contextId",
    "sourceId",
    "destinationId",
    "sourceOutputIndex",
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "contextId", type: "string", optional: false }],
    ["realtimeData"]
  );

  // WebAuthn.
  inspectorBackend.registerEnum("WebAuthn.AuthenticatorProtocol", {
    U2f: "u2f",
    Ctap2: "ctap2",
  });
  inspectorBackend.registerEnum("WebAuthn.Ctap2Version", {
    Ctap2_0: "ctap2_0",
    Ctap2_1: "ctap2_1",
  });
  inspectorBackend.registerEnum("WebAuthn.AuthenticatorTransport", {
    Usb: "usb",
    Nfc: "nfc",
    Ble: "ble",
    Cable: "cable",
  ...
  inspectorBackend.registerCommand(
    "WebAuthn.enable",
    [{ name: "enableUI", type: "boolean", optional: true }],
    []
  );
  ...
  // Media.
  inspectorBackend.registerEnum("Media.PlayerMessageLevel", {
    Error: "error",
    Warning: "warning",
    Info: "info",
    Debug: "debug",
  });
  inspectorBackend.registerEvent("Media.playerPropertiesChanged", [
    "playerId",
    "properties",
  ]);
  inspectorBackend.registerEvent("Media.playerEventsAdded", [
    "playerId",
    "events",
  ]);
  inspectorBackend.registerEvent("Media.playerMessagesLogged", [
    "playerId",
    "messages",
  ]);
  inspectorBackend.registerEvent("Media.playerErrorsRaised", [
    "playerId",
    "errors",
  ]);
  ...
  inspectorBackend.registerEnum("Debugger.BreakLocationType", {
    DebuggerStatement: "debuggerStatement",
    Call: "call",
    Return: "return",
  });
  inspectorBackend.registerEnum("Debugger.ScriptLanguage", {
    JavaScript: "JavaScript",
    WebAssembly: "WebAssembly",
  });
  inspectorBackend.registerEnum("Debugger.DebugSymbolsType", {
    None: "None",
    SourceMap: "SourceMap",
  ...
  inspectorBackend.registerEnum(
    "Debugger.ContinueToLocationRequestTargetCallFrames",
  ...
  inspectorBackend.registerCommand(
    "Debugger.enable",
    [{ name: "maxScriptsCacheSize", type: "number", optional: true }],
    ["debuggerId"]
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [
      ...
      { name: "end", type: "object", optional: true },
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "scriptId", type: "string", optional: false }],
    ["streamId", "totalNumberOfLines", "functionBodyOffsets", "chunk"]
  );
  inspectorBackend.registerCommand(
    "Debugger.nextWasmDisassemblyChunk",
    [{ name: "streamId", type: "string", optional: false }],
    ["chunk"]
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "stackTraceId", type: "object", optional: false }],
    ["stackTrace"]
  );
  inspectorBackend.registerCommand("Debugger.pause", [], []);
  inspectorBackend.registerCommand(
    "Debugger.pauseOnAsyncCall",
    [{ name: "parentStackTraceId", type: "object", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
    "Debugger.removeBreakpoint",
    [{ name: "breakpointId", type: "string", optional: false }],
    []
  );
  inspectorBackend.registerEnum("Debugger.RestartFrameRequestMode", {
    StepInto: "StepInto",
  });
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerCommand(
    "Debugger.resume",
    [{ name: "terminateOnResume", type: "boolean", optional: true }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum(
    "Debugger.SetInstrumentationBreakpointRequestInstrumentation",
    {
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "instrumentation", type: "string", optional: false }],
    ["breakpointId"]
  );
  inspectorBackend.registerCommand(
  ...
  inspectorBackend.registerEnum("Debugger.SetPauseOnExceptionsRequestState", {
    None: "none",
    Uncaught: "uncaught",
    All: "all",
  });
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "skip", type: "boolean", optional: false }],
    []
  );
  inspectorBackend.registerCommand(
  ...
  // HeapProfiler.
  inspectorBackend.registerEvent("HeapProfiler.addHeapSnapshotChunk", [
    "chunk",
  ]);
  inspectorBackend.registerEvent("HeapProfiler.heapStatsUpdate", [
    "statsUpdate",
  ]);
  inspectorBackend.registerEvent("HeapProfiler.lastSeenObjectId", [
    "lastSeenObjectId",
    "timestamp",
  ]);
  inspectorBackend.registerEvent("HeapProfiler.reportHeapSnapshotProgress", [
    "done",
    "total",
    "finished",
  ]);
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "heapObjectId", type: "string", optional: false }],
    []
  );
  ...
  // Profiler.
  inspectorBackend.registerEvent("Profiler.consoleProfileFinished", [
    "id",
    "location",
    "profile",
    "title",
  ]);
  inspectorBackend.registerEvent("Profiler.consoleProfileStarted", [
    "id",
    "location",
    "title",
  ]);
  inspectorBackend.registerEvent("Profiler.preciseCoverageDeltaUpdate", [
    "timestamp",
    "occasion",
    "result",
  ]);
  ...
  inspectorBackend.registerEvent("Runtime.bindingCalled", [
    "name",
    "payload",
    "executionContextId",
  ]);
  ...
  inspectorBackend.registerEvent("Runtime.consoleAPICalled", [
    "type",
    "args",
    "executionContextId",
    "timestamp",
  ...
  inspectorBackend.registerEvent("Runtime.exceptionRevoked", [
    "reason",
    "exceptionId",
  ]);
  inspectorBackend.registerEvent("Runtime.exceptionThrown", [
    "timestamp",
    "exceptionDetails",
  ]);
  inspectorBackend.registerEvent("Runtime.executionContextCreated", [
    "context",
  ]);
  inspectorBackend.registerEvent("Runtime.executionContextDestroyed", [
    "executionContextId",
  ]);
  inspectorBackend.registerEvent("Runtime.executionContextsCleared", []);
  inspectorBackend.registerEvent("Runtime.inspectRequested", [
    "object",
    "hints",
    "executionContextId",
  ]);
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "objectGroup", type: "string", optional: false }],
    []
  );
  ...
  inspectorBackend.registerCommand(
    ...
    [{ name: "errorObjectId", type: "string", optional: false }],
    ["exceptionDetails"]
  );
