...
declare namespace ProtocolProxyApi {
  ...
  export interface NetworkApi {
     ...
     * For testing.
     */
    invoke_setDataSizeLimitsForTest(params: Protocol.Network.SetDataSizeLimitsForTestRequest): Promise<Protocol.ProtocolResponseWithError>;
  ...
  export interface DebuggerApi {
     ...
     */
    invoke_executeWasmEvaluator(params: Protocol.Debugger.ExecuteWasmEvaluatorRequest): Promise<Protocol.Debugger.ExecuteWasmEvaluatorResponse>;
...
interface ProtocolProxyApiWorkaround_HeadlessExperimentalDispatcher extends ProtocolProxyApi.HeadlessExperimentalDispatcher {}
