...
export class Importer {
  static requestsFromHARLog(log: HARLog): SDK.NetworkRequest.NetworkRequest[] {
    ...
    for (const entry of log.entries) {
      ...
      let pageLoad: SDK.NetworkLog.PageLoad | (SDK.NetworkLog.PageLoad | undefined) = pageref ? pageLoads.get(pageref) : undefined;
  ...
  static _fillRequestFromHAREntry(request: SDK.NetworkRequest.NetworkRequest, entry: HAREntry, pageLoad: SDK.NetworkLog.PageLoad | undefined): void {
    // Request data.
  ...
  static _getResourceType(request: SDK.NetworkRequest.NetworkRequest, entry: HAREntry, pageLoad: SDK.NetworkLog.PageLoad | undefined): Common.ResourceType.ResourceType {
