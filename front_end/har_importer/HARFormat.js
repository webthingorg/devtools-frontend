...
class HARBase {
  ...
  constructor(data) {
    ...
    /** @type {!Map<string, (string|!Array<!HARWebSocketMessage>|HARInitiator|number|undefined)>} */
  ...
  customAsString(name) {
    ...
    return String(this._custom.get(name));
  }
  ...
  customAsNumber(name) {
    ...
    const value = Number(this._custom.get(name));
