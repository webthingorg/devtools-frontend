...
Timeline.TimelineTreeView = class extends UI.VBox {
  ...
  init() {
    ...
    this._dataGrid = new DataGrid.SortableDataGrid({gridName: ls`Performance`, columnsArray: columns});
...
Timeline.TimelineStackView = class extends UI.VBox {
  constructor(treeView) {
    ...
    this._dataGrid = new DataGrid.ViewportDataGrid({gridName: ls`Timeline Stack`, columnsArray: columns});
    this._dataGrid.setResizeMethod(DataGrid.DataGrid.ResizeMethod.Last);
