...
class MainWidget extends UI.Widget.VBox {
  ...
  setModelAndUpdateBoundaries(model) {
    ...
    this._webVitals.chartViewport.setBoundaries(
        left,
        right - left,
    );
    this._webVitals.chartViewport.setWindowTimes(
        left,
        right,
    );
...
export class TimelineFlameChartView extends UI.Widget.VBox {
  ...
  _onWindowChanged(event) {
    ...
    this._mainWidget.setWindowTimes(window.left, window.right);
