...
class MainSplitWidget extends UI.SplitWidget.SplitWidget {
  ...
  setModelAndUpdateBoundaries(model: PerformanceModel|null): void {
    ...
    const prepareEvents = /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
                          /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
                          /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
                          /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
                          /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
                          /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
        ...
        /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */ (
            ...
            /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
            /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */
            /** @param {function(!SDK.TracingModel.Event): boolean} filterFunction */ filterFunction:
                (arg0: SDK.TracingModel.Event) => boolean): number[] =>
