...
export class NodeConnectionsView extends UI.Widget.VBox implements UI.ListWidget.Delegate {
  ...
  renderItem(rule: Adb.PortForwardingRule, editable: boolean): Element {
  ...
  _createEditor(): UI.ListWidget.Editor<Adb.PortForwardingRule> {
    ...
    function addressValidator(rule: Adb.PortForwardingRule, index: number, input: HTMLInputElement | HTMLSelectElement): UI.ListWidget.ValidatorResult {
