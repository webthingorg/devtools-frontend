...
/** @interface */
Profiler.HeapSnapshotGridNode.ChildrenProvider = ProfilerModule.HeapSnapshotGridNodes.ChildrenProvider;
...
/** @constructor */
Profiler.ProfileType = ProfilerModule.ProfileType.ProfileType;

/** @enum {symbol} */
Profiler.ProfileType.Events = ProfilerModule.ProfileType.Events;

/** @interface */
Profiler.ProfileType.DataDisplayDelegate = ProfilerModule.ProfileType.DataDisplayDelegate;
...
/** @constructor */
Profiler.ProfileSidebarTreeElement = ProfilerModule.ProfilesPanel.ProfileSidebarTreeElement;
