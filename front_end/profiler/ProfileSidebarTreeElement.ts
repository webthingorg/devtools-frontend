...
sharedFileSelectorElement: HTMLInputElement | null = null;
...
export class ProfileSidebarTreeElement extends UI.TreeOutline.TreeElement {
  ...
  // Transformation: updateReturnType
  // Transformation: updateParameters
  _onProfileReceived(event: Common.EventTarget.EventTargetEvent): void {
    this._createSaveLink();
  }
  ...
  onattach(): void {
    ...
    UI.ARIAUtils.setDescription(this.listItemElement, i18nString(UIStrings.singlePlaceholder, { PH1: this.profile.profileType().name }));
  }
