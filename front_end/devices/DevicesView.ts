...
export const UIStrings = {
  ...
  */
  thisPanelHasBeenDeprecatedIn: 'This panel has been deprecated in favor of the {PH1} interface, which has equivalent functionality.',
};
...
Devices.DevicesView = class extends UI.Widget.VBox {
  constructor() {
    ...
    const documentationLink = UI.Fragment.html `<a class="devtools-link" role="link" tabindex="0" href="#" style="display: inline; cursor: pointer;">chrome://inspect/#devices</a>`;
    ...
    deprecationMessage.appendChild(i18n.i18n.getFormatLocalizedString(str_, UIStrings.thisPanelHasBeenDeprecatedIn, { PH1: documentationLink }));
