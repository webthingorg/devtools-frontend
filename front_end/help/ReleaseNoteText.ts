...
export const releaseNoteText: ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      {
        title: 'New Performance Heads-Up Display',
      ...
      {
        title: 'Escape double quotes when printing strings',
      ...
      {
        title: 'PWA updates',
        subtitle: 'Improve PWA installability warning message, new warnings for manifest screenshots, and more. ',
