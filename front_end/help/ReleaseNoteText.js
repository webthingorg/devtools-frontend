...
export const releaseNoteText = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        subtitle: 'Capture node screenshot for full node including content below the fold.',
      ...
      },
      {
        ...
        subtitle:
            'Support forcing the CSS :target state, color picker for custom CSS property, new context menu to duplicate element, and more.',
