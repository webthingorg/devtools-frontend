...
export const releaseNoteText = [
  {
    ...
    highlights: [
      ...
      {
        title: 'JavaScript compilation cache information in Performance panel',
        subtitle:
            'JavaScript compilation cache information is now always displayed in the Summary tab of the Performance panel.',
        link: 'https://developers.google.com/web/updates/2020/06/devtools#js-compilation-cache',
      },
    ],
