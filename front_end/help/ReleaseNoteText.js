...
export const releaseNoteText = [
  {
    ...
    highlights: [

      {
        ...
        subtitle: 'Breakpoint on Trusted Type violations and link to more information in Issues tab.',
        link: 'https://developers.google.com/web/updates/2021/01/devtools#trusted-type',
      },
      {
        title: 'Capture node screenshot beyond viewport',
        subtitle: 'Capture node screenshots for a full node, including content below the fold.',
      ...
      },
      {
        ...
        subtitle: 'Display Trusted Token parameters and result of network requests.',
      ...
      },
      {
        ...
        subtitle:
            'Force the CSS :target state, custom CSS property color picker, new context menu to duplicate elements, and more.',
        link: 'https://developers.google.com/web/updates/2021/01/devtools#elements-panel',
      },
      {
        title: 'Cookies updates',
        subtitle: 'Show URL-decoded cookies, only clear visible cookies, and more.',
