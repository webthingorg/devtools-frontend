...
export const releaseNoteText = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        subtitle: 'Syntax support for optional chaining, private fields, and the nullish coalescing operator.',
      ...
      },
      {
        ...
        subtitle: 'Bytecode offsets are now displayed next to Wasm disassemly rather than line numbers.',
