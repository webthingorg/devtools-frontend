...
export const releaseNoteText = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools#sourcemaperrors'),
      },
      {
    ...
    highlights: [
      {
        ...
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/12/devtools#redeclarations'),
      },
      {
    ...
    highlights: [
      {
        ...
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#blockedcookies'),
      },
      {
        title: 'View cookie values',
        subtitle: 'Click a row in the Cookies pane in the Application panel to see the cookie\'s value.',
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#cookiepreviews'),
      },
      {
        ...
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#userpreferences'),
      },
      {
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2019/07/devtools#breakpointeditor'),
      },
      {
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2019/07/devtools#backgroundservices'),
      },
    ],
    ...
    highlights: [
      {
        ...
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/05/devtools#eagerevaluation'),
      },
      {
    ...
    highlights: [
      {
        ...
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools#network-search'),
      },
      {
    ...
    highlights: [
      {
        ...
        link:
            UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/02/devtools#pretty-printing'),
      },
      {
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/11/devtools-release-notes#console-sidebar'),
      },
      {
        title: 'Group similar console messages',
        subtitle: 'The Console now groups similar messages by default.',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/11/devtools-release-notes#group-similar'),
      },
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/10/devtools-release-notes#audits'),
      },
      {
        title: 'Custom push notifications',
        subtitle: 'Simulate push notifications with custom data.',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/10/devtools-release-notes#push'),
      },
      {
        title: 'Custom background sync events',
        subtitle: 'Trigger background sync events with custom tags.',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/10/devtools-release-notes#sync'),
      },
    ],
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/08/devtools-release-notes#await'),
      },
      {
        title: 'New screenshot workflows',
        subtitle: 'Take screenshots of a portion of the viewport, or of specific HTML nodes.',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/08/devtools-release-notes#screenshots'),
      },
      {
        title: 'CSS Grid highlighting',
        subtitle: 'Hover over an element to see the CSS Grid that\'s affecting it.',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/08/devtools-release-notes#css-grid-highlighting'),
      },
      {
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/08/devtools-release-notes#console-filters'),
      },
      {
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/08/devtools-release-notes#cache-preview'),
      }
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/07/devtools-release-notes#storage'),
      },
      {
        title: 'Cache timestamps',
        subtitle: 'View when a service worker cached a response.',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/07/devtools-release-notes#time-cached'),
      },
      {
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/05/devtools-release-notes#continue'),
      },
      {
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/05/devtools-release-notes#object-previews'),
      },
      {
        title: 'Real-time Coverage tab updates',
        subtitle: 'See what code is being used in real-time.',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/05/devtools-release-notes#coverage'),
      }
    ],
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/03/devtools-release-notes#performance-panel'),
      },
      {
        title: 'Editable cookies',
        subtitle: 'You can edit any existing cookies and create new ones in the Application panel',
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/03/devtools-release-notes#cookies'),
      },
      {
      ...
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer(
            'https://developers.google.com/web/updates/2017/03/devtools-release-notes#out-of-memory-breakpoints'),
      },
    ],
