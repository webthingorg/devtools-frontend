    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools#motog4'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools#cookies'),
      },
      {
        title: 'More accurate web app manifest icons',
        subtitle: 'DevTools now shows the exact icon that Chrome uses.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools#manifesticons'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools#content'),
      },
      {
        title: 'Source map errors in the Console',
        subtitle: 'The Console now tells you when a source map has failed to load or parse.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools#sourcemaperrors'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools#scrolling'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2020/01/devtools'),
  },
  {
    version: 22,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/12/devtools#redeclarations'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/12/devtools#webassembly'),
      },
      {
        title: 'Network panel updates',
        subtitle: 'View request initiator chains, highlight requests in the Overview, and more.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/12/devtools#network'),
      },
      {
        title: 'Audits panel updates',
        subtitle: 'The redesigned configuration UI has simplified throttling options.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/12/devtools#audits'),
      },
      {
        title: 'Coverage tab updates',
        subtitle: 'Choose per-function or per-block coverage, and more.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/12/devtools#coverage'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/12/devtools'),
  },
  {
    version: 21,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#blockedcookies'),
      },
      {
        title: 'View cookie values',
        subtitle: 'Click a row in the Cookies pane in the Application panel to see the cookie\'s value.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#cookiepreviews'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#userpreferences'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#coverage'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#initiator'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#indentation'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools#console'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/10/devtools'),
  },
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/09/devtools#multiclient'),
      },
      {
        title: 'Payment Handler debugging',
        subtitle: 'Record Payment Handler events for 3 days, even when DevTools is closed.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/09/devtools#payments'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/09/devtools#audits'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/09/devtools#LCP'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/09/devtools#issues'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/09/devtools'),
  },
  {
    version: 19,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#copystyles'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#layoutshifts'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#audits'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#theming'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#breakpointeditor'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#prefetch'),
      },
      {
        title: 'Private properties when viewing objects',
        subtitle: 'The Console now shows private class fields in its object previews.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#privateclassfields'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools#backgroundservices'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/07/devtools'),
  },
  {
    version: 18,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/05/devtools#values'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/05/devtools#settings'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/05/devtools#websocket'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/05/devtools'),
  },
  {
    version: 17,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/04/devtools#presets'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/04/devtools#clear'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/04/devtools#indexeddb'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/04/devtools#uncompressed'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/04/devtools#inline'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/04/devtools'),
  },
  {
    version: 16,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/03/devtools#highlight'),
      },

      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/03/devtools#lighthouse'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/03/devtools#binary'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/03/devtools#screenshot'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/03/devtools#swfilters'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/03/devtools'),
  },
  {
    version: 15,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/01/devtools#logpoints'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/01/devtools#inspect'),
      },
      {
        title: 'Export code coverage data',
        subtitle: 'The Coverage tab now supports exporting coverage data as JSON.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/01/devtools#coverage'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/01/devtools#keyboard'),
      },
      {
        title: 'Save custom geolocation overrides',
        subtitle: 'Click Manage in the Sensors tab or open Settings > Geolocations.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/01/devtools#geolocation'),
      },
      {
        title: 'Code folding',
        subtitle: 'Go to Settings > Preferences > Sources and enable Code Folding to fold ' +
            'code in the Sources panel.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/01/devtools#folding'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2019/01/devtools'),
  },
  {
    version: 14,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/11/devtools#metrics'),
      },
      {
        title: 'Highlight text nodes',
        subtitle: 'Hover over a text node in the DOM Tree to highlight it in the viewport.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/11/devtools#highlight'),
      },
      {
        title: 'Copy JS path',
        subtitle:
            'Right-click a DOM node and select "Copy" > "Copy JS path" to quickly get a JavaScript expression that points to that node.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/11/devtools#copy'),
      },
      {
        title: 'Audits panel updates',
        subtitle:
            'A new audit that lists detected JS libraries and new keywords for accessing the Audits panel from the Command Menu.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/11/devtools#audits'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/11/devtools'),
  },
  {
    version: 13,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/10/devtools#hover'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/10/devtools#store'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/10/devtools#HAR'),
      },
      {
        title: 'Access the Command Menu from the Main Menu',
        subtitle: 'Open the Main Menu and select "Run command".',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/10/devtools#command-menu'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/10/devtools'),
  },
  {
    version: 12,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/08/devtools#watch'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/08/devtools#nodes'),
      },
      {
        title: 'Autocomplete Conditional Breakpoints',
        subtitle: 'Type expressions quickly and accurately.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/08/devtools#autocomplete'),
      },
      {
        title: 'Performance panel optimizations',
        subtitle: 'Faster loading and processing of Performance recordings.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/08/devtools#performance'),
      },
      {
        title: 'More reliable debugging',
        subtitle: 'Bug fixes for sourcemaps and blackboxing.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/08/devtools#debugging'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/08/devtools#ndb'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/08/devtools'),
  },
  {
    version: 11,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/05/devtools#eagerevaluation'),
      },
      {
        title: 'Argument hints',
        subtitle: `View a function's expected arguments in the Console.`,
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/05/devtools#hints'),
      },
      {
        title: 'Function autocompletion',
        subtitle: 'View available properties and methods after calling a function in the Console.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/05/devtools#autocomplete'),
      },
      {
        title: 'Audits panel updates',
        subtitle: 'Faster, more consisent audits, a new UI, and new audits, thanks to Lighthouse 3.0.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/05/devtools#lh3'),
      }
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/05/devtools'),
  },
  {
    version: 10,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools#network-search'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools#vars'),
      },
      {
        title: 'Stop infinite loops',
        subtitle: 'Pause JavaScript execution then select the new Stop Current JavaScript Call button.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools#stop'),
      },
      {
        title: 'Copy as fetch',
        subtitle: 'Right-click a network request then select Copy > Copy as fetch.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools#fetch'),
      },
      {
        title: 'More audits',
        subtitle: 'Two new audits, desktop configuration options, and viewing traces.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools#audits'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools#tabs'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/04/devtools'),
  },
  {
    version: 9,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/02/devtools#pretty-printing'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/02/devtools#previews'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/02/devtools#overrides'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/02/devtools#blackboxing'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/02/devtools'),
  },
  {
    version: 8,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/01/devtools#overrides'),
      },
      {
        title: 'Changes tab',
        subtitle: 'Track changes that you make locally in DevTools via the Changes tab.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/01/devtools#changes'),
      },
      {
        title: 'New accessibility tools',
        subtitle: 'Inspect the accessibility properties and contrast ratio of elements.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/01/devtools#a11y'),
      },
      {
        title: 'New audits',
        subtitle: 'New performance audits, a whole new category of SEO audits, and more.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/01/devtools#audits'),
      },
      {
        title: 'Code stepping updates',
        subtitle: 'Reliably step into web worker and asynchronous code.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/01/devtools#stepping'),
      },
      {
        title: 'Multiple recordings in the Performance panel',
        subtitle: 'Temporarily save up to 5 recordings.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/01/devtools#recordings'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2018/01/devtools'),
  },
  {
    version: 7,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/11/devtools-release-notes#perf-monitor'),
      },
      {
        title: 'Console sidebar',
        subtitle: 'Reduce console noise and focus on the messages that are important to you.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/11/devtools-release-notes#console-sidebar'),
      },
      {
        title: 'Group similar console messages',
        subtitle: 'The Console now groups similar messages by default.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/11/devtools-release-notes#group-similar'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/11/devtools-release-notes'),
  },
  {
    version: 6,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/10/devtools-release-notes#multi-client'),
      },
      {
        title: 'Workspaces 2.0',
        subtitle: 'Save changes made in DevTools to disk, now with more helpful UI and better auto-mapping.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/10/devtools-release-notes#workspaces'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/10/devtools-release-notes#audits'),
      },
      {
        title: 'Custom push notifications',
        subtitle: 'Simulate push notifications with custom data.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/10/devtools-release-notes#push'),
      },
      {
        title: 'Custom background sync events',
        subtitle: 'Trigger background sync events with custom tags.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/10/devtools-release-notes#sync'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/10/devtools-release-notes'),
  },
  {
    version: 5,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes#await'),
      },
      {
        title: 'New screenshot workflows',
        subtitle: 'Take screenshots of a portion of the viewport, or of specific HTML nodes.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes#screenshots'),
      },
      {
        title: 'CSS Grid highlighting',
        subtitle: 'Hover over an element to see the CSS Grid that\'s affecting it.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes#css-grid-highlighting'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes#query-objects'),
      },
      {
        title: 'New Console filters',
        subtitle: 'Filter out logging noise with the new negative and URL filters.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes#console-filters'),
      },
      {
        title: 'HAR imports in the Network panel',
        subtitle: 'Drag-and-drop a HAR file to analyze a previous network recording.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes#har-imports'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes#cache-preview'),
      }
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/08/devtools-release-notes'),
  },
  {
    version: 4,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/07/devtools-release-notes#throttling'),
      },
      {
        title: 'Storage usage',
        subtitle: 'See how much storage (IndexedDB, local, session, cache, etc.) an origin is using.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/07/devtools-release-notes#storage'),
      },
      {
        title: 'Cache timestamps',
        subtitle: 'View when a service worker cached a response.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/07/devtools-release-notes#time-cached'),
      },
      {
        title: 'ES6 Modules support',
        subtitle: 'Debug ES6 Modules natively from the Sources panel.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/07/devtools-release-notes#modules'),
      }
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/07/devtools-release-notes'),
  },
  {
    version: 3,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/05/devtools-release-notes#lighthouse'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/05/devtools-release-notes#badges'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/05/devtools-release-notes#continue'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/05/devtools-release-notes#step-into-async'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/05/devtools-release-notes#object-previews'),
      },
      {
        title: 'Real-time Coverage tab updates',
        subtitle: 'See what code is being used in real-time.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/05/devtools-release-notes#coverage'),
      }
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/05/devtools-release-notes'),
  },
  {
    version: 2,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/04/devtools-release-notes#coverage'),
      },
      {
        title: 'Full-page screenshots',
        subtitle: 'Take a screenshot of the entire page, from the top of the viewport to the bottom.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/04/devtools-release-notes#screenshots'),
      },
      {
        title: 'Block requests',
        subtitle: 'Manually disable individual requests in the Network panel.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/04/devtools-release-notes#block-requests'),
      },
      {
        title: 'Step over async await',
        subtitle: 'Step through async functions predictably.',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/04/devtools-release-notes#async'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/04/devtools-release-notes#command-menu'),
      }
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/04/devtools-release-notes'),
  },
  {
    version: 1,
    ...
    highlights: [
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/03/devtools-release-notes#performance-panel'),
      },
      {
        title: 'Editable cookies',
        subtitle: 'You can edit any existing cookies and create new ones in the Application panel',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/03/devtools-release-notes#cookies'),
      },
      {
        ...
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/03/devtools-release-notes#console'),
      },
      {
        title: 'Debugger catches out-of-memory errors',
        subtitle: 'See the stack or grab a heap snapshot to see why the app may crash',
        link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/03/devtools-release-notes#out-of-memory-breakpoints'),
      },
    ],
    link: UI.UIUtils.getURLWithReferrer('https://developers.google.com/web/updates/2017/03/devtools-release-notes'),
  }
];
