...
export class QuickPick {
  ...
  static show(items: QuickPickItem[], options: QuickPickOptions): Promise<QuickPickItem | undefined> {
    let canceledPromise: Promise<undefined> = new Promise<undefined>(_r => { }); // Intentionally creates an unresolved promise
...
class QuickPickProvider extends Provider {
  ...
  constructor(items: QuickPickItem[], resolve: Function, matchOnDescription: number | undefined = 0.5, matchOnDetail: number | undefined = 0.25) {
    super();
