...
export class CommandMenu {
  ...
  static createRevealViewCommand(options) {
    ...
    return CommandMenu.createCommand({
      ...
      shortcut: '',
      executeHandler: self.UI.viewManager.showView.bind(self.UI.viewManager, viewId, /* userGesture */ true),
      availableHandler: null,
      userActionCode
    });
  }
  ...
  _loadCommands() {
    ...
    for (const extension of viewExtensions) {
      ...
      const options = {extension, category: ls(category), userActionCode: null};
...
export class CommandMenuProvider extends Provider {
  ...
  attach() {
    ...
    for (const action of actions) {
      ...
      const options = {action, userActionCode: null};
