  ...
  _updateAdStatus() {
    switch (this._frame.adFrameType()) {
      case Protocol.Page.AdFrameType.Root:
        ...
        this._adStatus.title = ls`This frame has not been identified as the root frame of an ad`;
        break;
      case Protocol.Page.AdFrameType.Child:
        this._adStatus.textContent = ls`child`;
        this._adStatus.title = ls`This frame has not been identified as the a child frame of an ad`;
        break;
      default:
        this._adStatus.textContent = ls`none`;
        this._adStatus.title = ls`This frame has not been tagged as an ad`;
        break;
    }
  }
}
