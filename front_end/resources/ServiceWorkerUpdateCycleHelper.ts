...
export class ServiceWorkerUpdateCycleHelper {
  ...
  static createTimingTable(parent: Element, registration: SDK.ServiceWorkerManager.ServiceWorkerRegistration): Element {
    const tableElement = parent.createChild('table');
  ...
  private static createTimingTableHead(tableElement: Element): void {
    ...
    UI.UIUtils.createTextChild(serverHeader.createChild('td'), ls`Phase`);
