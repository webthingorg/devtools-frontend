...
export class ServiceWorkersView extends UI.Widget.VBox {
  constructor() {
    ...
    window.addEventListener(UI.InspectorView.Events.DrawerChange, event => {
      const {detail: {drawerStatus}} = event;
      this._drawerChangeCallback(drawerStatus);
    });
  }
