...
const str_ = i18n.i18n.registerUIStrings('bindings/DebuggerLanguagePlugins.ts', UIStrings);
 ...
 * @param {!SDK.Script.Script} scriptthe unique raw module ID for the script.
 */
function rawModuleIdForScript(script: any): string {
...
async function resolveRemoteObject(callFrame: SDK.DebuggerModel.CallFrame, object: SDK.RemoteObject.RemoteObject): Promise<any> {
...
export class ValueNode extends SDK.RemoteObject.RemoteObjectImpl {
  ...
  constructor(callFrame: SDK.DebuggerModel.CallFrame, objectId: string | undefined, type: string, subtype: string | undefined, value: any, inspectableAddress: number | undefined, unserializableValue?: string, description?: string, preview?: Protocol.Runtime.ObjectPreview, customPreview?: Protocol.Runtime.CustomPreview, className?: string) {
 ...
 */
async function getValueTreeForExpression(callFrame: SDK.DebuggerModel.CallFrame, plugin: DebuggerLanguagePlugin, expression: string, evalOptions: SDK.RuntimeModel.EvaluationOptions): Promise<SDK.RemoteObject.RemoteObject> {
 ...
 */
async function formatSourceValue(callFrame: SDK.DebuggerModel.CallFrame, plugin: DebuggerLanguagePlugin, sourceType: SourceType, base: EvalBase, field: FieldInfo[], evalOptions: SDK.RuntimeModel.EvaluationOptions): Promise<FormattedValueNode> {
  const location = getRawLocation(callFrame);
...
class FormattedValueNode extends ValueNode {
  ...
  constructor(callFrame: SDK.DebuggerModel.CallFrame, sourceType: SourceType, plugin: DebuggerLanguagePlugin, object: Protocol.Runtime.RemoteObject, formatterTag: {
    className: string;
    symbol: string;
  } | null, evalOptions: SDK.RuntimeModel.EvaluationOptions, inspectableAddress: number | undefined) {
   ...
   */
  async _createRemoteObject(newObject: Protocol.Runtime.RemoteObject): Promise<FormattedValueNode | StaticallyTypedValueNode> {
...
class FormattingError extends Error {
  ...
  static throwLocal(callFrame: SDK.DebuggerModel.CallFrame, message: string): void {
    ...
    const exceptionDetails: Protocol.Runtime.ExceptionDetails = { text: 'Uncaught', exceptionId: -1, columnNumber: 0, lineNumber: 0, exception };
...
class StaticallyTypedValueNode extends ValueNode {
  ...
  _evalOptions: SDK.RuntimeModel.EvaluationOptions;
  constructor(callFrame: SDK.DebuggerModel.CallFrame, plugin: DebuggerLanguagePlugin, sourceType: SourceType, base: EvalBase | null, fieldChain: FieldInfo[], evalOptions: SDK.RuntimeModel.EvaluationOptions, inspectableAddress: number | undefined) {
  ...
  static async getInspectableAddress(callFrame: SDK.DebuggerModel.CallFrame, plugin: DebuggerLanguagePlugin, base: EvalBase | null, field: FieldInfo[], evalOptions: SDK.RuntimeModel.EvaluationOptions): Promise<number | undefined> {
    if (!base) {
      return undefined;
    }
  ...
  async doGetProperties(ownProperties: boolean, accessorPropertiesOnly: boolean, generatePreview: boolean): Promise<SDK.RemoteObject.GetPropertiesResult> {
    const { typeInfo } = this._sourceType;
    if (accessorPropertiesOnly || !typeInfo.canExpand) {
      return /** @type {!SDK.RemoteObject.GetPropertiesResult} */ { properties: [], internalProperties: [] } as SDK.RemoteObject.GetPropertiesResult;
    }
    ...
    if (typeInfo.members.length > 0) {
      ...
      return /** @type {!SDK.RemoteObject.GetPropertiesResult} */ { properties: await members, internalProperties: [] } as SDK.RemoteObject.GetPropertiesResult;
    }
...
class SourceScopeRemoteObject extends SDK.RemoteObject.RemoteObjectImpl {
  ...
  async doGetProperties(ownProperties: boolean, accessorPropertiesOnly: boolean, generatePreview: boolean): Promise<SDK.RemoteObject.GetPropertiesResult> {
    ...
    return /** @type {!SDK.RemoteObject.GetPropertiesResult} */ { properties: properties, internalProperties: [] } as SDK.RemoteObject.GetPropertiesResult;
  }
}
...
export class DebuggerLanguagePluginManager implements SDK.SDKModel.SDKModelObserver {
  ...
  constructor(targetManager: SDK.SDKModel.TargetManager, workspace: Workspace.Workspace.WorkspaceImpl, debuggerWorkspaceBinding: DebuggerWorkspaceBinding) {
  ...
  async _evaluateOnCallFrame(callFrame: SDK.DebuggerModel.CallFrame, options: SDK.RuntimeModel.EvaluationOptions): Promise<{
  ...
  async rawLocationToUILocation(rawLocation: SDK.DebuggerModel.Location): Promise<Workspace.UISourceCode.UILocation | null> {
  ...
  uiLocationToRawLocationRanges(uiSourceCode: Workspace.UISourceCode.UISourceCode, lineNumber: number, columnNumber: number | undefined = -1): Promise<{
    ...
    async function getLocations(rawModuleId: string, plugin: DebuggerLanguagePlugin, script: SDK.Script.Script): Promise<{
      start: SDK.DebuggerModel.Location;
      end: SDK.DebuggerModel.Location;
    }[]> {
  ...
  async uiLocationToRawLocations(uiSourceCode: Workspace.UISourceCode.UISourceCode, lineNumber: number, columnNumber?: number): Promise<SDK.DebuggerModel.Location[] | null> {
...
export class DebuggerLanguagePlugin {
  ...
  /** Find locations in raw modules from a location in a source file
    */
  async sourceLocationToRawLocation(sourceLocation: SourceLocation): Promise<RawLocationRange[]> {
    throw new Error('Not implemented yet');
  }

  /** Find locations in source files from a location in a raw module
    */
  async rawLocationToSourceLocation(rawLocation: RawLocation): Promise<SourceLocation[]> {
    throw new Error('Not implemented yet');
  }
  ...
  /** List all variables in lexical scope at a given location in a raw module
    */
  async listVariablesInScope(rawLocation: RawLocation): Promise<Variable[]> {
    throw new Error('Not implemented yet');
  }
  ...
  /** Find locations in source files from a location in a raw module
    */
  async getFunctionInfo(rawLocation: RawLocation): Promise<{
    frames: Array<FunctionInfo>;
  }> {
    throw new Error('Not implemented yet');
  }
  ...
  /** Find locations in raw modules corresponding to the inline function
    ...
    */
  async getInlinedFunctionRanges(rawLocation: RawLocation): Promise<RawLocationRange[]> {
    throw new Error('Not implemented yet');
  }
  ...
  /** Find locations in raw modules corresponding to inline functions
    ...
    */
  async getInlinedCalleesRanges(rawLocation: RawLocation): Promise<RawLocationRange[]> {
    throw new Error('Not implemented yet');
  }
