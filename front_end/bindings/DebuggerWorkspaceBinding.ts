...
export class DebuggerWorkspaceBinding implements SDK.SDKModel.SDKModelObserver {
  ...
  _liveLocationPromises: Set<Promise<any>>;
   ...
   */
  async pendingLiveLocationChangesPromise(): Promise<any> {
    await Promise.all(this._liveLocationPromises);
  }

  _recordLiveLocationChange(promise: Promise<any>): void {
    promise.then(() => {
  ...
  async createLiveLocation(rawLocation: SDK.DebuggerModel.Location, updateDelegate: (arg0: LiveLocation) => Promise<unknown>, locationPool: LiveLocationPool): Promise<Location | null> {
  ...
  async createStackTraceTopFrameLiveLocation(rawLocations: SDK.DebuggerModel.Location[], updateDelegate: (arg0: LiveLocation) => Promise<unknown>, locationPool: LiveLocationPool): Promise<LiveLocation> {
  ...
  async createCallFrameLiveLocation(location: SDK.DebuggerModel.Location, updateDelegate: (arg0: LiveLocation) => Promise<unknown>, locationPool: LiveLocationPool): Promise<Location | null> {
  ...
  async uiLocationToRawLocations(uiSourceCode: Workspace.UISourceCode.UISourceCode, lineNumber: number, columnNumber?: number): Promise<SDK.DebuggerModel.Location[]> {
    for (const sourceMapping of this._sourceMappings) {
    ...
    for (const modelData of this._debuggerModelToData.values()) {
      locationPromises.push(Promise.resolve(modelData._uiLocationToRawLocations(uiSourceCode, lineNumber, columnNumber)));
    }
...
class ModelData {
  ...
  async _createLiveLocation(rawLocation: SDK.DebuggerModel.Location, updateDelegate: (arg0: LiveLocation) => Promise<unknown>, locationPool: LiveLocationPool): Promise<Location> {
  ...
  _uiLocationToRawLocations(uiSourceCode: Workspace.UISourceCode.UISourceCode, lineNumber: number, columnNumber: number | undefined = 0): SDK.DebuggerModel.Location[] {
...
export class Location extends LiveLocationWithPool {
  ...
  constructor(scriptId: string, rawLocation: SDK.DebuggerModel.Location, binding: DebuggerWorkspaceBinding, updateDelegate: (arg0: LiveLocation) => Promise<unknown>, locationPool: LiveLocationPool) {
...
class StackTraceTopFrameLocation extends LiveLocationWithPool {
  ...
  constructor(updateDelegate: (arg0: LiveLocation) => Promise<unknown>, locationPool: LiveLocationPool) {
    super(updateDelegate, locationPool);
  ...
  static async createStackTraceTopFrameLocation(rawLocations: SDK.DebuggerModel.Location[], binding: DebuggerWorkspaceBinding, updateDelegate: (arg0: LiveLocation) => Promise<unknown>, locationPool: LiveLocationPool): Promise<StackTraceTopFrameLocation> {
