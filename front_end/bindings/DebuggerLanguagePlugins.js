...
class SourceScopeRemoteObject extends SDK.RemoteObject.RemoteObjectImpl {
  ...
  constructor(runtimeModel, type) {
    super(runtimeModel, undefined, type, undefined, null);
    /** @type {!Array<!Variable>} */
    this.variables = [];
  }
  ...
  async doGetProperties(ownProperties, accessorPropertiesOnly, generatePreview) {
    ...
    return /** @type {!SDK.GetPropertiesResult} */ ({properties: variableObjects, internalProperties: []});
  }
}

/**
 * @unrestricted
 * FIXME rename Scope to RawScope and add an interface
 */
class SourceScope {
  /**
