...
class DebuggerLanguageExtensionPlugin {
  ...
  */
  async addRawModule(rawModuleId, symbolsURL, rawModule) {
    try {
      return await this._extension.callAddRawModule({rawModuleId, symbolsURL, rawModule});
    } catch (error) {
  ...
  async removeRawModule(rawModuleId) {
    try {
      return await this._extension.callRemoveRawModule({rawModuleId});
    } catch (error) {
      throw new DebuggerLanguagePluginError('EXTENSION_ERROR', error.message);
    }
  }
  ...
  */
  async sourceLocationToRawLocation(sourceLocation) {
    try {
      return await this._extension.callSourceLocationToRawLocation({sourceLocation});
    } catch (error) {
      throw new DebuggerLanguagePluginError('EXTENSION_ERROR', error.message);
    }
  }
  ...
  */
  async rawLocationToSourceLocation(rawLocation) {
    try {
      return await this._extension.callRawLocationToSourceLocation({rawLocation});
    } catch (error) {
      throw new DebuggerLanguagePluginError('EXTENSION_ERROR', error.message);
    }
  }
  ...
  */
  async listVariablesInScope(rawLocation) {
    try {
      return await this._extension.callListVariablesInScope({rawLocation});
    } catch (error) {
      throw new DebuggerLanguagePluginError('EXTENSION_ERROR', error.message);
    }
  }
  ...
  */
  async evaluateVariable(name, location) {
    try {
      return await this._extension.callEvaluateVariable({name, location});
    } catch (error) {
      throw new DebuggerLanguagePluginError('EXTENSION_ERROR', error.message);
    }
  }
