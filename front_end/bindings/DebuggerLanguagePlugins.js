...
class FormattedValueNode extends ValueNode {
  ...
  async _createRemoteObject(newObject) {
    ...
    if (!base) {
      return new FormattedValueNode(
          this._callFrame, this._sourceType, this._plugin, newObject, this.formatterTag, this._evalOptions, undefined);
    }
  ...
  async _getEvalBaseFromObject(object) {
    ...
    const baseObject = new FormattedValueNode(
        this._callFrame, this._sourceType, this._plugin, result, null, this._evalOptions, undefined);
