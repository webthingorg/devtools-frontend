...
export class ResourceMapping implements SDK.SDKModel.SDKModelObserver {
...
class Binding implements TextUtils.ContentProvider.ContentProvider {
  ...
  async _styleSheetChanged(stylesheet: SDK.CSSStyleSheetHeader.CSSStyleSheetHeader, edit: SDK.CSSModel.Edit | null): Promise<void> {
