...
export class CSSWorkspaceBinding implements SDK.SDKModel.SDKModelObserver {
  ...
  _getCSSModelInfo(cssModel: SDK.CSSModel.CSSModel): ModelInfo {
    return /** @type {!ModelInfo} */ this._modelToInfo.get(cssModel) as ModelInfo;
  }
...
export class ModelInfo {
  ...
  async _createLiveLocation(rawLocation: SDK.CSSModel.CSSLocation, updateDelegate: (arg0: LiveLocationInterface) => Promise<void>, locationPool: LiveLocationPool): Promise<LiveLocation> {
