...
function issuesAssociatedWithNetworkRequest(issues: SDK.Issue.Issue[], request: SDK.NetworkRequest.NetworkRequest): SDK.Issue.Issue[] {
...
function issuesAssociatedWithCookie(issues: SDK.Issue.Issue[], domain: string, name: string, path: string): SDK.Issue.Issue[] {
  return issues.filter(issue => {
