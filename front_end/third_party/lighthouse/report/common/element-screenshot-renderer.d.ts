export class ElementScreenshotRenderer {
     ...
     */
    static getScreenshotPositions(elementRectSC: any, elementPreviewSizeSC: Size, screenshotSize: Size): {
        screenshot: {
            left: number;
            top: number;
        };
    ...
    static renderClipPathInScreenshot(dom: DOM, maskEl: HTMLElement, positionClip: {
        left: number;
        top: number;
    }, elementRect: any, elementPreviewSize: Size): void;
    /**
     ...
     */
    static installFullPageScreenshot(el: HTMLElement, screenshot: any): void;
    /**
     ...
     * @return {number}
     */
    static _computeZoomFactor(elementRectSC: any, renderContainerSizeDC: Size): number;
    /**
     ...
     * @return {Element|null}
     */
    static render(dom: DOM, templateContext: ParentNode, screenshot: any, elementRectSC: any, maxRenderSizeDC: Size): Element | null;
}
