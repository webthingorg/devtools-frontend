...
export class SnippetRenderer {
     ...
     */
    static renderHeader(dom: DOM, tmpl: DocumentFragment, details: any, detailsRenderer: DetailsRenderer, toggleExpandedFn: Function): DocumentFragment;
    /**
     ...
     * @return {DocumentFragment}
     */
    static renderSnippetContent(dom: DOM, tmpl: DocumentFragment, details: any): DocumentFragment;
    /**
     * @param {DOM} dom
     * @param {DocumentFragment} tmpl
     * @param {LH.Audit.Details.SnippetValue} details
     * @return {DocumentFragment}
     */
    static renderSnippetLines(dom: DOM, tmpl: DocumentFragment, details: any): DocumentFragment;
    /**
     * @param {DOM} dom
