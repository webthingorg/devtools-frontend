...
export declare function throwIfDisposed<This extends Disposed>(message?: (value: This) => string) => any, _: unknown) => (this: This, ...args: any[]) => any;
export declare function inertIfDisposed<This extends Disposed>(target: (this: This, ...args: any[]) => any, _: unknown) => any;
/**
...
export declare function guarded<T extends object>(getKey?: (this: T) => object) => Promise<any>, _: ClassMethodDecoratorContext<T>) => (this: T, ...args: any[]) => Promise<any>;
