...
const puppeteer_core_js_1 = require("../puppeteer-core.js");
...
async function waitForEvent(emitter, eventName, predicate, timeout, abortPromise) {
    const deferred = puppeteer_core_js_1.Deferred.create({
    ...
    return puppeteer_core_js_1.Deferred.race([deferred, abortPromise]).then(r => {
...
async function waitWithTimeout(promise, taskName, timeout) {
    ...
    return await puppeteer_core_js_1.Deferred.race([promise, deferred]).finally(() => {
 ...
 * @internal
 */
async function getReadableFromProtocolStream(source, handle) {
