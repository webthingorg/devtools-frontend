...
export {lineNumbers, gutter, GutterMarker, gutters} from '@codemirror/gutter';
export {HighlightStyle, Tag, tags, TagStyle, highlightTree} from '@codemirror/highlight';
export {history, historyKeymap, redo, redoSelection, undo, undoSelection} from '@codemirror/history';
export {Language, LanguageSupport, indentOnInput, indentUnit, syntaxTree} from '@codemirror/language';
