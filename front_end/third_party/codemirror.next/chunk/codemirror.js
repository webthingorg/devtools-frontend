...
const baseTheme$5 = /*@__PURE__*/buildTheme("." + baseThemeID, {
    "&": {
...
class EditorView {
    ...
    */
    ...
    mountStyles() {
        ...
        StyleModule.mount(this.root, this.styleModules.concat(baseTheme$5).reverse());
    }
    readMeasured() {
        ...
        if (ranges.length > 1) {
            ...
            if (editor.state.field(snippetState, false) === undefined)
                effects.push(StateEffect.appendConfig.of([snippetState.init(() => active), addSnippetKeymap,
                    snippetPointerHandler, baseTheme$3]));
        }
...
async function clojure() {
    return StreamLanguage.define((await import('./legacy.js').then(function (n) { return n.c; })).clojure);
}
async function coffeescript() {
    return StreamLanguage.define((await import('./legacy.js').then(function (n) { return n.a; })).coffeeScript);
}
function cpp() {
...
async function shell() {
    return StreamLanguage.define((await import('./legacy.js').then(function (n) { return n.s; })).shell);
}
function wast() {
...
export { cursorMatchingBracket as $, clojure as A, coffeescript as B, ContextTracker as C, cpp as D, ExternalTokenizer as E, css as F, html as G, java as H, javascript as I, json as J, markdown as K, LRParser as L, php as M, NodeProp as N, python as O, Parser as P, shell as Q, wast as R, xml as S, Tree as T, acceptCompletion as U, autocompletion as V, completeAnyWord as W, CompletionContext as X, currentCompletions as Y, closeBrackets as Z, closeBracketsKeymap as _, LRLanguage as a, cursorSubwordBackward as a0, cursorSubwordForward as a1, indentLess as a2, indentMore as a3, selectMatchingBracket as a4, selectSubwordBackward as a5, selectSubwordForward as a6, standardKeymap as a7, toggleComment as a8, codeFolding as a9, Facet as aA, SelectionRange as aB, StateEffect as aC, StateEffectType as aD, StateField as aE, Transaction as aF, StreamLanguage as aG, StringStream as aH, Line as aI, Text as aJ, showTooltip as aK, tooltips as aL, Decoration as aM, drawSelection as aN, highlightSpecialChars as aO, MatchDecorator as aP, placeholder as aQ, scrollPastEnd as aR, ViewPlugin as aS, ViewUpdate as aT, WidgetType as aU, TreeCursor as aV, foldGutter as aa, foldKeymap as ab, gutter as ac, GutterMarker as ad, gutters as ae, lineNumbers as af, HighlightStyle as ag, highlightTree as ah, Tag as ai, history as aj, historyKeymap as ak, redo as al, redoSelection as am, undo as an, undoSelection as ao, indentOnInput as ap, indentUnit as aq, bracketMatching as ar, Range as as, RangeSet as at, RangeSetBuilder as au, selectNextOccurrence as av, Annotation as aw, AnnotationType as ax, Compartment as ay, EditorState as az, foldNodeProp as b, continuedIndent as c, foldInside$1 as d, LanguageSupport as e, flatIndent as f, syntaxTree as g, EditorView as h, indentNodeProp as i, EditorSelection as j, snippetCompletion as k, delimitedIndent as l, ifNotIn as m, completeFromList as n, NodeType as o, parseMixed as p, NodeSet as q, languageDataProp as r, styleTags as s, tags as t, Language as u, Prec as v, keymap as w, defineLanguageFacet as x, LanguageDescription as y, ParseContext as z };
