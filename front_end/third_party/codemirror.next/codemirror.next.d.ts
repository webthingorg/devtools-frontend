...
export { Annotation, AnnotationType, Command, Compartment, Completion, CompletionContext, CompletionResult, CompletionSource, Decoration, EditorSelection, EditorState, EditorStateConfig, EditorView, Extension, Facet, HighlightStyle, KeyBinding, Line, MatchDecorator, NodeProp, NodeSet, NodeType, Parser, Prec, Range, RangeSet, SelectionRange, StateEffect, StateEffectType, StateField, SyntaxNode, Tag, TagStyle, Text, TextIterator, Transaction, TransactionSpec, Tree, TreeCursor, ViewPlugin, ViewUpdate, WidgetType, autocompletion, bracketMatching, closeBrackets, closeBracketsKeymap, codeFolding, completeAnyWord, css, cursorMatchingBracket, cursorSubwordBackward, cursorSubwordForward, drawSelection, foldGutter, foldKeymap, highlightSpecialChars, history, historyKeymap, html, ifNotIn, indentOnInput, indentUnit, indentWithTab, javascriptLanguage, keymap, lineNumbers, redo, redoSelection, scrollPastEnd, selectMatchingBracket, selectNextOccurrence, selectSubwordBackward, selectSubwordForward, standardKeymap, syntaxTree, tags, toggleComment, undo, undoSelection };
