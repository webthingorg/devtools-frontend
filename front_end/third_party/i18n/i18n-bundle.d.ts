 ...
 * @return {Map<string, T>}
 */
declare function collectAllCustomElementsFromICU<T>(icuElements: any, seenElementsById?: Map<string, T>): T;
 ...
 */
declare function createMessageInstanceIdFn(filename: string, fileStrings: Record<string, string>): typeof getMessageInstanceIdFn;
 ...
 */
declare function getFormattedFromIdAndValues(locale: string, icuMessageId: string, values: Record<string, string | number>): string;
 ...
 */
declare function registerLocaleData(locale: any, lhlMessages: any): void;

/**
 * @param {string} icuMessage
 * @param {Record<string, string | number>} [values]
 */
declare function getMessageInstanceIdFn(icuMessage: string, values: Record<string, string | number>): string;
