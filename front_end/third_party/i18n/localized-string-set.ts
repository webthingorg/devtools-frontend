...
import i18nBundle from './i18n-bundle.js';
...
export class LocalizedStringSet {
  ...
  private readonly cachedMessageFormatters = new Map<string, IntlMessageFormat>();
  ...
  getLocalizedString(message: string, values: Object = EMPTY_VALUES_OBJECT): string {
  ...
  private getFormattedLocalizedString(message: string, values: Object): string {
