...
import {Chrome} from '../../../extension-api/ExtensionAPI.js';  // eslint-disable-line rulesdir/es_modules_import
...
export class ExtensionRemoteObject extends SDK.RemoteObject.RemoteObject {
  ...
  get type(): string {
    switch (this.extensionObject.type) {
      case Chrome.DevTools.RemoteObjectType.Undefined:
        return 'undefined';
      case Chrome.DevTools.RemoteObjectType.String:
        return 'string';
      case Chrome.DevTools.RemoteObjectType.Number:
        return 'number';
      case Chrome.DevTools.RemoteObjectType.Boolean:
        return 'boolean';
      case Chrome.DevTools.RemoteObjectType.BigInt:
        return 'bigint';
      case Chrome.DevTools.RemoteObjectType.Array:
      case Chrome.DevTools.RemoteObjectType.Null:
      case Chrome.DevTools.RemoteObjectType.Object:
        return 'object';
    }
  }
