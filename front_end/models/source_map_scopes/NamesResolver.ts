...
export class SourceMapScope implements SDK.DebuggerModel.ScopeChainEntry {
  ...
  type(): string {
    // TODO(jarin) Thread through the proper scope type.
    return 'source-map-scope';
  }

  typeName(): string {
    // TODO(jarin) Thread through the proper scope type name.
  ...
  description(): string {
    // TODO(jarin) Thread through the proper scope type description.
