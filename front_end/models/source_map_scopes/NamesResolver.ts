...
export const allVariablesAtPosition = async(location: SDK.DebuggerModel.Location): Promise<Map<string, string>> => {
  ...
  // We build {reverseMapping} from the "outside in". Variable shadowing works
  // out of the box since inner scopes will override any existing mapping to the
  // same name of an outer scope.
