...
// Each frame has a single process at a given time but it can have
// multiple process during a trace, for example if a navigation occurred
// in the frame. This map tracks the process that was active for each
// frame at each point in time. Also, because a process can be assigned
// to multiple URLs, there is a window for each URL a process was
// assigned.
//
