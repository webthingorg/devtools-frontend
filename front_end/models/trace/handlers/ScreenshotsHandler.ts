...
export async function finalize(): Promise<void> {
  ...
  for (const snapshotEvent of snapshotEvents) {
    ...
    const syntheticManagerInstance = Helpers.SyntheticEvents.SyntheticEventsManager.getManagerForTrace();
    const syntheticEvent = syntheticManagerInstance.makeSyntheticBasedEvent<Types.TraceEvents.SyntheticScreenshot>({
