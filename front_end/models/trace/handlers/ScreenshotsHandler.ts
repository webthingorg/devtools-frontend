...
const snapshotEvents: Types.TraceEvents.TraceEventScreenshotSnapshot[] = [];
...
export function handleEvent(event: Types.TraceEvents.TraceEventData): void {
  if (event.name === 'Screenshot') {
    snapshotEvents.push(event as Types.TraceEvents.TraceEventScreenshotSnapshot);
 ...
 */
function getPresentationTimestamp(screenshotEvent: Types.TraceEvents.TraceEventScreenshotSnapshot):
