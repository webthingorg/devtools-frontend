...
export interface WorkersData {
  ...
  workerURL: Map<Types.TraceEvents.WorkerId, string>;
}
...
const workerURL: Map<Types.TraceEvents.WorkerId, string> = new Map();
...
export async function finalize(): Promise<void> {
  ...
  for (const sessionIdEvent of sessionIdEvents) {
    ...
    workerURL.set(sessionIdEvent.args.data.workerId, sessionIdEvent.args.data.url);
  }
