 ...
 **/
let syntheticEvents: Types.TraceEvents.SyntheticNestableAsyncEvent<Types.TraceEvents.TraceEventNestableAsync>[] = [];
...
export interface UserTimingsData {
   ...
   */
  performanceMeasures: readonly Types.TraceEvents.SyntheticUserTiming[];
  /**
   ...
   */
  consoleTimings: readonly Types.TraceEvents.SyntheticConsoleTiming[];
  /**
...
export function data(): UserTimingsData {
  ...
  return {
    performanceMeasures: syntheticEvents.filter(e => e.cat === 'blink.user_timing') as
        Types.TraceEvents.SyntheticUserTiming[],
    consoleTimings: syntheticEvents.filter(e => e.cat === 'blink.console') as
        Types.TraceEvents.SyntheticConsoleTiming[],
