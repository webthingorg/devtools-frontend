...
//
import * as Animation from './AnimationHandler.js';
import * as GPU from './GPUHandler.js';
import * as LargestImagePaint from './LargestImagePaintHandler.js';
import * as LargestTextPaint from './LargestTextPaintHandler.js';
import * as LayoutShifts from './LayoutShiftsHandler.js';
import * as Meta from './MetaHandler.js';
