...
export async function finalize(): Promise<void> {
  ...
  for (const [requestId, request] of requestMap.entries()) {
    ...
    //   networkEvent.args.data.syntheticData.queueing = Types.Timing.MicroSeconds(0);
    //   networkEvent.args.data.syntheticData.waiting = Types.Timing.MicroSeconds(0);
    //   networkEvent.args.data.syntheticData.dnsLookup = Types.Timing.MicroSeconds(0);
    //   networkEvent.args.data.syntheticData.initialConnection = Types.Timing.MicroSeconds(0);
    //   networkEvent.args.data.syntheticData.ssl = Types.Timing.MicroSeconds(0);
    //   networkEvent.args.data.syntheticData.requestSent = Types.Timing.MicroSeconds(0);
    //   networkEvent.args.data.syntheticData.proxyNegotiation = Types.Timing.MicroSeconds(0);
    //   networkEvent.args.data.syntheticData.networkDuration = Types.Timing.MicroSeconds(0);

    //   // Update the stalled and download values.
    //   const endStalled = request.receiveResponse.ts;
    //   networkEvent.args.data.syntheticData.stalled = Types.Timing.MicroSeconds(endStalled - startTime);
    //   networkEvent.args.data.syntheticData.download = Types.Timing.MicroSeconds(endTime - endStalled);
    // }
