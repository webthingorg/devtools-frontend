...
export async function finalize(): Promise<void> {
  ...
  for (const [requestId, request] of requestMap.entries()) {
    ...
    const syntheticEventsManager = Helpers.SyntheticEvents.SyntheticEventsManager.getManagerForTrace();
    // Construct a synthetic trace event for this network request.
    const networkEvent = syntheticEventsManager.makeSyntheticBasedEvent<Types.TraceEvents.SyntheticNetworkRequest>({
