...
function makeSyntheticEventBase(event: Types.TraceEvents.TraceEventAuctionWorkletDoneWithProcess|
  ...
  return Helpers.SyntheticEvents.SyntheticEventsManager.getManagerForTrace()
      .makeSyntheticBasedEvent<Omit<Types.TraceEvents.SyntheticAuctionWorkletEvent, 'args'>>({
