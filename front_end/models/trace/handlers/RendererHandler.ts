...
export async function finalize(): Promise<void> {
  ...
  // Pass unsorted entries to Annotations Manager to identify where the original posibition of the entry is
  AnnotationsManager.AnnotationsManager.AnnotationsManager.instance().setSyntheticEntriesUnsortedArray(allTraceEntries);
