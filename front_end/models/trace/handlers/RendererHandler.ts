...
const entryToNode: Map<Types.TraceEvents.RenderererEntry, Helpers.TreeHelpers.TraceEntryNode> = new Map();
...
export interface RendererHandlerData {
  ...
  entryToNode: Map<Types.TraceEvents.RenderererEntry, Helpers.TreeHelpers.TraceEntryNode>;
  /**
...
export interface RendererThread {
   ...
   * samples.
   */
  entries: Types.TraceEvents.RenderererEntry[];
