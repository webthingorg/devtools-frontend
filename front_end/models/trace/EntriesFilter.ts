...
export class EntriesFilter {
  ...
  // Remove all of the child entries of the new modified entry from the modified array. Do that because to draw the initiator from the closest visible entry, we need to get the closest entry that is marked as modified.
