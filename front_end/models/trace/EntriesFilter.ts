...
// Object used to indicate to the Context Menu if an action is possible on a certain entry.
...
export class EntriesFilter {
  ...
  /**
   * Checks which actions can be applied to an entry. This allows us to only show possible actions in the Context Menu.
