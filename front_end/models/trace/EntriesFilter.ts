...
export class EntriesFilter {
  ...
  } = {entryToNodeMap: null}): EntriesFilter {
    if (opts.entryToNodeMap) {
      instance = new EntriesFilter(opts.entryToNodeMap);
    }
    if (instance.#entryToNode.size === 0) {
      throw new Error('The size of entryToNode map in EntriesFilter in 0');
    }
