...
type EntryToNodeMap = Map<Types.TraceEvents.RenderererEntry, Helpers.TreeHelpers.TraceEntryNode>;
...
export class TreeManipulator {
  ...
  // changed.
  #lastVisibleEntries: readonly Types.TraceEvents.RenderererEntry[]|null = null;
  ...
  #calculateVisibleEntries(): readonly Types.TraceEvents.TraceEventData[] {
    ...
    const entriesToHide = new Set<Types.TraceEvents.RenderererEntry>();
  ...
  #findAllAncestorsOfNode(root: Helpers.TreeHelpers.TraceEntryNode): Types.TraceEvents.RenderererEntry[] {
    const ancestors: Types.TraceEvents.RenderererEntry[] = [];
