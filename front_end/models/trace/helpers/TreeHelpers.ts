...
export const makeEmptyTraceEntryNode =
    (entry: Types.TraceEvents.SyntheticTreifiedEntry, id: TraceEntryNodeId): TraceEntryNode => ({
      entry,
      id,
      parent: null,
      children: [],
 ...
 */
export function treify(entries: Types.TraceEvents.SyntheticTreifiedEntry[], options?: {
  filter: {has: (name: Types.TraceEvents.KnownEventName) => boolean},
}): {tree: TraceEntryTree, entryToNode: Map<Types.TraceEvents.SyntheticTreifiedEntry, TraceEntryNode>} {
  ...
  const entryToNode = new Map<Types.TraceEvents.SyntheticTreifiedEntry, TraceEntryNode>();
...
export function walkTreeFromEntry(
    entryToNode: Map<Types.TraceEvents.SyntheticTreifiedEntry, TraceEntryNode>,
    rootEntry: Types.TraceEvents.SyntheticTreifiedEntry,
    onEntryStart: (entry: Types.TraceEvents.SyntheticTreifiedEntry) => void,
    onEntryEnd: (entry: Types.TraceEvents.SyntheticTreifiedEntry) => void,
    ): void {
