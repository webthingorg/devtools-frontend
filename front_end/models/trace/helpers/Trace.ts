...
/**
 * Matches beginning events with given target events, either
 * TraceEventPairableAsyncEnd or TraceEventPairableAsyncStatus (currently only used by the AnimationHandler)
 * type of events.
 */
