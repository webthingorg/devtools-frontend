...
export function expandWindowByPercentOrToOneMillisecond(
    overlayWindow: Types.Timing.TraceWindowMicroSeconds, percentage: number,
    maxTraceWindow?: Types.Timing.TraceWindowMicroSeconds): Types.Timing.TraceWindowMicroSeconds {
