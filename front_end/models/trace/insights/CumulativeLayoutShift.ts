...
function getRootCausesPerShift(
    layoutShifts: Types.TraceEvents.TraceEventLayoutShift[], prePaintEvents: Types.TraceEvents.TraceEventPrePaint[],
    networkRequests: Types.TraceEvents.SyntheticNetworkRequest[],
    iframeCreatedEvents: readonly Types.TraceEvents.TraceEventRenderFrameImplCreateChildFrame[]):
    Map<Types.TraceEvents.TraceEventLayoutShift, LayoutShiftRootCausesData> {
  ...
  getIframeRootCauses(iframeCreatedEvents, prePaintEvents, shiftsByPrePaint, rootCausesByShift);
...
export function generateInsight(
  ...
  // Get root causes.
  const shifts = getRootCausesPerShift(layoutShifts, prePaintEvents, networkRequests, iframeEvents);
