...
export const enum AnimationFailureReasons {
  ...
  OBSOLETE_TARGET_HAS_MULTIPLE_TRANSFORM_PROPERTIES = 'OBSOLETE_TARGET_HAS_MULTIPLE_TRANSFORM_PROPERTIES',
  ...
  OBSOLETE_MULTIPLE_TRANSFORM_ANIMATIONS_ON_SAME_TARGET = 'OBSOLETE_MULTIPLE_TRANSFORM_ANIMATIONS_ON_SAME_TARGET',
...
const ACTIONABLE_FAILURE_REASONS = [
  ...
  {
    flag: 1 << 8,
    failure: AnimationFailureReasons.OBSOLETE_TARGET_HAS_MULTIPLE_TRANSFORM_PROPERTIES,
  },
  {
    flag: 1 << 9,
  ...
  {
    flag: 1 << 14,
    failure: AnimationFailureReasons.OBSOLETE_MULTIPLE_TRANSFORM_ANIMATIONS_ON_SAME_TARGET,
  },
  {
    flag: 1 << 15,
