...
export type RemoteFontResult = InsightResult<{
  fonts: Array<{
...
export function generateInsight(
    traceData: RequiredData<typeof deps>, context: BoundedInsightContext): RemoteFontResult {
  ...
  for (const event of remoteFontLoadEvents) {
    ...
    if (!/^(block|fallback|optional|swap)$/.test(display)) {
