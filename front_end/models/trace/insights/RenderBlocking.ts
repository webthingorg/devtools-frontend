...
function computeSavings(
    renderBlockingRequests: Types.TraceEvents.SyntheticNetworkRequest[],
    lanternContext: LanternContext): Pick<RenderBlockingInsightResult, 'metricSavings'|'summaryByUrl'> {
  ...
  if (!summaryByUrl.length) {
    return {metricSavings, summaryByUrl};
  }
  ...
  // TODO(crbug.com/313905799): how get?
  // const lcpIsImage = ???
  // if (!lcpIsImage) {
