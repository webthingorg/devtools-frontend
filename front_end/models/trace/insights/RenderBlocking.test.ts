...
describeWithEnvironment('RenderBlockingRequests', function() {
  it('finds render blocking requests', async () => {
    ...
    assert.deepStrictEqual([...insights.keys()], ['NO_NAVIGATION', '0BCFC23BC7D7BEDC9F93E912DCCEC1DA']);
  ...
  it('considers only the navigation specified by the context', async () => {
    ...
    assert.deepStrictEqual(
        [...insights.keys()],
        ['NO_NAVIGATION', '8671F33ECE0C8DBAEFBC2F9A2D1D6107', '1AE2016BBCC48AA090FDAE2CBBA01900']);
