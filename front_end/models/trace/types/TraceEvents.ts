...
export interface TraceEventScreenshotSnapshot extends TraceEventData {
  /**
...
export interface TraceEventPipelineReporterBegin extends TraceEventNestableAsyncBegin {
  id: string;
  args: TraceEventArgs&{
...
export interface TraceEventSyntheticPipelineReporter extends TraceEventSyntheticNestableAsyncEvent {
  args: TraceEventArgs&{
    data: TraceEventSyntheticNestableAsyncEvent['args']['data'] & {
      beginEvent: TraceEventPipelineReporterBegin,
    },
  };
}
