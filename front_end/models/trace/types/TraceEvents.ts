...
export function isTraceEventIsAuctionWorkletRunningInProcess(event: TraceEventData):
    event is TraceEventAuctionWorkletRunningInProcess {
  return event.name === 'AuctionWorkletRunningInProcess';
}
export function isTraceEventIsAuctionWorkletDoneWithProcess(event: TraceEventData):
