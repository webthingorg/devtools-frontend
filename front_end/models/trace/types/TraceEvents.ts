...
// This type can be used with synthetic entries based on a raw trace
// event (like SyntheticUserTimings) and with those that aren't (like
// profile calls).
 ...
 */
export interface SyntheticJSSample extends SyntheticEntry {
