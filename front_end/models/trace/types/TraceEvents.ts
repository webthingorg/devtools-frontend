...
export interface SyntheticWebSocketEvent extends TraceEventInstant {
  args: TraceEventArgs&{
    data: TraceEventArgsData & {
      identifier: number,
      url: string,
      ...
      stackTrace?: TraceEventCallFrame, priority: Protocol.Network.ResourcePriority,
      subEvents?: (TraceEventWebSocketCreate|TraceEventWebSocketInfo|TraceEventWebSocketTransfer)[],
    },
  };
  cat: string;
...
export type SyntheticCompleteEventType = SyntheticWebSocketEvent;
...
export function isSyntheticWebSocketEvent(
    traceEventData: TraceEventData,
    ): traceEventData is SyntheticWebSocketEvent {
  return traceEventData.name === 'SyntheticWebSocketEvent';
}
