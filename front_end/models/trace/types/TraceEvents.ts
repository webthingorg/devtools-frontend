...
export type RenderererEntry = SyntheticRendererEvent|TraceEventSyntheticProfileCall;
...
export function isRendererEvent(event: TraceEventData): event is RenderererEntry {
