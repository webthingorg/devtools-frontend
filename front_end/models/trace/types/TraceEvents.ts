...
export const ImportantEventName = {
  ...
  /* V8 */
  [KnownEventName.CompileCode]: 'Compile Code',
  [KnownEventName.CompileModule]: 'Compile Code',
  [KnownEventName.Compile]: 'Compile Code',
  [KnownEventName.CompileScript]: 'Compile Code',
