...
export class TraceProcessor extends EventTarget {
  ...
  static getEnabledInsightRunners(traceParsedData: Handlers.Types.TraceParseData): Insights.Types.TraceInsightData {
    const enabledInsights = {} as Insights.Types.TraceInsightData;
