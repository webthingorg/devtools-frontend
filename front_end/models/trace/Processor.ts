...
export class TraceProcessor extends EventTarget {
  ...
  #insightSets: Insights.Types.InsightSets|null = null;
  ...
  get insightSets(): Insights.Types.InsightSets|null {
    if (this.#status !== Status.FINISHED_PARSING) {
      return null;
    }

    return this.#insightSets;
  }
  ...
  #computeInsightSets(
      insights: Insights.Types.InsightSets, parsedTrace: Handlers.Types.ParsedTrace,
      insightRunners: Partial<typeof Insights.InsightRunners>, context: Insights.Types.InsightSetContext): void {
    const data = {} as Insights.Types.InsightSet['data'];
  ...
  #computeInsights(parsedTrace: Handlers.Types.ParsedTrace, traceEvents: readonly Types.Events.Event[]): void {
    ...
    if (navigations.length) {
      ...
      if (bounds.range > threshold) {
        ...
        this.#computeInsightSets(this.#insightSets, parsedTrace, enabledInsightRunners, context);
      }
