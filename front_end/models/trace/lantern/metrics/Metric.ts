...
class Metric {
  ...
  static getOptimisticGraph(dependencyGraph: Node, processedNavigation: Types.Simulation.ProcessedNavigation): Node {
    throw new Error('Optimistic graph unimplemented!');
  }

  static getPessimisticGraph(dependencyGraph: Node, processedNavigation: Types.Simulation.ProcessedNavigation): Node {
