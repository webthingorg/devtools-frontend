...
import {runTraceEngine} from '../testing/MetricTestUtils.js';
...
describe('NetworkAnalyzer', () => {
  ...
  before(async function() {
    ...
    traceWithRedirect = {
      traceEvents: await TraceLoader.rawEvents(this, 'lantern/redirect/trace.json.gz'),
    };
  });
  ...
  describe('#computeRTTAndServerResponseTime', () => {
    it('should work', async () => {
      ...
      assertMatchesJSONSnapshot(result.additionalRttByOrigin);
    });
  });
