...
type Node = import('../BaseNode.js').Node;
type NetworkNode = import('../NetworkNode.js').NetworkNode;
type CpuNode = import('../CpuNode.js').CPUNode;
type CompleteNodeTiming = import('./SimulationTimingMap.js')
                              .CpuNodeTimingComplete|import('./SimulationTimingMap.js')
                              .NetworkNodeTimingComplete;
type ConnectionTiming = import('./SimulationTimingMap.js').ConnectionTiming;
...
const PriorityStartTimePenalty: Record<NetworkNode['request']['priority'], number> = {
  VeryHigh: 0,
  High: 0.25,
  Medium: 0.5,
  Low: 1,
...
class Simulator<T = any> {
  ...
  _connectionPool: Lantern.Simulation.ConnectionPool;
