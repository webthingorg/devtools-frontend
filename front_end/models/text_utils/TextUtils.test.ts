  ...
  describe('FilterParser', () => {
    ...
    describe('parse', () => {
      ...
      it('returns correct results for a range of inputs', () => {
        ...
        result = parse('/regex/');
        assert.deepEqual(
            result[0], {key: undefined, regex: /regex/imv, text: undefined, negative: false}, 'result was incorrect');

        result = parse('/regex/ /another/');
        assert.deepEqual(
            result[0], {key: undefined, regex: /regex/imv, text: undefined, negative: false}, 'result was incorrect');
        assert.deepEqual(
            result[1], {key: undefined, regex: /another/imv, text: undefined, negative: false}, 'result was incorrect');

        result = parse(String.raw`/complex\/regex/`);
        assert.deepEqual(
            result[0], {key: undefined, regex: /complex\/regex/imv, text: undefined, negative: false},
        ...
        assert.deepEqual(
            result[0], {key: undefined, regex: /regex with spaces/imv, text: undefined, negative: false},
            'result was incorrect');
