...
export class NetworkPersistenceManager extends Common.ObjectWrapper.ObjectWrapper<EventTypes> implements
  ...
  encodedPathFromUrl(url: Platform.DevToolsPath.UrlString, ignoreNoActive?: boolean):
      Platform.DevToolsPath.EncodedPathString {
    if ((!this.activeInternal && !ignoreNoActive) || !this.projectInternal) {
  ...
  fileUrlFromNetworkUrl(url: Platform.DevToolsPath.UrlString, ignoreNoActive?: boolean):
      Platform.DevToolsPath.UrlString {
    if (!this.projectInternal) {
      return Platform.DevToolsPath.EmptyUrlString;
    }
    return (this.projectInternal as FileSystem).fileSystemPath() + '/' + this.encodedPathFromUrl(url, ignoreNoActive) as
        Platform.DevToolsPath.UrlString;
  }
