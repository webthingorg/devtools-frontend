...
export class NetworkPersistenceManager extends Common.ObjectWrapper.ObjectWrapper<EventTypes> implements
  ...
  readonly #sourceCodeToBindProcessMutex: WeakMap<Workspace.UISourceCode.UISourceCode, Common.Mutex.Mutex> =
      new WeakMap();
  ...
  #getOrCreateMutex(networkUISourceCode: Workspace.UISourceCode.UISourceCode) {
