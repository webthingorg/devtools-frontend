...
describeWithLocale('ContextMenuProvider', () => {
  ...
  // Enabling this test causes various others to time out on Mac and we don't know why.
  it.skip('[crbug.com/40784130] passes along the "isEncoded" flag to the FileManager for "Save as"', async () => {
