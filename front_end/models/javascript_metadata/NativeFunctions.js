...
export const NativeFunctions = [
  ...
  {
    name: 'register',
    signatures: [['name','operationCtor']],
    receivers: ['SharedStorageWorkletGlobalScope']
  },
  {
