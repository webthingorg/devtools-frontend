...
export const NativeFunctions = [
  ...
  },
  {
    name: 'get',
    signatures: [['id']],
    receivers: ['BackgroundFetchManager','Clients']
  },
  {
    name: 'get',
  ...
  },
  {
    ...
    receivers: ['MessagePort','ServiceWorker','Worker','DedicatedWorkerGlobalScope','Client']
  },
  {
    name: 'postMessage',
  ...
  {
    name: 'createOffer',
    signatures: [['?options'],['successCallback','failureCallback','?options'],['successCallback','failureCallback','?rtcOfferOptions']]
  },
  {
    name: 'getStats',
