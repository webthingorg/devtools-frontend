...
type ListenerArgs = [string, EventListenerOrEventListenerObject, boolean | AddEventListenerOptions | undefined];
...
document.addEventListener = function(...args: ListenerArgs) {
  documentListeners.push(args);
  return originalDocumentAddListener(...args);
};

class InternalPerformanceObserver extends PerformanceObserver {
  constructor(...args: [PerformanceObserverCallback]) {
    super(...args);
    observers.push(this);
  }
}
