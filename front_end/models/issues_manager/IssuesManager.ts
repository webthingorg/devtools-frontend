...
import type {Issue, IssueKind, HideIssueMenuSetting} from './Issue.js';
import {Events} from './IssuesManagerEvents.js';
import {defaultHideIssueByCodeSetting, IssueStatus} from './Issue.js';
...
export class IssuesManager extends Common.ObjectWrapper.ObjectWrapper<EventTypes> implements
  ...
  addIssue(issuesModel: SDK.IssuesModel.IssuesModel, issue: Issue): void {
    ...
    if (this.issueFilter(issue)) {
      ...
      this.updateIssueHiddenStatus(issue);
  ...
  private updateIssueHiddenStatus(issue: Issue): void {
