...
import {defaultHideIssueSetting, IssueStatus} from './Issue.js';
...
export class IssuesManager extends Common.ObjectWrapper.ObjectWrapper implements
  ...
  private hideIssue(issue: Issue): void {
    ...
    // All issues are hidden via their code despite of being chosen by either category, kind or code.
