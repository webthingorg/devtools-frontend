...
export const enum IssueCode {
  ...
  UseErrorMachingDictionaryNotUsed = 'SharedDictionaryIssue::UseErrorMachingDictionaryNotUsed',
...
function getIssueCode(details: Protocol.Audits.SharedDictionaryIssueDetails): IssueCode {
  switch (details.sharedDictionaryError) {
    ...
    case Protocol.Audits.SharedDictionaryError.UseErrorMachingDictionaryNotUsed:
      return IssueCode.UseErrorMachingDictionaryNotUsed;
...
const issueDescriptions: Map<Protocol.Audits.SharedDictionaryError, LazyMarkdownIssueDescription> = new Map([
  ...
  [
    Protocol.Audits.SharedDictionaryError.UseErrorMachingDictionaryNotUsed,
    {
      file: 'sharedDictionaryUseErrorMachingDictionaryNotUsed.md',
      links: specLinks,
    },
  ],
  [
