...
const cspURLViolation = {
  file: 'descriptions/cspURLViolation.md',
...
const cspInlineViolation = {
  file: 'descriptions/cspInlineViolation.md',
  substitutions: undefined,
  links: [{
...
const cspEvalViolation = {
  file: 'descriptions/cspEvalViolation.md',
  substitutions: undefined,
  links: [{
...
const cspTrustedTypesSinkViolation = {
  file: 'descriptions/cspTrustedTypesSinkViolation.md',
  substitutions: undefined,
  links: [{
...
const cspTrustedTypesPolicyViolation = {
  file: 'descriptions/cspTrustedTypesPolicyViolation.md',
  substitutions: undefined,
