...
export type HideIssueFilterSetting = {
  [x: string]: HideIssue,
};
...
export function defaultHideIssueMenuSetting(): HideIssueMenuSetting {
  const setting: HideIssueMenuSetting = {};
  return setting;
}

export function defaultHideIssueFilterSetting(): HideIssueFilterSetting {
  const setting: HideIssueFilterSetting = {};
  return setting;
}
...
export function getHideIssueMenuSetting(): Common.Settings.Setting<HideIssueMenuSetting> {
  return Common.Settings.Settings.instance().createSetting('hideIssueMenuSetting', defaultHideIssueMenuSetting());
}

export function getHideIssueFilterSetting(): Common.Settings.Setting<HideIssueFilterSetting> {
  return Common.Settings.Settings.instance().createSetting('HideIssueFilter', defaultHideIssueFilterSetting());
}
