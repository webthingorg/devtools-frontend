...
const UIStrings = {
  ...
  /**
   *@description Warning displayed to developers permission to use notifications has been requested by a cross-origin iframe, to notify them that this use is no longer supported.
   */
