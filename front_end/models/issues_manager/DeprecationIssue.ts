...
const UIStrings = {
  ...
  /**
   * @description A deprecation warning shown to developers in the DevTools Issues tab when code tries to use the deprecated hostCandidate field, guiding devolpers to use the the equivalent information in the .address and .port fields instead.
   */
