...
const UIStrings = {
  ...
  /**
   *@description This warning occurs when a frame accesses another frame's data,
   *    after having set `document.domain` without havin set the
   ...
   *    warning occurs when `document.domain` is set, and this warning occurs
   *    when an access has been made, based on that previous `document.domain`
   *    setting.
   */
