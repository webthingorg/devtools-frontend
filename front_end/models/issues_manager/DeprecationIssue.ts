...
const UIStrings = {
   ...
   *    Accept-CH header.
   */
  clientHintUaFullVersion: 'We are deprecating UA full version client hint: `Sec-CH-UA-Full-Version`. Instead, please use `Sec-CH-UA-Full-Version-List`. See https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Sec-CH-UA-Full-Version-List.',
  ...
  getDescription(): MarkdownIssueDescription {
    ...
    switch (this.#issueDetails.type) {
      ...
      case Protocol.Audits.DeprecationIssueType.ClientHintsUAFullVersion:
        messageFunction = i18nLazyString(UIStrings.clientHintUaFullVersion);
        break;
