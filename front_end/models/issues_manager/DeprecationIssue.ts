...
// `Deprecation.UIStrings` is typed as the real object literal.
// We don't have messages for all the deprecations, so we re-type it for
// easier handling.
type DeprecationUIStrings = Partial<Record<Protocol.Audits.DeprecationIssueType, string>>;
...
export class DeprecationIssue extends Issue {
  ...
  getDescription(): MarkdownIssueDescription {
    ...
    const uiStrings = Deprecation.UIStrings as DeprecationUIStrings;
    const maybeEnglishMessage = uiStrings[this.#issueDetails.type];
