...
const UIStrings = {
  ...
  /**
   * @description Warning displayed to developers when `window.openDatabase` is used in a non-secure context to notify that the API is deprecated.
   */
  openWebDatabaseInsecureContext:
      '`window.openDatabase` no longer works on insecure origins. Please use Web Storage or Indexed Database instead.',
  /**
