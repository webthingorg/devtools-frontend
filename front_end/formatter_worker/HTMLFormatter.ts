...
export class HTMLFormatter {
  ...
  _afterCloseTag(element: FormatterElement): void {
    this._builder.addNewLine();
  }
...
export class HTMLModel {
  ...
  _build(text: string): void {
    ...
    function processToken(this: HTMLModel, baseOffset: number, tokenValue: string, type: string | null, tokenStart: number, tokenEnd: number): Object | undefined {
