...
export class ResourceWebSocketFrameView extends UI.Widget.VBox {
  ...
  constructor(request: SDK.NetworkRequest.NetworkRequest) {
    ...
    this._timeComparator = (ResourceWebSocketFrameNodeTimeComparator as (arg0: DataGrid.SortableDataGrid.SortableDataGridNode<ResourceWebSocketFrameNode>, arg1: DataGrid.SortableDataGrid.SortableDataGridNode<ResourceWebSocketFrameNode>) => number);
    ...
    function onRowContextMenu(this: ResourceWebSocketFrameView, contextMenu: UI.ContextMenu.ContextMenu, genericNode: DataGrid.DataGrid.DataGridNode<any>): void {
  ...
  _onFrameDeselected(event: Common.EventTarget.EventTargetEvent): void {
...
export class ResourceWebSocketFrameNode extends DataGrid.SortableDataGrid.SortableDataGridNode<?> {
  ...
  opCode(): OpCodes {
    return /** @type {!OpCodes} */ this._frame.opCode as OpCodes;
  }
...
export function ResourceWebSocketFrameNodeTimeComparator(a: ResourceWebSocketFrameNode, b: ResourceWebSocketFrameNode): number {
