...
export class RequestInitiatorView extends UI.Widget.VBox {
  ...
  wasShown() {
    ...
    if (stackTracePreview) {
      ...
      this._appendExpandableSection(stackTracePreview.element, i18nString(UIStrings.requestCallStack), true);
    }
    ...
    if (initiatorGraph.initiators.size > 1 || initiatorGraph.initiated.size > 1) {
      ...
      this._appendExpandableSection(
          this._buildRequestChainTree(initiatorGraph).element, i18nString(UIStrings.requestInitiatorChain), true);
    }
