...
export class RequestInitiatorView extends UI.Widget.VBox {
  ...
  static createStackTracePreview(request: SDK.NetworkRequest.NetworkRequest, linkifier: Components.Linkifier.Linkifier, focusableLink?: boolean, callback?: (() => any)): {
    element: Element;
    links: Array<Element>;
  } | null {
    ...
    const stackTrace = Components.JSPresentationUtils.buildStackTracePreviewContents(target, linkifier, { stackTrace: initiator.stack, contentUpdated: callback, tabStops: focusableLink });
    return stackTrace;
  }
  ...
  _buildRequestChainTree(initiatorGraph: SDK.NetworkLog.InitiatorGraph, title: string, tree: UI.TreeOutline.TreeOutlineInShadow): UI.TreeOutline.TreeElement {
