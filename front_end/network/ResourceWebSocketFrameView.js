...
export class ResourceWebSocketFrameView extends UI.Widget.VBox {
  ...
  constructor(request) {
    ...
    // TODO(crbug.com/1011811): Remove clang-format comments once Closure is gone. The DevTools custom Closure
    //                          regex can't parse the object literal properly and thinks its a type.
    // clang-format off
