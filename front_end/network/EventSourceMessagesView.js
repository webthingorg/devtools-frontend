...
export class EventSourceMessagesView extends UI.Widget.VBox {
  ...
  constructor(request) {
    ...
    // TODO(crbug.com/1011811): Remove clang comments once Closure is gone. The custom Closure regexes have problems parsing
    //                          the object literal and treat the object literals as a type instead.
    // clang-format off
...
/**
 * @param {function(!SDK.NetworkRequest.EventSourceMessage):*} fieldGetter
