 ...
 */
const onRevealAndFilter = (evt: Event) => {
  const revealEvent = evt as CustomEvent<{filterType: NetworkLogView.FilterType, filterValue: string}[]>;
  NetworkPanel.NetworkPanel.revealAndFilter(revealEvent.detail);
};
