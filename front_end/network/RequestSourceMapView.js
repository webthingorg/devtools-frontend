 ...
 * @unrestricted
 */
Network.RequestSourceMapView = class extends UI.VBox {
  /**
  ...
  async wasShown() {
    ...
    self.webtreemap.sort(treemapNodes);
    this._treemap = new self.webtreemap.TreeMap(treemapNodes, {padding: [18, 3, 3, 3]});
