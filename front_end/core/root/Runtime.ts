...
export interface HostConfigDrJonesPerformanceAgentDogfood {
  modelId: string;
  temperature: number;
  enabled: boolean;
  userTier: string;
...
export interface HostConfigDrJonesFileAgentDogfood {
  modelId: string;
  temperature: number;
  enabled: boolean;
  userTier: string;
...
export type HostConfig = Platform.TypeScriptUtilities.RecursivePartial<{
  ...
  devToolsDrJonesPerformanceAgentDogfood: HostConfigDrJonesPerformanceAgentDogfood,
  devToolsDrJonesFileAgentDogfood: HostConfigDrJonesFileAgentDogfood,
