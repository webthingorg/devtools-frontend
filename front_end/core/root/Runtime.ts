...
export class ExperimentsSupport {
  ...
  register(
      experimentName: string, experimentTitle: string, unstable?: boolean,
      docLink?: Platform.DevToolsPath.UrlString): void {
    Platform.DCHECK(
    ...
    this.#experiments.push(new Experiment(
        this, experimentName, experimentTitle, Boolean(unstable), docLink ?? Platform.DevToolsPath.EmptyUrlString));
  }
