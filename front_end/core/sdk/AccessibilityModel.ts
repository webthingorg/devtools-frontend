...
export class AccessibilityNode {
  private accessibilityModelInternal: AccessibilityModel;
...
export class AccessibilityModel extends SDKModel {
  private agent: ProtocolProxyApi.AccessibilityApi;
  private axIdToAXNode: Map<string, AccessibilityNode>;
  // TODO(crbug.com/1172300) Ignored during the jsdoc to ts migration
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  // TODO(crbug.com/1172300) Ignored during the jsdoc to ts migration
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  private readonly backendDOMNodeIdToAXNode: Map<any, any>;
  ...
  axNodeForDOMNode(domNode: DOMNode|null): AccessibilityNode|null {
    ...
    return this.backendDOMNodeIdToAXNode.get(domNode.backendNodeId());
  }

  setAXNodeForBackendDOMNodeId(backendDOMNodeId: number, axNode: AccessibilityNode): void {
