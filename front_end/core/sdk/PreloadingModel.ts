...
export class PreloadingModel extends SDKModel.SDKModel<EventTypes> {
  ...
  constructor(target: Target.Target) {
    ...
    this.resourceTreeModelObserver = new ResourceTreeModelObserver(this);
  }

  dispose(): void {
    super.dispose();

    this.resourceTreeModelObserver.dispose();
...
class ResourceTreeModelObserver implements TargetManager.SDKModelObserver<ResourceTreeModel.ResourceTreeModel> {
