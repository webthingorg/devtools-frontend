...
export class PreloadingModel extends SDKModel.SDKModel<EventTypes> {
  ...
  onMainFrameNavigated(event: Common.EventTarget.EventTargetEvent<ResourceTreeModel.ResourceTreeFrame>): void {
    ...
    // For short-term, we mitigate this by handling
    // Page.prerenderAttemptCompleted as Page.frameNavigated for
    // prerendered pages. Note that this is far from perfect and may
    // cause race.
    //
