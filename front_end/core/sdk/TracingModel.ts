...
export class TracingModel {
  ...
  static isAsyncBeginPhase(phase: TraceEngine.Types.TraceEvents.Phase): boolean {
    return phase === TraceEngine.Types.TraceEvents.Phase.ASYNC_BEGIN ||
        phase === TraceEngine.Types.TraceEvents.Phase.ASYNC_NESTABLE_START;
  }
