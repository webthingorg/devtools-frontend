...
export class TracingModel {
  ...
  private readonly processByName: Map<any, any>;
  ...
  private addEvent(payload: EventPayload): void {
    ...
    if (timestamp && (!this.minimumRecordTimeInternal || timestamp < this.minimumRecordTimeInternal) &&
