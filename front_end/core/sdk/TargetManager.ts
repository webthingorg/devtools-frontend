...
export class TargetManager extends Common.ObjectWrapper.ObjectWrapper<EventTypes> {
  ...
  unobserveModels<T extends SDKModel>(modelClass: ModelClass<T>, observer: SDKModelObserver<T>, opts?: {
    scoped: boolean,
  }): void {
  ...
  addModelListener<Events, T extends keyof Events>(
    ...
    const wrappedListener = (event: Common.EventTarget.EventTargetEvent<any>): void => {
