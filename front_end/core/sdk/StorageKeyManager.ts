...
export class StorageKeyManager extends SDKModel<EventTypes> {
  ...
  #unreachableMainStorageKeyInternal: string|null;
  ...
  constructor(target: Target) {
    ...
    this.#unreachableMainStorageKeyInternal = '';
  ...
  unreachableMainStorageKey(): string|null {
    return this.#unreachableMainStorageKeyInternal;
  }

  setMainStorageKey(storageKey: string, unreachableStorageKey: string): void {
    this.#mainStorageKeyInternal = storageKey;
    this.#unreachableMainStorageKeyInternal = unreachableStorageKey || null;
    this.dispatchEventToListeners(Events.MainStorageKeyChanged, {
      mainStorageKey: this.#mainStorageKeyInternal,
      unreachableMainStorageKey: this.#unreachableMainStorageKeyInternal,
    });
  }
}
