...
export class CSSMatchedStyles {
  ...
  readonly #parentNodeId: Protocol.DOM.NodeId|undefined;
  ...
  constructor(
      ...
      animationsPayload: Protocol.CSS.CSSKeyframesRule[], parentNodeId: Protocol.DOM.NodeId|undefined) {
  ...
  getParentNodeId(): Protocol.DOM.NodeId|undefined {
