...
export class EnhancedTracesParser {
  ...
  data(): EnhancedTracesData {
    ...
    const data = new Map<Target, [ExecutionContext[], Script[]]>();
  ...
  private groupContextsAndScriptsUnderTarget(target: Target, executionContexts: ExecutionContext[], scripts: Script[]):
