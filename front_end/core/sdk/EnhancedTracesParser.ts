...
export class EnhancedTracesParser {
  private scriptRundownEvents: TraceEventScriptRundown[] = [];
  private scriptToV8Context: Map<string, string> = new Map<string, string>();
  private scriptToScriptSource: Map<string, string> = new Map<string, string>();
  private largeScriptToScriptSource: Map<string, string[]> = new Map<string, string[]>();
  private scriptToSourceLength: Map<string, number> = new Map<string, number>();
  private targets: RehydratingTarget[] = [];
  private executionContexts: RehydratingExecutionContext[] = [];
  private scripts: RehydratingScript[] = [];
  ...
  parseEnhancedTrace(traceEvents: unknown): void {
    for (const event of (traceEvents as unknown[])) {
