...
export class Cookie {
  ...
  sameSite(): Protocol.Network.CookieSameSite {
    ...
    return /** @type {!Protocol.Network.CookieSameSite} */ this.attributes['samesite'] as
  ...
  path(): string {
    return /** @type {string} */ this.attributes['path'] as string;
  }

  domain(): string {
    return /** @type {string} */ this.attributes['domain'] as string;
  }

  expires(): number {
    return /** @type {number} */ this.attributes['expires'] as number;
  }

  maxAge(): number {
    return /** @type {number} */ this.attributes['max-age'] as number;
  }

  sourcePort(): number {
    return /** @type {number} */ this.attributes['sourceport'] as number;
  }

  sourceScheme(): Protocol.Network.CookieSourceScheme {
    return /** @type {Protocol.Network.CookieSourceScheme} */ this.attributes['sourcescheme'] as
