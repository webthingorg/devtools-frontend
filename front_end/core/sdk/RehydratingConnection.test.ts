...
const mockTarget2: RehydratingTarget = {
  targetId: 'FGHIJ' as Protocol.Page.FrameId,
  type: 'page',
  isolate: '6789',
  url: 'example.com',
  pid: 6789,
...
const mockExecutionContext3: RehydratingExecutionContext = {
  id: 1 as Protocol.Runtime.ExecutionContextId,
  origin: 'example.com',
  v8Context: 'example context 3',
  auxData: {
    frameId: 'FGHIJ' as Protocol.Page.FrameId,
    isDefault: true,
    type: 'type',
  },
  isolate: '6789',
...
const mockScript3: RehydratingScript = {
  scriptId: '1' as Protocol.Runtime.ScriptId,
  isolate: '6789',
  executionContextId: 1 as Protocol.Runtime.ExecutionContextId,
  startLine: 0,
...
const targets: RehydratingTarget[] = [mockTarget1, mockTarget2];
const executionContexts: RehydratingExecutionContext[] =
    [mockExecutionContext1, mockExecutionContext2, mockExecutionContext3];
const scripts: RehydratingScript[] = [mockScript1, mockScript2, mockScript3];
