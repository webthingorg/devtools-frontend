...
export class OverlayPersistentHighlighter {
  ...
  highlightContainerQueryInOverlay(nodeId: number): void {
    this.containerQueryHighlights.set(nodeId, this.buildContainerQueryContainerHighlightConfig(nodeId));
    this.updateHighlightsInOverlay();
  }
  ...
  buildContainerQueryContainerHighlightConfig(_nodeId: number):
