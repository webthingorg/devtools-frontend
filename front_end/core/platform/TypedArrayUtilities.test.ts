...
describe('TypedArrayUtilities', () => {
  describe('BigUint32Array', () => {
    it('can be expandable', () => {
      const array = Platform.TypedArrayUtilities.createBigUint32Array();
    ...
    it('can act as a Uint32Array', () => {
      const array = Platform.TypedArrayUtilities.createBigUint32Array(15);
    ...
    it('can be bigger than a Uint32Array', () => {
      const array = Platform.TypedArrayUtilities.createBigUint32Array(12_345_678, /* maxLengthForTesting=*/ 2e6);
      ...
      assert.strictEqual(array.getValue(12_345_676), 9999);  // TEMP
    });
  });
});
