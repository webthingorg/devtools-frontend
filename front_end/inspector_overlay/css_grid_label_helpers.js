...
let GridBounds;  // eslint-disable-line no-unused-vars
...
/** @typedef {!{rows: TracksOffsetData, columns: TracksOffsetData, bounds: GridBounds}} */
let GridOffsetData;  // eslint-disable-line no-unused-vars
 ...
 *
 * @param {Object} config The highlight config object from the backend
 * @param {Object} bounds The bounds of the grid container
 * @return {GridOffsetData} The new, normalized, data object
 */
 ...
 * @param {object} data The normalized offset data
 */
