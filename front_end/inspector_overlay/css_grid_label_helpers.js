...
// The minimum distance (in px) a label has to be from the edge of the viewport to avoid being flipped inside the grid.
const gridPageMargin = 20;
// The minimum distance (in px) 2 labels can be to eachother.
const gridLabelDistance = 15;
