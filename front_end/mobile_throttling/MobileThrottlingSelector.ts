...
import {Conditions, MobileThrottlingConditionsGroup, ThrottlingPresets} from './ThrottlingPresets.js';  // eslint-disable-line no-unused-vars
...
export class MobileThrottlingSelector {
  _populateCallback: (arg0: Array<MobileThrottlingConditionsGroup>) => (
      Conditions |
      import(
          '/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/mobile_throttling/ThrottlingPresets')
  ...
  _options: (
      Conditions|import(
          '/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/mobile_throttling/ThrottlingPresets')
          .PlaceholderConditions|null)[];
  constructor(
      populateCallback: (arg0: Array<MobileThrottlingConditionsGroup>) => (
          Conditions |
          import(
              '/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/mobile_throttling/ThrottlingPresets')
              .PlaceholderConditions |
