...
export class MobileThrottlingSelector {
  _populateCallback: (arg0: Array<MobileThrottlingConditionsGroup>) => (Conditions | import("/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/mobile_throttling/ThrottlingPresets").PlaceholderConditions | null)[];
  _selectCallback: (arg0: number) => void;
  _options: (Conditions | import("/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/mobile_throttling/ThrottlingPresets").PlaceholderConditions | null)[];
  constructor(populateCallback: (arg0: Array<MobileThrottlingConditionsGroup>) => (Conditions | import("/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/mobile_throttling/ThrottlingPresets").PlaceholderConditions | null)[], selectCallback: (arg0: number) => void) {
  ...
  _populateOptions(): (Conditions | import("/usr/local/google/home/janscheffler/dev/devtools/devtools-frontend/front_end/mobile_throttling/ThrottlingPresets").PlaceholderConditions | null)[] {
    const disabledGroup = {
