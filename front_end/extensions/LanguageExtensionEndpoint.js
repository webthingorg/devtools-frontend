...
export class LanguageExtensionEndpoint extends Bindings.DebuggerLanguagePlugins.DebuggerLanguagePlugin {
  ...
  /**
   * @override
   * @param {{base: !Bindings.DebuggerLanguagePlugins.EvalBase, field: !Array<!Bindings.DebuggerLanguagePlugins.FieldInfo>}} expressionOrField
   * @return {!Promise<!{js: string}>}
   */
  getInspectableAddress(expressionOrField) {
    return /** @type {!Promise<!{js: string}>}} */ (
        this._sendRequest(this._commands.GetInspectableAddress, {expressionOrField}));
  }
