...
export class LanguageExtensionEndpoint extends Bindings.DebuggerLanguagePlugins.DebuggerLanguagePlugin {
  ...
  addRawModule(rawModuleId: string, symbolsURL: string, rawModule: Bindings.DebuggerLanguagePlugins.RawModule): Promise<string[]> {
    return /** @type {!Promise<!Array<string>>} */ this._sendRequest(this._commands.AddRawModule, { rawModuleId, symbolsURL, rawModule }) as Promise<string[]>;
  }
  ...
  removeRawModule(rawModuleId: string): Promise<void> {
    return /** @type {!Promise<void>} */ this._sendRequest(this._commands.RemoveRawModule, { rawModuleId }) as Promise<void>;
  }
  ...
  sourceLocationToRawLocation(sourceLocation: Bindings.DebuggerLanguagePlugins.SourceLocation): Promise<Bindings.DebuggerLanguagePlugins.RawLocationRange[]> {
    return /** @type {!Promise<!Array<!Bindings.DebuggerLanguagePlugins.RawLocationRange>>} */ this._sendRequest(this._commands.SourceLocationToRawLocation, { sourceLocation }) as Promise<Bindings.DebuggerLanguagePlugins.RawLocationRange[]>;
  }
  ...
  rawLocationToSourceLocation(rawLocation: Bindings.DebuggerLanguagePlugins.RawLocation): Promise<Bindings.DebuggerLanguagePlugins.SourceLocation[]> {
    return /** @type {!Promise<!Array<!Bindings.DebuggerLanguagePlugins.SourceLocation>>} */ this._sendRequest(this._commands.RawLocationToSourceLocation, { rawLocation }) as Promise<Bindings.DebuggerLanguagePlugins.SourceLocation[]>;
  }

  getScopeInfo(type: string): Promise<Bindings.DebuggerLanguagePlugins.ScopeInfo> {
    return /** @type {!Promise<!Bindings.DebuggerLanguagePlugins.ScopeInfo>} */ this._sendRequest(this._commands.GetScopeInfo, { type }) as Promise<Bindings.DebuggerLanguagePlugins.ScopeInfo>;
  }
  ...
  listVariablesInScope(rawLocation: Bindings.DebuggerLanguagePlugins.RawLocation): Promise<Bindings.DebuggerLanguagePlugins.Variable[]> {
    return /** @type {!Promise<!Array<!Bindings.DebuggerLanguagePlugins.Variable>>} */ this._sendRequest(this._commands.ListVariablesInScope, { rawLocation }) as Promise<Bindings.DebuggerLanguagePlugins.Variable[]>;
  }
  ...
  getFunctionInfo(rawLocation: Bindings.DebuggerLanguagePlugins.RawLocation): Promise<{
    ...
    return /** @type {!Promise<!{frames: !Array<!Bindings.DebuggerLanguagePlugins.FunctionInfo>}>} */ this._sendRequest(this._commands.GetFunctionInfo, { rawLocation }) as Promise<{
      frames: Array<Bindings.DebuggerLanguagePlugins.FunctionInfo>;
    }>;
  }
  ...
  getInlinedFunctionRanges(rawLocation: Bindings.DebuggerLanguagePlugins.RawLocation): Promise<Bindings.DebuggerLanguagePlugins.RawLocationRange[]> {
    return /** @type {!Promise<!Array<!Bindings.DebuggerLanguagePlugins.RawLocationRange>>} */ this._sendRequest(this._commands.GetInlinedFunctionRanges, { rawLocation }) as Promise<Bindings.DebuggerLanguagePlugins.RawLocationRange[]>;
  }
  ...
  getInlinedCalleesRanges(rawLocation: Bindings.DebuggerLanguagePlugins.RawLocation): Promise<Bindings.DebuggerLanguagePlugins.RawLocationRange[]> {
    return /** @type {!Promise<!Array<!Bindings.DebuggerLanguagePlugins.RawLocationRange>>} */ this._sendRequest(this._commands.GetInlinedCalleesRanges, { rawLocation }) as Promise<Bindings.DebuggerLanguagePlugins.RawLocationRange[]>;
  }
  ...
  getTypeInfo(expression: string, context: Bindings.DebuggerLanguagePlugins.RawLocation): Promise<{
    ...
    return /** @type {!Promise<?{typeInfos: !Array<!Bindings.DebuggerLanguagePlugins.TypeInfo>, base: !Bindings.DebuggerLanguagePlugins.EvalBase}>} */ this._sendRequest(this._commands.GetTypeInfo, { expression, context }) as Promise<{
      typeInfos: Array<Bindings.DebuggerLanguagePlugins.TypeInfo>;
      base: Bindings.DebuggerLanguagePlugins.EvalBase;
    } | null>;
  }
  ...
  getFormatter(expressionOrField: string | {
    ...
    return /** @type {!Promise<!{js: string}>} */ this._sendRequest(this._commands.GetFormatter, { expressionOrField, context }) as Promise<{
      js: string;
    }>;
  }
  ...
  getInspectableAddress(field: {
    ...
    return /** @type {!Promise<!{js: string}>}} */ this._sendRequest(this._commands.GetInspectableAddress, { field }) as Promise<{
      js: string;
    }>;
  }
