...
export class LayerPaintProfilerView extends UI.SplitWidget.SplitWidget {
  ...
  profile(snapshot: SDK.PaintProfiler.PaintProfilerSnapshot): void {
    ...
    function setSnapshotAndLog(this: LayerPaintProfilerView, snapshot: SDK.PaintProfiler.PaintProfilerSnapshot | null, log: SDK.PaintProfiler.PaintProfilerLogItem[] | null): void {
