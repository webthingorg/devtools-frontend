...
export class AnimationTimeline extends UI.Widget.VBox implements SDK.SDKModel.SDKModelObserver {
  ...
  _createScrubber(): HTMLElement {
    this._timelineScrubber = (document.createElement('div') as HTMLElement);
