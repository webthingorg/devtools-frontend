...
export class WebauthnPaneImpl extends UI.Widget.VBox {
  ...
  async _updateCredentialTable(authenticatorId) {
    ...
    /** @type {!Element} */
    const credentialTableBodySafe =
        credentialTableBody;  // Workaround to closure compiler requirements without TS typing.
    ...
    credentials.forEach(credential => this._insertCredentialRow(authenticatorId, credentialTableBodySafe, credential));
