...
Common.Settings.registerSettingExtension({
  ...
  defaultValue: [
    {
      title: i18nLazyString(UIStrings.berlin),
      lat: 52.520007,
      long: 13.404954,
    ...
    {
      title: i18nLazyString(UIStrings.london),
      lat: 51.507351,
      long: -0.127758,
    ...
    {
      title: i18nLazyString(UIStrings.moscow),
      lat: 55.755826,
      long: 37.6173,
    ...
    {
      title: i18nLazyString(UIStrings.mountainView),
      lat: 37.386052,
      long: -122.083851,
    ...
    {
      title: i18nLazyString(UIStrings.mumbai),
      lat: 19.075984,
      long: 72.877656,
    ...
    {
      title: i18nLazyString(UIStrings.sanFrancisco),
      lat: 37.774929,
      long: -122.419416,
      timezoneId: 'US/Pacific',
      locale: 'en_US',
    ...
    {
      title: i18nLazyString(UIStrings.shanghai),
      lat: 31.230416,
      long: 121.473701,
    ...
    {
      title: i18nLazyString(UIStrings.saoPaulo),
      lat: -23.55052,
      long: -46.633309,
    ...
    {
      title: i18nLazyString(UIStrings.tokyo),
      lat: 35.689487,
      long: 139.691706,
