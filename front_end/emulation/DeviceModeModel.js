...
export const UIStrings = {
  ...
  */
  mobile: 'Mobile',
  /**
  *@description Text in Device Mode Model of the Device Toolbar
  */
...
export const UA = {
  ...
  MobileNoTouch: i18nString(UIStrings.mobileNoTouch),
  Desktop: i18nString(UIStrings.desktop),
  DesktopTouch: i18nString(UIStrings.desktopTouch)
};
