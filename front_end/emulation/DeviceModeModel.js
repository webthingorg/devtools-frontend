...
export class DeviceModeModel extends Common.ObjectWrapper.ObjectWrapper {
  ...
  _applyUserAgent(userAgent, userAgentMetadata) {
    self.SDK.multitargetNetworkManager.setUserAgentOverride(userAgent, userAgentMetadata);
  }
...
// ### check these, get version right
export const _defaultMobileUserAgentMetadata = {
  brand: 'Chrome',
  fullVersion: SDK.NetworkManager.MultitargetNetworkManager.patchUserAgentWithChromeVersion('%s'),
  majorVersion: SDK.NetworkManager.MultitargetNetworkManager.patchUserAgentWithChromeMajorVersion('%s'),
  platform: 'Android',
  platformVersion: '6.0',
  architecture: 'arm',
  model: 'Nexus 5',
