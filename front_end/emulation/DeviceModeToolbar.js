...
export class DeviceModeToolbar {
  ...
  _appendScaleMenuItems(contextMenu) {
    ...
    boundAppendScaleItem(i18nString('50%'), 0.5);
    boundAppendScaleItem(i18nString('75%'), 0.75);
    boundAppendScaleItem(i18nString('100%'), 1);
    boundAppendScaleItem(i18nString('125%'), 1.25);
    boundAppendScaleItem(i18nString('150%'), 1.5);
  ...
  _appendDeviceScaleMenuItems(contextMenu) {
    ...
    appendDeviceScaleFactorItem(
        contextMenu.headerSection(), i18nString(i18nString(UIStrings.defaultF), {PH: defaultValue}), 0);
