...
export const UIStrings = {
  ...
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_2496af30b64c3a4ff21e8505ea439a73: '50%',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_f819de81247be4a5428dc0e169de28b8: '75%',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_30bd7ce7de206924302499f197c7a966: '100%',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_649676015173b6195516eed77e5aee60: '125%',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_6149711fb8edc5e2adeea7aa63ee11ff: '150%',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  *@example {4.3} PH1
  */
  ...
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_c4ca4238a0b923820dcc509a6f75849b: '1',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_c81e728d9d4c2f636f067f89cc14862c: '2',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
  IDS_DEVTOOLS_eccbc87e4b5ce2fe28308fd9f2a7baf3: '3',
  /**
  *@description Text in Device Mode Toolbar of the Device Toolbar
  */
...
const str_ = i18n.i18n.registerUIStrings('emulation/DeviceModeToolbar.js', UIStrings);
...
export class DeviceModeToolbar {
  ...
  _fillRightToolbar(toolbar) {
    ...
    this._scaleItem.setTitle(i18nString(UIStrings.zoom));
    ...
    this._deviceScaleItem.setTitle(i18nString(UIStrings.devicePixelRatio));
    ...
    this._uaItem.setTitle(i18nString(UIStrings.deviceType));
  ...
  _createExperimentalButton(toolbar) {
    ...
    const title = (this._model.webPlatformExperimentalFeaturesEnabled()) ?
        i18nString('\"Experimental Web Platform Feature\" flag is enabled. Click to disable it.') :
        i18nString('\"Experimental Web Platform Feature\" flag is disabled. Click to enable it.');
  ...
  _appendScaleMenuItems(contextMenu) {
    ...
    contextMenu.footerSection().appendCheckboxItem(
        i18nString(UIStrings.autoadjustZoom), this._onAutoAdjustScaleChanged.bind(this), this._autoAdjustScaleSetting.get());
    const boundAppendScaleItem = appendScaleItem.bind(this);
    boundAppendScaleItem(i18nString(UIStrings.IDS_DEVTOOLS_2496af30b64c3a4ff21e8505ea439a73), 0.5);
    boundAppendScaleItem(i18nString(UIStrings.IDS_DEVTOOLS_f819de81247be4a5428dc0e169de28b8), 0.75);
    boundAppendScaleItem(i18nString(UIStrings.IDS_DEVTOOLS_30bd7ce7de206924302499f197c7a966), 1);
    boundAppendScaleItem(i18nString(UIStrings.IDS_DEVTOOLS_649676015173b6195516eed77e5aee60), 1.25);
    boundAppendScaleItem(i18nString(UIStrings.IDS_DEVTOOLS_6149711fb8edc5e2adeea7aa63ee11ff), 1.5);
  ...
  _appendDeviceScaleMenuItems(contextMenu) {
    ...
    appendDeviceScaleFactorItem(contextMenu.headerSection(), i18nString('Default: %.1f', defaultValue), 0);
    appendDeviceScaleFactorItem(
        contextMenu.defaultSection(), i18nString(UIStrings.IDS_DEVTOOLS_c4ca4238a0b923820dcc509a6f75849b), 1);
    appendDeviceScaleFactorItem(
        contextMenu.defaultSection(), i18nString(UIStrings.IDS_DEVTOOLS_c81e728d9d4c2f636f067f89cc14862c), 2);
    appendDeviceScaleFactorItem(
        contextMenu.defaultSection(), i18nString(UIStrings.IDS_DEVTOOLS_eccbc87e4b5ce2fe28308fd9f2a7baf3), 3);
  ...
  update() {
    if (this._model.type() !== this._cachedModelType) {
      ...
      if (this._model.type() === Type.Responsive) {
        ...
        this._modeButton.setTitle(i18nString(UIStrings.rotate));
      } else {
    ...
    if (this._model.scale() !== this._cachedScale) {
      this._scaleItem.setText(i18nString('%.0f%%', this._model.scale() * 100));
    ...
    if (deviceScale !== this._cachedDeviceScale) {
      this._deviceScaleItem.setText(i18nString('DPR: %.1f', deviceScale));
    ...
    if (this._experimentDualScreenSupport && this._experimentalButton) {
      ...
      this._spanButton.setTitle(i18nString(UIStrings.toggleDualscreenMode));
    }
