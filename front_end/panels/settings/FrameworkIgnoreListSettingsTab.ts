...
export class FrameworkIgnoreListSettingsTab extends UI.Widget.VBox implements
  ...
  constructor() {
    ...
    automaticallyIgnoreLinkButton
        .data = {iconName: 'help', variant: Buttons.Button.Variant.ICON, size: Buttons.Button.Size.SMALL};
    automaticallyIgnoreLink.prepend(automaticallyIgnoreLinkButton);
