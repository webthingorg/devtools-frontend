...
import {parseList, ResultKind, serializeItem, serializeList, type Item, type List, type Parameters, type ParamName, type String as SHString} from './StructuredHeaders.js';
