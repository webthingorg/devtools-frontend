...
import * as DeviceSettingsTab from './device_settings_tab.js';
...
const str_ = i18n.i18n.registerUIStrings('panels/settings/emulation/device_settings_tab-meta.ts', UIStrings);
...
UI.ViewManager.registerViewExtension({
  ...
  order: 30,
  async loadView() {
    return DeviceSettingsTab.DeviceSettingsTab.DevicesSettingsTab.instance();
  },
  id: 'devices',
  settings: [
