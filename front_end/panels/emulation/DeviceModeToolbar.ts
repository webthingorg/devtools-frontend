...
export class DeviceModeToolbar {
  ...
  constructor(
    ...
    this.widthInput = new EmulationComponents.DeviceSizeInputElement.SizeInputElement(
        i18nString(UIStrings.width), {jslogContext: 'widthSizeInput'});
    ...
    this.heightInput = new EmulationComponents.DeviceSizeInputElement.SizeInputElement(
        i18nString(UIStrings.heightLeaveEmptyForFull), {jslogContext: 'heightSizeInput'});
  ...
  private fillLeftToolbar(toolbar: UI.Toolbar.Toolbar): void {
    ...
    this.deviceSelectItem =
        new UI.Toolbar.ToolbarMenuButton(this.appendDeviceMenuItems.bind(this), undefined, 'deviceSelect');
  ...
  private fillRightToolbar(toolbar: UI.Toolbar.Toolbar): void {
    toolbar.appendToolbarItem(this.wrapToolbarItem(this.createEmptyToolbarElement()));
    this.scaleItem = new UI.Toolbar.ToolbarMenuButton(this.appendScaleMenuItems.bind(this), undefined, 'scaleMenu');
    ...
    this.deviceScaleItem =
        new UI.Toolbar.ToolbarMenuButton(this.appendDeviceScaleMenuItems.bind(this), undefined, 'deviceScaleMenu');
  ...
  private appendScaleMenuItems(contextMenu: UI.ContextMenu.ContextMenu): void {
    ...
    boundAppendScaleItem('50%', 0.5, '50%');
    boundAppendScaleItem('75%', 0.75, '75%');
    boundAppendScaleItem('100%', 1, '100%');
    boundAppendScaleItem('125%', 1.25, '125%');
    boundAppendScaleItem('150%', 1.5, '150%');
    boundAppendScaleItem('200%', 2, '200%');

    function appendScaleItem(this: DeviceModeToolbar, title: string, value: number, jslogContext: string): void {
      contextMenu.defaultSection().appendCheckboxItem(
          title, this.onScaleMenuChanged.bind(this, value), this.model.scaleSetting().get() === value, false, undefined,
          undefined, jslogContext);
    }
  }
