...
export class DeviceModeToolbar {
  ...
  private appendDevicePostureItems(contextMenu: UI.ContextMenu.ContextMenu): void {
    const boundDevicePostureItem = appendDevicePostureItem.bind(this);
    boundDevicePostureItem(contextMenu.defaultSection(), 'Continuous');
    boundDevicePostureItem(contextMenu.defaultSection(), 'Folded');

    function appendDevicePostureItem(section: UI.ContextMenu.Section, title: string): void {
