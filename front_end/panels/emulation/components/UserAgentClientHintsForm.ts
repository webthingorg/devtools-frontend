...
const UIStrings = {
  ...
  /**
    ...
    */
  deviceModelRow: 'Device model row',
  /**
...
export class UserAgentClientHintsForm extends HTMLElement {
  ...
  private renderPlatformSection(): LitHtml.TemplateResult {
    ...
    return LitHtml.html`
      ...
      <div class="full-row brand-row" aria-label="${i18nString(UIStrings.platformRow)}">
        <input
  ...
  private renderDeviceModelSection(): LitHtml.TemplateResult {
    ...
    return LitHtml.html`
      ...
      <div class="full-row brand-row" aria-label="${i18nString(UIStrings.deviceModelRow)}">
        <input
  ...
  private renderBrands(): LitHtml.TemplateResult {
    ...
    const brandElements = brands.map((brandRow, index) => {
      ...
      return LitHtml.html`
        <div class="full-row brand-row" aria-label="${i18nString(UIStrings.brandList)}">
          <input
