...
const str_ = i18n.i18n.registerUIStrings('panels/changes/DiffRenderer.ts', UIStrings);
...
export class DiffRenderer {
  ...
  static async render(diff: Diff.Diff.DiffArray, mimeType: string, parent: HTMLElement): Promise<void> {
