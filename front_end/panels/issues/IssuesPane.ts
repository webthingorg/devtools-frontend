...
export class IssuesPane extends UI.Widget.VBox {
  ...
  showAllHiddenIssues(): void {
    IssuesManager.Issue.getHideIssueByKindSetting().set(IssuesManager.Issue.defaultHideIssueByKindSetting());
    IssuesManager.Issue.getHideIssueByCatergorySetting().set(IssuesManager.Issue.defaultHideIssueByCategorySetting());
    IssuesManager.Issue.getHideIssueByCodeSetting().set(IssuesManager.Issue.defaultHideIssueByCodeSetting());
  }
