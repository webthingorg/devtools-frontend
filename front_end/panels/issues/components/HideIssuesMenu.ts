...
export class HideIssuesMenu extends HTMLElement {
  ...
  #render(): void {
    ...
    <${Buttons.Button.Button.litTagName}
      .data=${{variant: Buttons.Button.Variant.ICON,iconName: 'dots-vertical'} as Buttons.Button.ButtonData}
      .title=${i18nString(UIStrings.tooltipTitle)}
      .jslogContext=${VisualLogging.dropDown('hide-issues').track({click: true})}
      class="hide-issues-menu-btn"
      @click=${this.onMenuOpen.bind(this)}>
    </${Buttons.Button.Button.litTagName}>
