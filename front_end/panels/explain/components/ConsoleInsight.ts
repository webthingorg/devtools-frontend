...
const UIStrings = {
  ...
  /**
   * @description The title of the screen in a console insight asking for a confirmation to send the data.
   */
  consentTitle: 'Debug console errors faster with AI insights',
  /**
...
export class ConsoleInsight extends HTMLElement {
  ...
  #getHeader(): string {
    switch (this.#state.type) {
      ...
      case State.CONSENT:
        return i18nString(UIStrings.consentTitle);
    }
  }
