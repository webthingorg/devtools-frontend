...
export class ConsoleInsight extends HTMLElement {
  ...
  #renderLearnMoreAboutInsights(): LitHtml.TemplateResult {
    // clang-format off
    return html`<x-link href=${DOGFOODINFO_URL} class="link">Learn more about Gen AI in DevTools</x-link>`;
    // clang-format on
  }
      ...
      case State.CONSENT_ONBOARDING:
        switch (this.#state.page) {
          case ConsentOnboardingPage.PAGE1:
            return html`<main>
              <p>This notice and our <x-link href="https://policies.google.com/privacy" class="link">privacy notice</x-link> describe how 'Understand this message" in Chrome DevTools handles your data. Please read them carefully.</p>
          ...
          case ConsentOnboardingPage.PAGE2:
            ...
            <ul>
              ...
              <li>This feature is experimental and subject to future changes.</li>
            ...
            <label>
              ...
              <span>I accept my use of "Understand this message" is subject to the <x-link href="https://policies.google.com/terms" class="link">Google Terms of Service</x-link> and the <x-link href=${'https://policies.google.com/terms/gener' + 'ative-ai'} class="link">${'Gener' + 'ative'} AI Additional Terms of Service</x-link>.</span>
            </label>
            </p>
            </main>`;
        }
