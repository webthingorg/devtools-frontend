...
export class CSSOverviewSidebarPanel extends Common.ObjectWrapper.eventMixin<EventTypes, typeof UI.Widget.VBox>(
  ...
  #onItemClick(event: Event): void {
    ...
    this.select(id);
    this.dispatchEventToListeners(SidebarEvents.ItemSelected, {id: id, isMouseEvent: true});
  }
  ...
  #onItemKeyDown(event: KeyboardEvent): void {
    ...
    this.select(id);
    this.dispatchEventToListeners(SidebarEvents.ItemSelected, {id: id, isMouseEvent: false});
    event.consume(true);
  }
