...
describeWithMockConnection('AnimationModel', () => {
  ...
  describe('AnimationImpl', () => {
    it('rebase should update values returned from the relevant value functions for time based animations', async () => {
      const target = createTarget();
      const model = new Animation.AnimationModel.AnimationModel(target);
      const animationImpl = new Animation.AnimationModel.AnimationImpl(model, {
        id: '1',
        name: 'animation-name',
        pausedState: false,
        playbackRate: 1,
    ...
    it('rebase should update values returned from the relevant value functions for scroll based animations',
       async () => {
