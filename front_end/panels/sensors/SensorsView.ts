...
export class SensorsView extends UI.Widget.VBox {
  ...
  private createLocationSection(location: SDK.EmulationModel.Location): void {
    ...
    geogroup.setAttribute('jslog', `${VisualLogging.sensorsLocationSection()}`);
    ...
    manageButton.setAttribute('jslog', `${VisualLogging.sensorsManageLocations().track({click: true})}`);
  ...
  private createDeviceOrientationSection(): void {
    ...
    orientationGroup.setAttribute('jslog', `${VisualLogging.sensorsOrientationSection()}`);
  ...
  private createDeviceOrientationOverrideElement(deviceOrientation: SDK.EmulationModel.DeviceOrientation):
    ...
    resetButton.setAttribute('jslog', `${VisualLogging.reset().track({click: true})}`);
