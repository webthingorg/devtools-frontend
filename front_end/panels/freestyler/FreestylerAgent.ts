...
You are going to answer to the query using THOUGHT, ACTION, ANSWER keywords stricly following instructions for each step.
...
ANWER is always followed by FIXABLE.
