...
Use ACTION to run JavaScript on the page. Following ACTION, output JavaScript code you want to run followed by STOP.
...
Use $0 to learn about the selected element.
...
ACTION
/* Collect information at this point */
...
OBSERVATION
{"textAlign":"normal","justifyContent":"center","display":"block"}
