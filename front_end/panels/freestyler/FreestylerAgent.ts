...
type AgentOptions = {
  ...
  confirmSideEffect?: <T>() => ReturnType<typeof Platform.PromiseUtilities.promiseWithResolvers<T>>,
...
export class FreestylerAgent {
  ...
  constructor(opts: AgentOptions) {
    ...
    this.#confirmSideEffect = opts.confirmSideEffect ?? Platform.PromiseUtilities.promiseWithResolvers;
  }
