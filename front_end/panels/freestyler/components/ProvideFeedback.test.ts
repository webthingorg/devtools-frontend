...
describe('ProvideFeedback', () => {
  it('should show the feedback form', async () => {
    const component = new Freestyler.ProvideFeedback({onFeedbackSubmit: sinon.stub(), showFeedbackForm: true});
  ...
  it('should not show the feedback form', async () => {
    const component = new Freestyler.ProvideFeedback({onFeedbackSubmit: sinon.stub(), showFeedbackForm: false});
    renderElementIntoDOM(component);
    await coordinator.done();
