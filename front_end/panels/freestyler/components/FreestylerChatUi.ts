...
function getInputPlaceholderString(aidaAvailability: Host.AidaClient.AccountAvailability): string {
  switch (aidaAvailability) {
    case Host.AidaClient.AccountAvailability.AVAILABLE:
      return i18nString(UIStringsTemp.inputPlaceholder);
    case Host.AidaClient.AccountAvailability.NO_ACCOUNT_EMAIL:
      return i18nString(UIStringsTemp.notLoggedIn);
    case Host.AidaClient.AccountAvailability.NO_ACTIVE_SYNC:
      return i18nString(UIStringsTemp.syncIsOff);
    case Host.AidaClient.AccountAvailability.NO_INTERNET:
...
export interface Props {
  ...
  state: State;
  aidaAvailability: Host.AidaClient.AccountAvailability;
...
export class FreestylerChatUi extends HTMLElement {
  ...
  #renderChatUi = (): LitHtml.TemplateResult => {
    ...
    const isAidaAvailable = this.#props.aidaAvailability === Host.AidaClient.AccountAvailability.AVAILABLE;
