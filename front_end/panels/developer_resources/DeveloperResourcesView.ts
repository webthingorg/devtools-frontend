...
export class DeveloperResourcesRevealer implements
    Common.Revealer.Revealer<SDK.PageResourceLoader.ResourceInitiatorKey> {
  async reveal(resourceInitiatorKey: SDK.PageResourceLoader.ResourceInitiatorKey): Promise<void> {
