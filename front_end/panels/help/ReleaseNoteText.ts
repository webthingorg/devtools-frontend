...
export const releaseNoteText: ReleaseNote[] = [
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        subtitle: 'View all the JavaScript bundles on your page easily with the new Lighthouse Treemap, and more.',
        link: 'https://developer.chrome.com/blog/new-in-devtools-92#lighthouse',
      },
      {
        title: 'Improvements on CORS debugging',
        subtitle: 'Report CORS errors in the Issues tab.',
