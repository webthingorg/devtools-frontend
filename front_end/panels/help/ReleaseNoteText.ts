...
export const releaseNoteText: ReleaseNote[] = [
  {
    ...
    highlights: [
      {
        title: 'New preview feature: Recorder Overview panel',
        subtitle: 'Record, replay and measure user flows with option to export to Puppeteer script.',
      ...
      },
      {
        ...
        subtitle: 'Edit as HTML in the Elements panel now supports code completion, syntax highlghts and more.',
