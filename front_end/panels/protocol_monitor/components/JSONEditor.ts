...
export class JSONEditor extends LitElement {
  ...
  @property() declare targets: SDK.Target.Target[];
  ...
  constructor() {
    ...
    this.targetId = this.targets.length !== 0 ? this.targets[0].id() : undefined;
  ...
  override connectedCallback(): void {
    ...
    targetManager.addEventListener(SDK.TargetManager.Events.AvailableTargetsChanged, () => {
      this.targets = targetManager.targets();
    });
  }
  ...
  override disconnectedCallback(): void {
    ...
    const targetManager = SDK.TargetManager.TargetManager.instance();
    targetManager.removeEventListener(SDK.TargetManager.Events.AvailableTargetsChanged, () => {});
  }
