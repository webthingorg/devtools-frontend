...
import contentEditableStyles from './jsonPromptEditor.css.js';
...
declare global {
  interface HTMLElementTagNameMap {
    'devtools-json-prompt-editor': JSONPromptEditor;
    'devtools-editable-json-editor': EditableContent;
    'devtools-suggestion-box-json-editor': SuggestionBox;
  }
}
...
@customElement('devtools-editable-json-editor')
 ...
 */
@customElement('devtools-suggestion-box-json-editor')
...
@customElement('devtools-json-prompt-editor')
export class JSONPromptEditor extends LitElement {
  ...
  get #editableContent(): EditableContent {
    ...
    const node = this.renderRoot.querySelector('devtools-editable-json-editor');
    if (!node) {
  ...
  override render(): LitHtml.TemplateResult {
    return html`<devtools-editable-json-editor
        ...
        spellcheck="false"
      ></devtools-editable-json-editor>
      <devtools-suggestion-box-json-editor
