...
export class ProtocolMonitorImpl extends UI.Widget.VBox {
  ...
  private messageReceived(message: Message, target: ProtocolClient.InspectorBackend.TargetBase|null): void {
    ...
    responseIcon.data = {iconName: 'arrow-up', color: 'var(--color-text-disabled)', width: '20px', height: '20px'};
  ...
  private messageSent(
    ...
    requestResponseIcon
        .data = {iconName: 'arrow-up-down', color: 'var(--color-primary-old)', width: '20px', height: '20px'};
    const newRow: DataGrid.DataGridUtils.Row = {
      styles: {
