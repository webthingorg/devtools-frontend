  ...
  modelAdded(serviceWorkerManager: SDK.ServiceWorkerManager.ServiceWorkerManager): void {
    ...
    this.eventListeners.set(serviceWorkerManager, [
      ...
      this.securityOriginManager.addEventListener(
          SDK.SecurityOriginManager.Events.SECURITY_ORIGIN_ADDED, this.updateSectionVisibility, this),
      this.securityOriginManager.addEventListener(
          SDK.SecurityOriginManager.Events.SECURITY_ORIGIN_REMOVED, this.updateSectionVisibility, this),
    ]);
  }
