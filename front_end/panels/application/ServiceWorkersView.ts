...
export class Section {
  ...
  private readonly staticRouterView: ApplicationComponents.ServiceWorkerStaticRouterView.ServiceWorkerStaticRouterView;
  ...
  constructor(
    ...
    this.staticRouterView = new ApplicationComponents.ServiceWorkerStaticRouterView.ServiceWorkerStaticRouterView();
  ...
  private maybeCreateStaticRouterField(): void {
    ...
    if (active && active.routerRules && active.routerRules.length > 0) {
      ...
      if (!this.staticRouterField.lastElementChild) {
        this.staticRouterField.appendChild(this.staticRouterView);
      }
      this.staticRouterView.update(active.routerRules);
    } else {
