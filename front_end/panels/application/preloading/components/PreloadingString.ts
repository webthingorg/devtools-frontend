...
const UIStrings = {
  /**
   *@description  Description text for Prefetch status PrefetchAllowed.
   */
  PrefetchAllowed: '',
  /**
  ...
  /**
   *@description  Description text for Prefetch status PrefetchHeldback.
   */
  // PrefetchHeldback: '',
  /**
  ...
  /**
   *@description  Description text for Prefetch status PrefetchNotFinishedInTime.
   */
  // PrefetchNotFinishedInTime: '',
  /**
   *@description  Description text for Prefetch status PrefetchNotStarted.
   */
  // PrefetchNotStarted: '',
  /**
  ...
  /**
   *@description  Description text for Prefetch status PrefetchResponseUsed.
   */
  PrefetchResponseUsed: '',
  /**
   *@description  Description text for Prefetch status PrefetchSuccessfulButNotUsed.
   */
...
export const PrefetchReasonDescription: {[key: string]: {name: () => Platform.UIString.LocalizedString}} = {
  'PrefetchAllowed': {name: i18nLazyString(UIStrings.PrefetchAllowed)},
  ...
  PrefetchResponseUsed: {name: i18nLazyString(UIStrings.PrefetchResponseUsed)},
  PrefetchSuccessfulButNotUsed: {name: i18nLazyString(UIStrings.PrefetchSuccessfulButNotUsed)},
