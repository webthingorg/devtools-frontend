...
const UIStrings = {
  ...
  prerenderFinalStatusMaxNumOfRunningEmbedderPrerendersExceeded:
      'The prerender driven by chrome was not performed because the initiating page already has too many prerenders ongoing.',
  /**
  ...
  prerenderFinalStatusMaxNumOfRunningNonEagerPrerendersExceeded:
      'The old non-eager prerender (with a "moderate" or "conservative" eagerness and triggered by hovering or clicking links) was automatically canceled due to accept another new non-eager prerender. It can be re-triggered by interacting with the link again.',
  /**
