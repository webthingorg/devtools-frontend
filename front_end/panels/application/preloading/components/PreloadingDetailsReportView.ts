...
class PreloadingUIUtils {
  ...
  static detailedStatus(x: SDK.PreloadingModel.PreloadingAttempt): string {
    // See content/public/browser/preloading.h PreloadingAttemptOutcome.
    switch (x.status) {
      case Protocol.Page.PreloadingStatus.Pending:
        return i18nString(UIStrings.detailedStatusPending);
      case Protocol.Page.PreloadingStatus.Running:
        return i18nString(UIStrings.detailedStatusRunning);
      case Protocol.Page.PreloadingStatus.Ready:
        return i18nString(UIStrings.detailedStatusReady);
      case Protocol.Page.PreloadingStatus.Success:
        return i18nString(UIStrings.detailedStatusSuccess);
      case Protocol.Page.PreloadingStatus.Failure:
      ...
      // internal error.
      case Protocol.Page.PreloadingStatus.NotSupported:
