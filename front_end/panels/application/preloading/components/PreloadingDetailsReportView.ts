    ...
    await coordinator.write('PreloadingDetailsReportView render', () => {
      ...
      LitHtml.render(LitHtml.html`
        <${ReportView.ReportView.Report.litTagName} .data=${{reportTitle: 'Prerendering Attempt'} as ReportView.ReportView.ReportData}>
          ...
          <${ReportView.ReportView.ReportKey.litTagName}>${i18n.i18n.lockedString('Started at')}</${
            ReportView.ReportView.ReportKey.litTagName}>
          <${ReportView.ReportView.ReportValue.litTagName}>
          ...
          <${ReportView.ReportView.ReportKey.litTagName}>${i18n.i18n.lockedString('Trigger')}</${
            ReportView.ReportView.ReportKey.litTagName}>
          <${ReportView.ReportView.ReportValue.litTagName}>
            <div class="text-ellipsis" title="">
              ${trigger}
          ...
          <${ReportView.ReportView.ReportKey.litTagName}>${i18n.i18n.lockedString('Status')}</${
            ReportView.ReportView.ReportKey.litTagName}>
          <${ReportView.ReportView.ReportValue.litTagName}>
            ${status}
          </${ReportView.ReportView.ReportValue.litTagName}>
