...
import preloadingDetailsReportViewStyles from './RuleSetDetailsView.css.js';
...
export class RuleSetDetailsView extends LegacyWrapper.LegacyWrapper.WrappableComponent<UI.Widget.VBox> {
  ...
  set data(data: RuleSetDetailsViewData) {
    this.#data = data;
    this.#ruleSetUrl = this.#data?.url || SDK.TargetManager.TargetManager.instance().inspectedURL();
