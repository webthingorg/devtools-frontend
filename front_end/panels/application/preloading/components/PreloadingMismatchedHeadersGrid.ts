...
//     /**
//      *@description Column header: Initial value
//      */
//     initialValue: 'initialValue',
//     /**
//      *@description Column header: Activation value
//      */
//     activationValue: 'activationValue',
// };
// const str_ =
//     i18n.i18n.registerUIStrings('panels/application/preloading/components/PreloadingMismatchedHeadersGrid.ts', UIStrings);
  ...
  #render(): void {
    ...
    const reportsGridData: DataGrid.DataGridController.DataGridControllerData = {
      columns: [
        {
          id: 'headerName',
          title: i18n.i18n.lockedString('Header name'),
          widthWeighting: 40,
          hideable: false,
          visible: true,
          sortable: true,
        ...
        {
          id: 'initialValue',
          title: i18n.i18n.lockedString('Initial value'),
          widthWeighting: 15,
          hideable: false,
          visible: true,
          sortable: true,
        ...
        {
          id: 'activationValue',
          title: i18n.i18n.lockedString('Activation value'),
          widthWeighting: 20,
          hideable: false,
          visible: true,
          sortable: true,
    ...
    return this.#data.mismatchedHeaders.map(mismatchedHeaders => ({
                                              cells: [
                                                ...
                                                },
                                                {
                                                  ...
                                                  value: mismatchedHeaders.initialValue || null,
                                                },
                                                {
                                                  columnId: 'activationValue',
                                                  value: mismatchedHeaders.activationValue || null,
                                                },
                                              ],
                                            }));
  }
