  ...
  #render(): void {
    ...
    const reportsGridData: DataGrid.DataGridController.DataGridControllerData = {
      columns: [
        ...
        {
          id: 'initialValue',
          title: i18n.i18n.lockedString('Value in initial navigation'),
          widthWeighting: 30,
          hideable: false,
          visible: true,
          sortable: true,
        ...
        {
          id: 'activationValue',
          title: i18n.i18n.lockedString('Value in activation navigation'),
          widthWeighting: 30,
          hideable: false,
          visible: true,
          sortable: true,
        ...
        mismatchedHeaders => ({
          cells: [
            ...
            },
            {
              ...
              value: mismatchedHeaders.initialValue || i18n.i18n.lockedString('<missing>'),
            },
            {
              columnId: 'activationValue',
              value: mismatchedHeaders.activationValue || i18n.i18n.lockedString('<missing>'),
            },
          ],
        }));
  }
