  ...
  #renderInternal(): LitHtml.LitTemplate {
    ...
    switch (kind) {
      ...
      case UsedKind.PreloadUsed:
        basicMessage = LitHtml.html`<div class="success-label">
        <${IconButton.Icon.Icon.litTagName}
          ...
          >
          </${IconButton.Icon.Icon.litTagName}>${i18nString(UIStrings.preloadUsed)}</div>`;
        break;
      case UsedKind.PreloadFailed:
        basicMessage = LitHtml.html`<div class="failure-label"><${IconButton.Icon.Icon.litTagName}
        .data=${{
      ...
      >
      ${i18nString(UIStrings.preloadFailed)}</div>`;
        break;
      case UsedKind.NoPreloads:
        // Disabled until https://crbug.com/1079231 is fixed.
        // clang-format off
        basicMessage = LitHtml.html`<div class="no-preload-label">
          <${IconButton.Icon.Icon.litTagName}
            .data=${
              {
                iconName: 'clear',
          ...
          ${i18nString(UIStrings.noPreloads)}</div>
        `;
        // clang-format on
        break;
    }
