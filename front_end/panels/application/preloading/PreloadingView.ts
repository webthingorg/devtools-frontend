...
export class PreloadingRuleSetView extends UI.Widget.VBox {
  ...
  constructor(model: SDK.PreloadingModel.PreloadingModel) {
    ...
    // this.contentElement.appendChild(this.hsplit);
...
export class PreloadingAttemptView extends UI.Widget.VBox {
  ...
  constructor(model: SDK.PreloadingModel.PreloadingModel) {
    ...
    LitHtml.render(
        LitHtml.html`
        <${SplitView.SplitView.SplitView.litTagName} .horizontal=${true} style="--min-sidebar-size: 0">
          <div slot="main" class="overflow-auto" style="height: 100%">
            ${this.preloadingGrid}
          </div>
          <div slot="sidebar" class="overflow-auto" style="height: 100%">
    ...
    // this.hsplit = vbox.contentElement.querySelector('devtools-split-view') as SplitView.SplitView.SplitView;
    // const hsplit = makeHsplit(this.preloadingGrid, this.preloadingDetails);
    // vbox.contentElement.appendChild(hsplit);
