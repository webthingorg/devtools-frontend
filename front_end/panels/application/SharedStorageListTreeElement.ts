...
export class SharedStorageListTreeElement extends ApplicationPanelTreeElement {
  ...
  constructor(resourcesPanel: ResourcesPanel, settingsDefault = false) {
    super(resourcesPanel, i18nString(UIStrings.sharedStorage), false);
    this.expandedSetting =
        Common.Settings.Settings.instance().createSetting('resources Shared Storage Expanded', settingsDefault);
  ...
  get itemURL(): Platform.DevToolsPath.UrlString {
    return 'category://' + i18nString(UIStrings.sharedStorage) as Platform.DevToolsPath.UrlString;
  }
