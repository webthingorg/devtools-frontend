...
export class BackgroundServiceModel extends SDK.SDKModel.SDKModel<EventTypes> implements
  ...
  readonly #backgroundServiceAgent: ProtocolProxyApi.BackgroundServiceApi;
  readonly #events: Map<Protocol.BackgroundService.ServiceName, Protocol.BackgroundService.BackgroundServiceEvent[]>;
