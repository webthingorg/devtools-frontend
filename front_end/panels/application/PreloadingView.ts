...
import {type PreloadingModel, type PreId, type PrerenderingAttempt} from './PreloadingModel.js';
  ...
  private onModelUpdated(): void {
    const convert = ([id, x]: [PreId, PrerenderingAttempt]): ApplicationComponents.PreloadingGrid.PreloadingGridRow => {
      return {
        id: id,
        // FIXME: Wrong format.
        timestamp: UI.UIUtils.formatTimestamp(x.timestamp * 1000, /* full= */ true),
