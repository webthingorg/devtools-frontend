...
const UIStrings = {
   ...
   */
  normalNavigation:
      'Not served from from Back/forward cache: to trigger back/forward cache, use Chrome\'s Back/forward button, or use the test button below to automatically navigate away and back.',
  /**
   * @description Status text for the status of the back/forward cache status indicating that
...
export class BackForwardCacheView extends UI.ThrottledWidget.ThrottledWidget {
  ...
  private renderButtonComponent(): LitHtml.TemplateResult {
