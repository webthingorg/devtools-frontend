    ...
    return LitHtml.html`
      ${pageSupportNeeded.length > 0 ?
        LitHtml.html`
          ...
          <${ReportView.ReportView.ReportValue.litTagName}>${
            pageSupportNeeded.map(explanation => LitHtml.html`<div>${explanation.reason}</div>`)
          }</${ReportView.ReportView.ReportValue.litTagName}>
        ` : LitHtml.nothing}
      ${supportPending.length > 0 ?
        LitHtml.html`
          ...
          <${ReportView.ReportView.ReportValue.litTagName}>${
            supportPending.map(explanation => LitHtml.html`<div>${explanation.reason}</div>`)
          }</${ReportView.ReportView.ReportValue.litTagName}>
        ` : LitHtml.nothing}
      ${circumstantial.length > 0 ?
        LitHtml.html`
          ...
          <${ReportView.ReportView.ReportValue.litTagName}>${
            circumstantial.map(explanation => LitHtml.html`<div>${explanation.reason}</div>`)
          }</${ReportView.ReportView.ReportValue.litTagName}>
        ` : LitHtml.nothing}
    `;
    // clang-format on
