...
const UIStrings = {
  ...
  */
  ...
  /**
  *@description Label for a button which when clicked causes the budget to be refreshed/updated.
  */
  refresh: 'Refresh',
  /**
...
export class SharedStorageMetadataView extends UI.Widget.VBox {
  ...
  constructor(sharedStorageMetadataGetter: SharedStorageMetadataGetter, owner: string) {
    ...
    this.#reportView.resetBudgetHandler = (): Promise<void> => {
      return this.#sharedStorageMetadataGetter.resetBudget();
    };
    void this.doUpdate();
  }
...
export class SharedStorageMetadataReportView extends HTMLElement {
  ...
  resetBudgetHandler: () => Promise<void> = () => {
