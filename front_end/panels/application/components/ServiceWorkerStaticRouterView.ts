...
import styles from './serviceWorkerStaticRouterView.css.js';

const {html, render} = LitHtml;

export class ServiceWorkerStaticRouterView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  static readonly litTagName = LitHtml.literal`devtools-service-worker-static-router-view`;
...
ComponentHelpers.CustomElements.defineComponent(
    'devtools-service-worker-static-router-view', ServiceWorkerStaticRouterView);
