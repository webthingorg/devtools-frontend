...
const UIStrings = {
  ...
  origin: 'Origin',
  /**
   *@description Site (https://web.dev/same-site-same-origin/#site) for the URL user sees in the omnibox.
   */
  topLevelSite: 'Top-level Site',
  /**
   *@description Text to be show in the Top-level Site row in case the value is opaque (https://html.spec.whatwg.org/#concept-origin-opaque)
   */
  opaque: '(opaque)',
  /**
   *@description Wether the storage corresponds to an opaque key (similar to https://html.spec.whatwg.org/#concept-origin-opaque)
   */
  isOpaque: 'Is Opaque',
  /**
   *@description Wether the storage corresponds to a third-party origin (https://web.dev/learn/privacy/third-parties/)
   */
  ...
  /**
   *@description Text indicating that the storage corresponds to a third-party origin because the storeage key is opaque
   */
