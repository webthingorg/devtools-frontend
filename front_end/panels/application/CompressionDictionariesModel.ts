...
export class CompressionDictionariesModel extends SDK.SDKModel.SDKModel<EventTypes> {
  ...
  deleteDictionary(_topFrameSite: string, _frameOrigin: string, _match: string, _matchDest: string): void {
    // TODO.
  }
  deleteAllDictionaries(_topFrameSite: string, _frameOrigin: string): void {
    // TODO.
  }
