...
export class CompressionDictionariesModel extends SDK.SDKModel.SDKModel<EventTypes> {
  ...
  #frameAddedToTarget(event: Common.EventTarget.EventTargetEvent<{frame: SDK.ResourceTreeModel.ResourceTreeFrame}>): void {
  ...
  #frameNavigated(event: Common.EventTarget.EventTargetEvent<{frame: SDK.ResourceTreeModel.ResourceTreeFrame}>): void {
    console.log('frameNavigated');
    this.#updateCompressionDictionariesTracking();
  }

  #outermostFrameNavigated(event: Common.EventTarget.EventTargetEvent<{frame: SDK.ResourceTreeModel.ResourceTreeFrame}>): void {
