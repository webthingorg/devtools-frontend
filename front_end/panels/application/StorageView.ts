  ...
  private clear(): void {
    ...
    if (this.target) {
      ...
      if (this.storageKey) {
        ...
        if (selectedStorageTypes.includes(Protocol.Storage.StorageType.Cookies)) {
          StorageView.clear(
              this.target, this.securityOrigin, [Protocol.Storage.StorageType.Cookies], includeThirdPartyCookies);
        }
