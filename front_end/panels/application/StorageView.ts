...
export class StorageView extends UI.ThrottledWidget.ThrottledWidget {
  #pieColors: Map<Protocol.Storage.StorageType, string>;
  #reportView: UI.ReportView.ReportView;
  #target: SDK.Target.Target|null;
  #securityOrigin: string|null;
  #settings: Map<Protocol.Storage.StorageType, Common.Settings.Setting<boolean>>;
  #includeThirdPartyCookiesSetting: Common.Settings.Setting<boolean>;
  #quotaRow: HTMLElement;
  #quotaUsage: number|null;
  #pieChart: PerfUI.PieChart.PieChart;
  #previousOverrideFieldValue: string;
  #quotaOverrideCheckbox: UI.UIUtils.CheckboxLabel;
  #quotaOverrideControlRow: HTMLElement;
  #quotaOverrideEditor: HTMLInputElement;
  #quotaOverrideErrorMessage: HTMLElement;
