  ...
  private async renderManifest(
    ...
    for (const screenshot of screenshots) {
      ...
      if (screenshot.form_factor && width && height) {
        ...
        const firstFormFactorScreenshotDimensions = formFactorScreenshotDimensions.get(screenshot.form_factor);
        if (firstFormFactorScreenshotDimensions) {
          haveScreenshotsDifferentAspectRatio = haveScreenshotsDifferentAspectRatio ||
              (width * firstFormFactorScreenshotDimensions.height !==
               height * firstFormFactorScreenshotDimensions.width);
        }
      }
