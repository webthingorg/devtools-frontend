...
const UIStrings = {
  ...
  /**
   *@description Link text for more information on customizing WCO title bar in the Application panel
   */
...
export class AppManifestView extends UI.Widget.VBox implements SDK.TargetManager.Observer {
  ...
  private async renderManifest(
    ...
    if (hasWco) {
      ...
      checkmarkIcon
          .data = {iconName: 'ic_checkmark_16x16', color: 'var( --color-ic-file-image)', width: '16px', height: '16px'};
      ...
      infoIcon.data = {iconName: 'ic_info_black_18dp', color: 'var(--color-link)', width: '16px', height: '16px'};
