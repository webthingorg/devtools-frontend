  ...
  private async renderManifest(
    ...
    if (appId && recommendedId) {
      ...
      appIdField.appendChild(UI.XLink.XLink.create(
          'https://developer.chrome.com/blog/pwa-manifest-id/' as Platform.DevToolsPath.UrlString, i18nString(UIStrings.learnMore), 'learn-more'));
    ...
    const documentationLink =
        UI.XLink.XLink.create('https://web.dev/maskable-icon/' as Platform.DevToolsPath.UrlString, i18nString(UIStrings.documentationOnMaskableIcons));
