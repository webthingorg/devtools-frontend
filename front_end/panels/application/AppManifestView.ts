...
const UIStrings = {
  ...
  /**
   *@description OS selection option. (Operating system names are often used internationally without translation, please translate only where necessary)
   */
  windows: 'Windows',
  /**
   *@description OS selection option (Operating system names are often used internationally without translation, please translate only where necessary)
...
export class AppManifestView extends Common.ObjectWrapper.eventMixin<EventTypes, typeof UI.Widget.VBox>(UI.Widget.VBox)
  ...
  private async appendWindowControlsToSection(
    ...
    osSelectElement.appendChild(new Option(i18nString(UIStrings.windows), SDK.OverlayModel.EmulatedOSType.WindowsOS));
    osSelectElement.appendChild(new Option(i18nString(UIStrings.mac), SDK.OverlayModel.EmulatedOSType.MacOS));
    osSelectElement.appendChild(new Option(i18nString(UIStrings.linux), SDK.OverlayModel.EmulatedOSType.LinuxOS));
