...
class ExpandablePreloadingTreeElementBase<View extends PreloadingSummaryView> extends
  ...
  constructor(
      panel: ResourcesPanel, viewConstructor: {new(model: SDK.PreloadingModel.PreloadingModel): View}, title: string) {
