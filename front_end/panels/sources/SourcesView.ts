...
const UIStrings = {
  ...
  /**
   *@description Text in Sources View of the Sources panel. The sentence ends with an action
   *@example {select folder} PH1
   */
  workspaceDropInAFolderToSyncSources: 'To sync edits to the workspace, drop a folder with your sources here or {PH1}',
  /**
   *@description Text in Sources View of the Sources panel. It is part of a sentence
   *@example {Drop a folder with your sources here or } PH1
   */
  selectFolder: '{PH1}select folder',
  /**
  ...
  private placeholderElement(): Element {
    ...
    const shortcuts = [
      ...
      {actionId: 'commandMenu.show', description: i18nString(UIStrings.runCommand)},
      {
        ...
        description: i18nString(UIStrings.workspaceDropInAFolderToSyncSources, {PH1: ''}),
        isWorkspace: true,
      },
    ];
    ...
    for (const shortcut of shortcuts) {
      ...
      if (shortcut.isWorkspace) {
        ...
        browseButton.textContent = i18nString(UIStrings.selectFolder, {PH1: ''});
