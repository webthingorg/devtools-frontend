...
let breakpointViewControllerInstance: BreakpointsSidebarController|null;
...
export class BreakpointsSidebarController implements UI.ContextFlavorListener.ContextFlavorListener {
  ...
  static instance(opts: {forceNew: boolean|null} = {forceNew: null}): BreakpointsSidebarController {
    if (!breakpointViewControllerInstance || opts.forceNew) {
      breakpointViewControllerInstance = new BreakpointsSidebarController();
    }
    return breakpointViewControllerInstance;
  }

  flavorChanged(_object: Object|null): void {
    void this.getUpdatedBreakpointViewData();
  }
