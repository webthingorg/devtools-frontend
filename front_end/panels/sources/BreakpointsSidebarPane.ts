...
import {debuggerPluginWrapper, Events} from './DebuggerPlugin.js';
...
export class BreakpointsSidebarController implements UI.ContextFlavorListener.ContextFlavorListener {
  ...
  private constructor(
    ...
    debuggerPluginWrapper.addEventListener(Events.BreakpointEditFinished, ({data: {breakpoint, edited}}) => {
      if (this.#outstandingBreakpointEdited && this.#outstandingBreakpointEdited === breakpoint && edited) {
