...
export class BreakpointsView extends LegacyWrapper.LegacyWrapper.WrappableComponent {
  ...
  #renderEditBreakpointButton(breakpointItem: BreakpointItem): LitHtml.TemplateResult {
    ...
    <button data-edit-breakpoint @click=${clickHandler} title=${title} jslog=${VisualLogging.action().track({click: true}).context('edit-breakpoint')}>
      <${IconButton.NewIcon.NewIcon.litTagName} name="edit"></${IconButton.NewIcon.NewIcon.litTagName}>
    </button>
      `;
    // clang-format on
  }
  ...
  #renderRemoveBreakpointButton(
    ...
    <button data-remove-breakpoint @click=${clickHandler} title=${tooltipText} aria-label=${tooltipText} jslog=${VisualLogging.action().track({click: true}).context('remove-breakpoint')}>
      <${IconButton.NewIcon.NewIcon.litTagName} name="bin"></${IconButton.NewIcon.NewIcon.litTagName}>
    </button>
      `;
    // clang-format on
  }
  ...
  #renderFileIcon(): LitHtml.TemplateResult {
    return LitHtml.html`
      <${IconButton.NewIcon.NewIcon.litTagName} name="file-script">
