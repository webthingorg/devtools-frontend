...
const UIStrings = {
  ...
  */
  ...
  /**
   *@description Context menu item in the JavaScript Breakpoints Sidebar Pane of the Sources panel that disables all breakpoints in a file.
   */
  disableAllBreakpointsInFile: 'Disable all breakpoints in file',
  /**
   *@description Context menu item in the JavaScript Breakpoints Sidebar Pane of the Sources panel that enables all breakpoints in a file.
   */
