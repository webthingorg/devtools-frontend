...
import breakpointListViewStyles from './breakpointListView.css.js';
...
const str_ = i18n.i18n.registerUIStrings('panels/sources/components/BreakpointListView.ts', UIStrings);
const i18nString = i18n.i18n.getLocalizedString.bind(undefined, str_);

const MAX_SNIPPET_LENGTH = 200;

export interface BreakpointListViewData {
...
export class BreakpointListView extends HTMLElement {
  ...
  set data(data: BreakpointListViewData) {
    this.#breakpointGroups = data.groups;
    void ComponentHelpers.ScheduledRender.scheduleRender(this, this.#boundRender);
  }

  connectedCallback(): void {
    this.#shadow.adoptedStyleSheets = [breakpointListViewStyles];
    void ComponentHelpers.ScheduledRender.scheduleRender(this, this.#boundRender);
  }
  ...
  #renderBreakpointEntry(breakpointItem: BreakpointItem): LitHtml.TemplateResult {
    ...
    // clang-format off
    return LitHtml.html`
    <div class=${LitHtml.Directives.classMap(classMap)} aria-desciption=${breakpointItemDescription}  tabIndex=${breakpointItem.isHit ? 0 : 1}>
...
ComponentHelpers.CustomElements.defineComponent('devtools-breakpoint-view', BreakpointListView);

declare global {
  interface HTMLElementTagNameMap {
    'devtools-breakpoint-view': BreakpointListView;
  }
}
