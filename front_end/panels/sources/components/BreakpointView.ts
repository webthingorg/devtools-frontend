...
const str_ = i18n.i18n.registerUIStrings('panels/sources/components/BreakpointView.ts', UIStrings);
...
export class BreakpointView extends HTMLElement {
  ...
  #getBreakpointItemDescription(breakpointItem: BreakpointItem): Platform.UIString.LocalizedString {
    ...
    return i18nString(UIStrings.sBreakpointHit, {PH1: checkboxDescription});
  }
