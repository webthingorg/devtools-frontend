...
export class BreakpointEditDialog extends UI.Widget.Widget {
  ...
  static async create(
    ...
    return new BreakpointEditDialog(editorLineNumber, oldCondition, preferLogpoint, onFinish, TextEditor, CodeMirror);
  }
  ...
  constructor(
    ...
    this.editor = new modTextEditor.TextEditor.TextEditor(modCodeMirror.EditorState.create({
      ...
      extensions: [
        ...
        modTextEditor.Config.baseConfiguration(content),
        modCodeMirror.EditorView.lineWrapping,
        modCodeMirror.javascriptLanguage,
        modTextEditor.JavaScript.completion,
      ],
    }));
