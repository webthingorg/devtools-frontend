...
const UIStrings = {
  ...
  */
  ...
  simulateASlowerPageLoadBasedOn:
      'Simulated throttling will simulate a slower page load, based on data from an initial unthrottled load. DevTools throttling will actually slow down the page.',
  /**
