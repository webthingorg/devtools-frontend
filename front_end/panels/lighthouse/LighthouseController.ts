...
const UIStrings = {
  ...
  */
   ...
   */
  timespanTooltip: 'Timespan reports analyze an arbitrary period of time, typically containing user interactions.',
  /**
   ...
   */
  snapshotTooltip: 'Snapshot reports analyze the page in a particular state, typically after user interactions.',
  /**
