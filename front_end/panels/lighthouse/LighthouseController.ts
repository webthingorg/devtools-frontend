...
const UIStrings = {
  ...
  /**
   * @description Text of checkbox to enable JavaScript sampling prior to running audits in Lighthouse
   */
  enableSampling: 'Enable JS Sampling',
  /**
   * @description Tooltip text of checkbox to enable JavaScript sampling prior to running audits in
   * Lighthouse. Resetting the storage clears/empties it to a neutral state.
   */
  enableJavaScriptSampling:
      'Enable JavaScript sampling during the Lighthouse run. This will provide more runtime details in the performance panel when you view the trace, but has higher overhead an may impact the performance of the page.',
  /**
