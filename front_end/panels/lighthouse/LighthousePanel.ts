...
export class LighthousePanel extends UI.Panel.Panel {
  ...
  private constructor() {
    ...
    this.controller.addEventListener(Events.RequestLighthouseEnd, this.onLighthouseEnd.bind(this));
    this.controller.addEventListener(Events.RequestLighthouseRun, this.onLighthouseRun.bind(this));
  ...
  private async onLighthouseEnd(): Promise<void> {
    this.timespanView?.hide();
    await this.endLighthouse();
  }

  private async onLighthouseRun(): Promise<void> {
    await this.startLighthouse();
    await this.endLighthouse();
  }
  ...
  private async startLighthouse(): Promise<void> {
    ...
    try {
      ...
      await this.protocolService.startLighthouse(this.currentLighthouseRun);
  ...
  private async endLighthouse(): Promise<void> {
    try {
      ...
      const lighthouseResponse = await this.protocolService.endLighthouse(this.currentLighthouseRun);
