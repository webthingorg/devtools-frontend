...
export class EntriesFilter {
   ...
   */
  findPossibleActions(entry: TraceEngine.Types.TraceEvents.SyntheticTraceEntry): TraceEngine.Types.TraceEvents.PossibleFilterActions {
    const entryNode = this.#entryToNode.get(entry);
    if (!entryNode) {
      // Invalid node was given, return no possible actions.
      return {
        [TraceEngine.Types.TraceEvents.FilterAction.MERGE_FUNCTION]: false,
        [TraceEngine.Types.TraceEvents.FilterAction.COLLAPSE_FUNCTION]: false,
        [TraceEngine.Types.TraceEvents.FilterAction.COLLAPSE_REPEATING_DESCENDANTS]: false,
        [TraceEngine.Types.TraceEvents.FilterAction.RESET_CHILDREN]: false,
        [TraceEngine.Types.TraceEvents.FilterAction.UNDO_ALL_ACTIONS]: false,
      };
    }
    ...
    const possibleActions: TraceEngine.Types.TraceEvents.PossibleFilterActions = {
      [TraceEngine.Types.TraceEvents.FilterAction.MERGE_FUNCTION]: entryParent !== null,
      [TraceEngine.Types.TraceEvents.FilterAction.COLLAPSE_FUNCTION]: allVisibleDescendants.length > 0,
      [TraceEngine.Types.TraceEvents.FilterAction.COLLAPSE_REPEATING_DESCENDANTS]: allVisibleRepeatingDescendants.length > 0,
      [TraceEngine.Types.TraceEvents.FilterAction.RESET_CHILDREN]: allInVisibleDescendants.length > 0,
      [TraceEngine.Types.TraceEvents.FilterAction.UNDO_ALL_ACTIONS]: this.#invisibleEntries.length > 0,
    };
   ...
   */
  applyFilterAction(action: TraceEngine.Types.TraceEvents.UserFilterAction): TraceEngine.Types.TraceEvents.TraceEventData[] {
    ...
    switch (action.type) {
      case TraceEngine.Types.TraceEvents.FilterAction.MERGE_FUNCTION: {
      ...
      case TraceEngine.Types.TraceEvents.FilterAction.COLLAPSE_FUNCTION: {
      ...
      case TraceEngine.Types.TraceEvents.FilterAction.COLLAPSE_REPEATING_DESCENDANTS: {
        const entryNode = this.#entryToNode.get(action.entry);
        if (!entryNode) {
          // Invalid node was given, just ignore and move on.
          break;
      ...
      case TraceEngine.Types.TraceEvents.FilterAction.UNDO_ALL_ACTIONS: {
        this.#invisibleEntries = [];
        this.#expandableEntries = [];
        break;
      }
      case TraceEngine.Types.TraceEvents.FilterAction.RESET_CHILDREN: {
