...
Common.ObjectWrapper.eventMixin<PerfUI.TimelineOverviewPane.EventTypes, typeof UI.Widget.VBox>(UI.Widget.VBox) {
  ...
  #timelineEventOverviewCPUActivity: TimelineEventOverviewCPUActivity | null = null;
  #timelineEventOverviewResponsiveness: TimelineEventOverviewResponsiveness | null = null;
  ...
  addBreadcrumb(start: number, end: number): void {
    ...
    if (this.#initialWindowEnd === undefined || this.#initialWindowStart === undefined) {
      ...
      this.#timelineEventOverviewCPUActivity?.setMaxMinTS(start, end);
      this.#timelineEventOverviewResponsiveness?.setMaxMinTS(start, end);
  ...
  setData(data: OverviewData): void {
    ...
    if (data.traceParsedData) {
      this.#timelineEventOverviewResponsiveness = new TimelineEventOverviewResponsiveness(data.traceParsedData);
      this.#setMarkers(data.traceParsedData);
      this.#setNavigationStartEvents(data.traceParsedData);
      this.#controls.push(this.#timelineEventOverviewResponsiveness);
    }
    ...
    if (data.performanceModel) {
      this.#timelineEventOverviewCPUActivity = new TimelineEventOverviewCPUActivity(data.performanceModel);
      this.#controls.push(this.#timelineEventOverviewCPUActivity);
    }
