...
export class TimelineMiniMap extends
   ...
   */
  #activateBreadcrumb(breadcrumb: TraceEngine.Types.File.Breadcrumb, options: {
    ...
    this.breadcrumbs.setActiveBreadcrumb(breadcrumb, options.removeChildBreadcrumbs, options.updateVisibleWindow);
