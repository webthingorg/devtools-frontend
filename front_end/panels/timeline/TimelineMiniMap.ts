...
export class TimelineMiniMap extends
  ...
  #activateBreadcrumbs(): void {
    ...
    this.#breadcrumbsUI.addEventListener(TimelineComponents.BreadcrumbsUI.BreadcrumbActivatedEvent.eventName, event => {
      const breadcrumb = (event as TimelineComponents.BreadcrumbsUI.BreadcrumbActivatedEvent).breadcrumb;
      const removeChildBreadcrumbs =
          (event as TimelineComponents.BreadcrumbsUI.BreadcrumbActivatedEvent).childBreadcrumbsRemoved;
      this.#activateBreadcrumb(breadcrumb, removeChildBreadcrumbs);
    });
