...
export class ThreadAppender implements TrackAppender {
  ...
  #addDecorations(): void {
    for (const entry of this.#entries) {
      ...
      addDecorationToEvent(this.#flameChartData, index, {
        type: 'CANDY',
        startAtTime: TraceEngine.Helpers.Timing.millisecondsToMicroseconds(
  ...
  #buildWarningElement(
      ...
      warning: TraceEngine.Handlers.ModelHandlers.Warnings.Warning): Element|null {
    const duration =
