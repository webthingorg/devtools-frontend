...
export class ModificationsManager extends EventTarget {
  ...
  #annotationToOverlay: Map<TimelineOverlay, TraceEngine.Types.File.Annotation>;
  ...
  addAnnotationOverlay(newOverlayAnnotation: TraceEngine.Types.File.Annotation): void {
    const newOverlay = {
      type: 'ENTRY_LABEL',
