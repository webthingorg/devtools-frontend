 ...
 * @param visualLoggingName the text that will be set as the logging context
...
export function buildTrackHeader(
    visualLoggingName: VisualLoggingTrackName|null, startLevel: number, name: string,
  ...
  if (visualLoggingName !== null) {
    group.jsLogContext = visualLoggingName;
  }
  return group;
}
