...
export class EventCategoryStyle {
  ...
  constructor(name: EventCategory, titleCallback: () => string, visible: boolean, childColor: string, color: string) {
    this.name = name;
...
export const DEFAULT_CATEGORY_STYLES_PALETTE: StylePalette = {
  Loading: new EventCategoryStyle(
      'Loading', i18nLazyString(UIStrings.loading), true, 'hsl(214, 67%, 74%)', 'hsl(214, 67%, 66%)'),
  Experience: new EventCategoryStyle(
      'Experience', i18nLazyString(UIStrings.experience), false, 'hsl(5, 80%, 74%)', 'hsl(5, 80%, 66%)'),
  Scripting: new EventCategoryStyle(
      'Scripting', i18nLazyString(UIStrings.scripting), true, 'hsl(43, 83%, 72%)', 'hsl(43, 83%, 64%) '),
  Rendering: new EventCategoryStyle(
      'Rendering', i18nLazyString(UIStrings.rendering), true, 'hsl(256, 67%, 76%)', 'hsl(256, 67%, 70%)'),
  Painting: new EventCategoryStyle(
      'Painting', i18nLazyString(UIStrings.painting), true, 'hsl(109, 33%, 64%)', 'hsl(109, 33%, 55%)'),
  GPU: new EventCategoryStyle('GPU', i18nLazyString(UIStrings.gpu), false, 'hsl(109, 33%, 64%)', 'hsl(109, 33%, 55%)'),
  Async:
      new EventCategoryStyle('Async', i18nLazyString(UIStrings.async), false, 'hsl(0, 100%, 50%)', 'hsl(0, 100%, 40%)'),
  Other: new EventCategoryStyle('Other', i18nLazyString(UIStrings.system), false, 'hsl(0, 0%, 87%)', 'hsl(0, 0%, 79%)'),
  Idle: new EventCategoryStyle('Idle', i18nLazyString(UIStrings.idle), false, 'hsl(0, 0%, 98%)', 'hsl(0, 0%, 98%)'),
};
