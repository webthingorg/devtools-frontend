...
export function stringIsEventCategory(it: string): it is EventCategory {
  return (eventCategories as readonly string[]).includes(it);
}
...
export function getCategoryStyles(): CategoryPalette {
  ...
  categoryStyles = {
    ...
    layout: new TimelineCategory(
        'layout', i18nString(UIStrings.layout), false, '--app-color-loading-children', '--app-color-loading'),
    rasterizing: new TimelineCategory(
        'rasterizing', i18nString(UIStrings.rasterizing), false, '--app-color-children', '--app-color-scripting'),
    drawing: new TimelineCategory(
        'drawing', i18nString(UIStrings.drawing), false, '--app-color-rendering-children', '--app-color-rendering'),
  };
  return categoryStyles;
}
...
export function getTimelineMainEventCategories(): EventCategory[] {
  ...
  mainEventCategories = ['idle', 'loading', 'painting', 'rendering', 'scripting', 'other'];
  return mainEventCategories;
}
