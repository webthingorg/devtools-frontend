...
const UIStrings = {
   ...
   *@description Text in Timeline UIUtils of the Performance panel
   */
  postMessageDispatch: 'Post Message',
  /**
   *@description Text in Timeline UIUtils of the Performance panel
   */
  postMessageHandler: 'On Message',
  /**
   *@description Text in Timeline UIUtils of the Performance panel
   */
...
function maybeInitSylesMap(): EventStylesMap {
  ...
  eventStylesMap = new Map([
    ...
    [
      TraceEngine.Types.TraceEvents.KnownEventName.PostMessageDispatch,
      new TimelineRecordStyle(i18nString(UIStrings.postMessageDispatch), defaultCategoryStyles.Messaging),
    ],
    [
      TraceEngine.Types.TraceEvents.KnownEventName.PostMessageHandler,
      new TimelineRecordStyle(i18nString(UIStrings.postMessageHandler), defaultCategoryStyles.Messaging),
    ],
    [
      TraceEngine.Types.TraceEvents.KnownEventName.PostMessageScheduleTask,
      new TimelineRecordStyle(i18nString(UIStrings.PostMessageScheduleTask), defaultCategoryStyles.Messaging),
    ],
  ]);
  return eventStylesMap;
}
