...
export class TimelineFlameChartView extends UI.Widget.VBox implements PerfUI.FlameChart.FlameChartDelegate,
   ...
   * If `overlays` is undefined, reverts back to the original overlays provided by
   * the insight.
   */
  setOverlaysOverride(overlays: Overlays.Overlays.TimelineOverlay[]|undefined): void {
    this.bulkRemoveOverlays(this.#currentInsightOverlays);
