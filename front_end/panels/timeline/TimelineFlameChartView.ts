...
export class TimelineFlameChartView extends UI.Widget.VBox implements PerfUI.FlameChart.FlameChartDelegate,
  ...
  // We use an empty object as the loggable for each group. This is because
  // groups can get re-built at times and we need a common object to act as
  // the reference for each group that we log. By storing these objects in
