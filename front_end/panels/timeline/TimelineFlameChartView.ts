...
import {type ThreadTracksSource, type TimelineModeViewDelegate} from './TimelinePanel.js';
...
export class TimelineFlameChartView extends UI.Widget.VBox implements PerfUI.FlameChart.FlameChartDelegate,
  ...
  constructor(delegate: TimelineModeViewDelegate, threadTracksSource: ThreadTracksSource) {
    super();
