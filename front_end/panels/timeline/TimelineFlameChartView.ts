...
export class TimelineFlameChartView extends UI.Widget.VBox implements PerfUI.FlameChart.FlameChartDelegate,
  ...
  constructor(delegate: TimelineModeViewDelegate) {
    ...
    this.mainFlameChart.addEventListener(PerfUI.FlameChart.Events.CheckActionsAvailability, event => {
      this.mainDataProvider.checkActionsAvailability(event.data.group, event.data.node, this.mainFlameChart);
    });
    ...
    this.mainFlameChart.addEventListener(PerfUI.FlameChart.Events.PossibleActionCalculated, this.onActionsCalculated, this);
  ...
  onActionsCalculated(actions: Common.EventTarget.EventTargetEvent<TraceEngine.EntriesFilter.PossibleFilterActions>): void {
    this.mainFlameChart.startMenu(actions.data);
  }
