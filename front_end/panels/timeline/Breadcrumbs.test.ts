...
describe('Timeline breadcrumbs', () => {
  it('can create breadcrumbs', () => {
    ...
    TraceBounds.BoundsManager.instance({forceNew: true}).resetWithNewBounds(initialBreadcrumb.window);
  ...
  it('can create breadcrumbs with equal start or end as the parent breadcrumb', () => {
    ...
    TraceBounds.BoundsManager.instance({forceNew: true}).resetWithNewBounds(initialTraceWindow);
  ...
  it('correctly sets the last breadrumb and trace bound window when a new initial breadcrumb is provided', () => {
    ...
    assert.deepEqual(TraceBounds.BoundsManager.instance().state()?.micro.minimapTraceBounds, breadcrumb2.window);
  ...
  it('it will not update the trace window when activating a breadcrumb if the option is set to false', () => {
    ...
    assert.deepEqual(TraceBounds.BoundsManager.instance().state()?.micro.timelineTraceWindow, breadcrumb2.window);
    ...
    assert.deepEqual(TraceBounds.BoundsManager.instance().state()?.micro.timelineTraceWindow, breadcrumb1.window);
  });
});
