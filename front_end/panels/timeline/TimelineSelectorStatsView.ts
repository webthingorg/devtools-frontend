...
export class TimelineSelectorStatsView extends UI.Widget.VBox {
  ...
  setEvent(event: TraceEngine.Legacy.CompatibleTraceEvent): boolean {
    ...
    const timings: TraceEngine.Types.TraceEvents.SelectorTiming[] = selectorStats['selector_timings'];
  ...
  setAggregatedEvent(events: TraceEngine.Types.TraceEvents.TraceEventUpdateLayoutTree[]): void {
