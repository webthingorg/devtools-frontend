...
const UIStrings = {
  ...
  rejectPercentageExplanation:
      'The percentage of non-matching elements that couldn\'t be quickly ruled out by the bloom filter. Lower is better.',
  /**
...
export class TimelineSelectorStatsView extends UI.Widget.VBox {
  ...
  setAggregatedEvents(events: TraceEngine.Types.TraceEvents.TraceEventUpdateLayoutTree[]): void {
    ...
    timings.unshift({
      ...
      [SelectorTimingsKey.Selector]: '(Total of all selectors)',
