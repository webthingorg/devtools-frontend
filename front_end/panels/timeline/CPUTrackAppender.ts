...
export class CPUTrackAppender{
  ...
  appendTrackAtLevel(trackStartLevel: number, expanded?: boolean|undefined): number {
    ...
    // console.log(this.#flameChartData)
    ...
    // // should only be cpu track
    // this.#flameChartData.entryLevels = entryLevels;
    // this.#flameChartData.entryStartTimes = entryStartTimes;
    // this.#flameChartData.entryTotalTimes = entryTotalTimes;
  ...
  #appendTrackHeaderAtLevel(currentLevel: number, expanded?: boolean): void {
    console.log('trackStartLevel should be 0', currentLevel)//should be 0
  ...
  eventsForTreeView(): TraceEngine.Types.TraceEvents.TraceEventData[] {
    ...
    function openFrameCallback(
      ...
      trackingStack.push({callFrame: node.callFrame, ts, pid: 0, children: [], tid: 0});
    }
