...
export function eventInitiatorPairsToDraw(
  ...
  pairs = pairs.map(pair => getPairVisibleParents(pair, traceEngineData, modifiedEntries, hiddenEntries));
  return pairs;
}
 ...
 */
function getPairVisibleParents(
    pair: InitiatorPair, traceEngineData: TraceEngine.Handlers.Types.TraceParseData,
    modifiedEntries: TraceEngine.Types.TraceEvents.TraceEventData[],
    hiddenEntries: TraceEngine.Types.TraceEvents.TraceEventData[]): InitiatorPair {
