...
//   private currentTree!: TraceEngine.Helpers.TreeHelpers.TraceEntryNode;
...
//   override buildTree(): TraceEngine.Helpers.TreeHelpers.TraceEntryNode {
...
//   private findNodeWithEvent(event: TraceEngine.Legacy.CompatibleTraceEvent): TraceEngine.Helpers.TreeHelpers.TraceEntryNode
//       |null {
...
//     const iterators = [...this.currentTree.children];
//     while (iterators.length) {
//       const child = iterators.shift();
//       if (child) {
//         if (child?.entry === event) {
//           return child;
//         }
...
//   override onHover(node: TraceEngine.Helpers.TreeHelpers.TraceEntryNode|null): void {
