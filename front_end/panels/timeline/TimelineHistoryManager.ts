...
const UIStrings = {
  ...
  /**
   *@description the title shown when the user is viewing the landing page which is showing live metrics that DevTools observed on the page.
   */
  landingPageTitle: 'Live metric observations view',
  /**
