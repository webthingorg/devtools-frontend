...
export class TimelineFlameChartNetworkDataProvider implements PerfUI.FlameChart.FlameChartDataProvider {
  ...
  setModel(traceEngineData: Trace.Handlers.Types.ParsedTrace|null): void {
    this.#timelineDataInternal = null;
    this.#events = [];
    this.#parsedTrace = traceEngineData;
  ...
  setEvents(traceEngineData: Trace.Handlers.Types.ParsedTrace): void {
   ...
   * new engine data.
   */
  #setTimingBoundsData(newTraceEngineData: Trace.Handlers.Types.ParsedTrace): void {
