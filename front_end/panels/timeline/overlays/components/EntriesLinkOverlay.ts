...
export class EntriesLinkOverlay extends HTMLElement {
  ...
  constructor(
    ...
    this.#onlyCreateButton = createButtonOnly;
    this.#render();
  }
  ...
  #render(): void {
    ...
    LitHtml.render(
        LitHtml.html`
          ...
          <div class="create-link-box ${this.#onlyCreateButton ? 'visible' : 'hidden'}">
