...
export class Overlays extends EventTarget {
  ...
  #positionEntryLabelOverlay(overlay: EntryLabel, element: HTMLElement): number|null {
    ...
    const entryWrapper = element?.querySelector('devtools-entry-label-overlay')
                             ?.shadowRoot?.querySelector<HTMLElement>('.label-parts-wrapper')
                             ?.querySelector<HTMLElement>('.entry-highlight-wrapper') ??
        null;
