...
export class SidebarAnnotationsTab extends HTMLElement {
  ...
  #zoomIntoAnnotation(annotation: TraceEngine.Types.File.Annotation): void {
    ...
    switch (annotation.type) {
      case 'ENTRY_LABEL': {
        const eventDuration = annotation.entry.dur ?? TraceEngine.Types.Timing.MilliSeconds(0.001);
      ...
      case 'ENTRIES_LINK': {
        ...
        const fromEventDuration = annotation.entryFrom.dur ?? TraceEngine.Types.Timing.MilliSeconds(0.001);
        const toEventDuration = annotation.entryFrom.dur ?? TraceEngine.Types.Timing.MilliSeconds(0.001);
