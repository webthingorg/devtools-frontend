    ...
    return LitHtml.html`
      <div class="annotation-tutorial-container">
        ...
        <div class="tutorial-card">
          ...
          <div class="tutorial-title">Entry Label</div>
          <div class="tutorial-description">Double click on an entry to create  an entry label</div>
        ...
        <div class="tutorial-card">
          ...
          <div class="tutorial-title">Diagram</div>
          <div class="tutorial-description">Double click on an entry to create a diagram</div>
        ...
        <div class="tutorial-card">
          ...
          <div class="tutorial-title">Time range</div>
          <div class="tutorial-description">Shift and drag on the canvas to create a time range</div>
        </div>
      </div>
    `;
  }
