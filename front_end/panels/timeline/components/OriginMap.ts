...
export class OriginMap extends HTMLElement implements UI.ListWidget.Delegate<ListItem> {
  static readonly litTagName = LitHtml.literal`devtools-origin-map`;
  ...
  constructor() {
    ...
    this.#list.markAsRoot();
    this.#list.show(this.#rootEl);
  ...
  connectedCallback(): void {
    this.#shadow.adoptedStyleSheets = [originMapStyles];
