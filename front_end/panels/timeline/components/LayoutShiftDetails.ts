...
export class LayoutShiftDetails extends HTMLElement {
  ...
  #traceInsightsData: Trace.Insights.Types.TraceInsightSets|null = null;
  ...
  setData(
      ...
      traceInsightsData: Trace.Insights.Types.TraceInsightSets|null, parsedTrace: Trace.Handlers.Types.ParsedTrace|null,
  ...
  #renderDetailsTable(
      layoutShift: Trace.Types.Events.SyntheticLayoutShift,
      traceInsightsData: Trace.Insights.Types.TraceInsightSets,
  ...
  #render(): void {
    if (!this.#layoutShift || !this.#traceInsightsData || !this.#parsedTrace) {
      return;
    }
    // clang-format off
    const output = LitHtml.html`
      <div class="layout-shift-summary-details">
        ...
        ${this.#renderDetailsTable(this.#layoutShift, this.#traceInsightsData, this.#parsedTrace)}
      </div>
    `;
    // clang-format on
