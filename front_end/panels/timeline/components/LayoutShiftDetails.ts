...
export class LayoutShiftDetails extends HTMLElement {
  ...
  setData(
      ...
      traceInsightsData: Trace.Insights.Types.TraceInsightData|null,
      traceEngineData: Trace.Handlers.Types.ParsedTrace|null, isFreshRecording: Boolean): void {
  ...
  #renderDetailsTable(
      layoutShift: Trace.Types.Events.SyntheticLayoutShift,
      traceInsightsData: Trace.Insights.Types.TraceInsightData,
      traceEngineData: Trace.Handlers.Types.ParsedTrace,
    ...
    const ts = Trace.Types.Timing.MicroSeconds(layoutShift.ts - traceEngineData.Meta.traceBounds.min);
