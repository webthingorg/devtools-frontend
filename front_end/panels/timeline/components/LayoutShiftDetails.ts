...
export class LayoutShiftDetails extends HTMLElement {
  ...
  #traceInsightsSets: Trace.Insights.Types.InsightSets|null = null;
  ...
  setData(
      layoutShift: Trace.Types.Events.SyntheticLayoutShift, traceInsightsSets: Trace.Insights.Types.InsightSets|null,
      parsedTrace: Trace.Handlers.Types.ParsedTrace|null, isFreshRecording: Boolean): void {
  ...
  #renderDetailsTable(
      ...
      traceInsightsSets: Trace.Insights.Types.InsightSets,
