...
const UIStrings = {
   ...
   */
  recThrottlingLCP:
      'Real users may experience longer page loads due to slower network conditions. Increasing network throttling will help simulate slower network conditions.',
  /**
   ...
   */
  recThrottlingINP:
      'Real users may experience longer interactions due to slower CPU speeds. Increasing CPU throttling will help simulate a slower device.',
  /**
   * @description Text block explaining viewport size can affect LCP.
   */
  recViewportLCP: 'Viewport size can influence what the LCP element is. Consider testing different viewport sizes.',
  /**
   * @description Text block explaining viewport size can affect CLS/layout shifts.
   */
  recViewportCLS: 'Viewport size can influence what layout shifts happen. Consider testing different viewport sizes.',
  /**
   * @description Text block explaining how different user journeys can have different amounts of layout shifts.
   */
  recJourneyCLS:
      'Different user journeys can create different layout shifts. Consider testing a variety of user journeys (e.g. scrolling the page).',
  /**
   * @description Text block explaining how different user journeys can contain interactions with different delays.
   */
  recJourneyINP: 'Different interactions can have different delays. Consider testing a variety of user journeys.',
  /**
