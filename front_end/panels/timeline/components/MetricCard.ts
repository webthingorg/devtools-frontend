...
const UIStrings = {
  ...
  /**
   * @description Text block explaining how a user interacts with the page can cause different amounts of layout shifts.
   */
  recJourneyCLS:
      'How a user interacts with the page can influence layout shifts. Consider testing common interactions like scrolling the page.',
  /**
   * @description Text block explaining how a user interacts with the page can cause different interaction delays.
   */
  recJourneyINP:
      'How a user interacts with the page can influence interaction delays. Consider testing common interactions.',
  /**
