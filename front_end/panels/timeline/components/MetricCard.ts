...
const UIStrings = {
  ...
  /**
   * @description Text block explaining how screen size can affect LCP. "viewport" and "screen" are synonymous in this case.
   */
  recViewportLCP: 'Screen size can influence what the LCP element is. Ensure you are testing common viewport sizes.',
  /**
   * @description Text block explaining viewport size can affect CLS/layout shifts. "viewport" and "screen" are synonymous in this case.
   */
  recViewportCLS: 'Screen size can influence what layout shifts happen. Ensure you are testing common viewport sizes.',
  /**
   * @description Text block explaining how a user interacts with the page can cause different amounts of layout shifts. "layout shifts" refer to page content moving around.
   */
  recJourneyCLS:
  ...
  /**
   * @description Text block explaining how a user interacts with the page can cause different interaction delays.
   */
  recJourneyINP:
