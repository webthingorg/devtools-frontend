...
The width of the label depends on the entry width, while the sizes of the conencting line, the shift and paddings are hardcoded.
*/
  afterOverlayUpdate(entryHeight: number, entryWidth: number): void {
    ...
    connectorLineContainer.setAttribute('height', EntryLabelOverlay.LABLE_CONNECTOR_HEIGHT.toString());
