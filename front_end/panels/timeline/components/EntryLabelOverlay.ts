...
`drawLabelAndConnector` method below draws the first 2 parts.
`drawEntryHighlightWrapper` draws the third part.
We only rerender the first 2 parts if the label changes and the third part if the size of the entry changes.
