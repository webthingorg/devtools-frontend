...
export class SidebarInsight extends HTMLElement {
  ...
  #render(): void {
    // TODO: add link <a rel="noopener" target="_blank" href="https://web.dev/articles/optimize-lcp#lcp-breakdown">Learn more about the Largest Contentful Paint Phases</a>
