...
const UIStrings = {
  ...
  /**
   * @description Label for selection box that selects which URL or origin to show field data for.
   */
  fieldDataPage: 'Field data page',
  /**
  ...
  #renderPageScopeSetting(): LitHtml.LitTemplate {
    ...
    return html`
      <${Menus.SelectMenu.SelectMenu.litTagName}
        ...
        aria-label=${i18nString(UIStrings.fieldDataPage)}
      >
