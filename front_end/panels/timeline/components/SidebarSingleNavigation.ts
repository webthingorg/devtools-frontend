...
import {DEFAULT_SIDEBAR_TAB, InsightsCategories, type SidebarTabsName} from './Sidebar.js';
...
export interface SidebarSingleNavigationData {
  ...
  insights: TraceEngine.Insights.Types.TraceInsightData<typeof TraceEngine.Handlers.ModelHandlers>|null;
  activeTab: SidebarTabsName;
