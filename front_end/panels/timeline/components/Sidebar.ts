...
export class SidebarWidget extends UI.Widget.VBox {
  ...
  setInsights(insights: Trace.Insights.Types.InsightSets|null): void {
...
class InsightsView extends UI.Widget.VBox {
  ...
  setInsights(data: Trace.Insights.Types.InsightSets|null): void {
    this.#component.insightSets = data;
  }
