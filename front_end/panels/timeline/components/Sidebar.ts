...
export class SidebarWidget extends UI.SplitWidget.SplitWidget {
  ...
  annotationsTabDataChanged(updatedOverlays: TraceEngine.Types.File.OverlayAnnotations[]): void {
    this.#sidebarUI.annotationsTabDataChanged(updatedOverlays);
  }
...
export class SidebarUI extends HTMLElement {
  ...
  annotationsTabDataChanged(updatedOverlays: TraceEngine.Types.File.OverlayAnnotations[]): void {
    this.#sidebarAnnotationsTab.rerenderContent(updatedOverlays);
  }
