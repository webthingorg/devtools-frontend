...
export class SidebarWidget extends UI.SplitWidget.SplitWidget {
  ...
  updateAnnotationsTabContent(updatedOverlays: TraceEngine.Types.File.Annotation[]): void {
    this.#sidebarUI.updateAnnotationsTabContent(updatedOverlays);
  }
...
export class SidebarUI extends HTMLElement {
  ...
  updateAnnotationsTabContent(updatedOverlays: TraceEngine.Types.File.Annotation[]): void {
    this.#sidebarAnnotationsTab.updateAnnotations(updatedOverlays);
  }
