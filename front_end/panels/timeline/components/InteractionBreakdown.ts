...
export class InteractionBreakdown extends HTMLElement {
  ...
  #render(): void {
    ...
    const inputDelay = i18n.TimeUtilities.formatMicroSecondsAsMillis(this.#entry.inputDelay);
    const mainThreadTime = i18n.TimeUtilities.formatMicroSecondsAsMillis(this.#entry.mainThreadHandling);
    const presentationDelay = i18n.TimeUtilities.formatMicroSecondsAsMillis(this.#entry.presentationDelay);
    LitHtml.render(
