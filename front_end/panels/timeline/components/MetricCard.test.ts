  ...
  describe('environment recommendations', () => {
    ...
    it('should show LCP recs', async () => {
      ...
      assert.deepStrictEqual(recs, [
        ...
        'Screen size can influence what the LCP element is. Consider testing different viewport sizes.',
    ...
    it('should show CLS recs', async () => {
      ...
      const recs = getEnvironmentRecs(view);
      assert.deepStrictEqual(recs, [
        'Screen size can influence what layout shifts happen. Consider testing different viewport sizes.',
