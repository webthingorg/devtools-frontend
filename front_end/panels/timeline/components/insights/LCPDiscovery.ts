...
export function getLCPInsightData(insights: Trace.Insights.Types.TraceInsightData|null, navigationId: string|null):
...
function getImageData(
    insights: Trace.Insights.Types.TraceInsightData|null, navigationId: string|null): LCPImageDiscoveryData|null {
