...
export function getRenderBlockingInsight(insights: Trace.Insights.Types.InsightSets|null, navigationId: string|null):
    Trace.Insights.Types.InsightResults['RenderBlocking']|null {
...
export class RenderBlockingRequests extends BaseInsight {
  ...
  override createOverlays(): Overlays.Overlays.TimelineOverlay[] {
    const renderBlockingResults = getRenderBlockingInsight(this.data.insightSets, this.data.navigationId);
