...
export const InsightName = 'slow-css-selector';

export class SlowCSSSelector extends HTMLElement {
  ...
  #slowCSSSelector: TraceEngine.Insights.Types.SlowCSSSelectorInsightResult|null = null;

  set insights(insights: TraceEngine.Insights.Types.TraceInsightData|null) {
    this.#insights = insights;
    this.#slowCSSSelector = this.getSlowCSSSelectorData(this.#insights, this.#navigationId);
  ...
  getSlowCSSSelectorData(insights: TraceEngine.Insights.Types.TraceInsightData|null, navigationId: string|null):
      TraceEngine.Insights.Types.SlowCSSSelectorInsightResult|null {
  ...
  #createSlowCSSSelectorOverlay(): Array<Overlays.Overlays.TimelineOverlay> {
    ...
    const scsInsight: Error|TraceEngine.Insights.Types.SlowCSSSelectorInsightResult =
  ...
  #sidebarClicked(): void {
    ...
    this.dispatchEvent(new SidebarInsight.InsightActivated(
        InsightName,
        this.#navigationId,
        this.#createSlowCSSSelectorOverlay.bind(this),
        ));
  }
