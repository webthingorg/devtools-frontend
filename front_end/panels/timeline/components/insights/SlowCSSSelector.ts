...
export class SlowCSSSelector extends BaseInsight {
  ...
  getSlowCSSSelectorData(insights: Trace.Insights.Types.InsightSets|null, navigationId: string|null):
  ...
  #hasDataToRender(): boolean {
    ...
    this.#slowCSSSelector = selectorStatsFeatureEnabled.get() ?
        this.getSlowCSSSelectorData(this.data.insightSets, this.data.navigationId) :
        null;
