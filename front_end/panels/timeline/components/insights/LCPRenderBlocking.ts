...
export function getRenderBlockingInsight(
    ...
    navigationId: string|null): TraceEngine.Insights.Types.RenderBlockingInsightResult|null {
  ...
  const insight: TraceEngine.Insights.Types.RenderBlockingInsightResult|Error = insightsByNavigation.RenderBlocking;
...
export class RenderBlockingRequests extends BaseInsight {
  static readonly litTagName = LitHtml.literal`devtools-performance-lcp-render-blocking-requests`;
  override insightCategory: InsightsCategories = InsightsCategories.LCP;
  override internalName: string = 'lcp-render-blocking-requests';
  ...
  #renderRenderBlocking(insightResult: TraceEngine.Insights.Types.RenderBlockingInsightResult): LitHtml.TemplateResult {
...
declare global {
  interface HTMLElementTagNameMap {
    'devtools-performance-lcp-render-blocking-requests': RenderBlockingRequests;
  }
}

customElements.define('devtools-performance-lcp-render-blocking-requests', RenderBlockingRequests);
