...
const UIStrings = {
   ...
   */
  description:
      'Consider using [the `font-display` CSS feature](https://developer.chrome.com/blog/font-display). It can ensure text is visible while webfonts load, and prevent layout shifts.',
