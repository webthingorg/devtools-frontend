...
export class LCPPhases extends BaseInsight {
  ...
  #getPhaseData(insights: Trace.Insights.Types.InsightSets|null, navigationId: string|null): PhaseData[] {
  ...
  override render(): void {
    const phaseData = this.#getPhaseData(this.data.insightSets, this.data.navigationId);
