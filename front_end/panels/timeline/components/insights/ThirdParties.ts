...
export class ThirdParties extends BaseInsight {
  ...
  #onHover(entity: TraceEngine.Insights.InsightRunners.ThirdPartyWeb.Entity): void {
                ...
                <div slot="insight-content">
                  ${LitHtml.html`<${Table.litTagName}
                    .data=${{
                      ...
                      onHoverRow: (index: number) => this.#onHover(topTransferSizeEntries[index][0]),
                      onMouseLeave: () => this.onOverlayOverride(undefined),
                    } as TableData}>
                  </${Table.litTagName}>`}
                  ${LitHtml.html`<${Table.litTagName}
                    .data=${{
                      ...
                      onHoverRow: (index: number) => this.#onHover(topMainThreadTimeEntries[index][0]),
                      onMouseLeave: () => this.onOverlayOverride(undefined),
                    } as TableData}>
                  </${Table.litTagName}>`}
                </div>
