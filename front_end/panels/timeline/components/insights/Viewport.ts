...
export function getViewportInsight(insights: Trace.Insights.Types.InsightSets|null, navigationId: string|null):
...
export class Viewport extends BaseInsight {
  ...
  override render(): void {
    const viewportInsight = getViewportInsight(this.data.insightSets, this.data.navigationId);
