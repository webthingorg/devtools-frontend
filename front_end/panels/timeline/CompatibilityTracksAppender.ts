...
export interface TrackAppender {
  /**
   * The position relative to other tracks, an appender's track should
   * be rendered on
   **/
  weight: number;
  /**
...
export type TrackAppenderData = {
  ...
  // legacy flame chart architechture of the panel. system to
  // use the new engine, the reference can be removed. Once all tracks
