    ...
    it('renders invalidations correctly', async function() {
      ...
      assert.deepEqual(rowData, [
        ...
        },
        {
          ...
          title: undefined,
          value:
              'testFuncs.changeAttributeAndDisplay @ chromedevtools.github.io/performance-stories/style-invalidations/app.js:48',
        },
        {
          title: 'Initiated by',
    ...
    it('shows information for the WebSocketCreate initiator when viewing a WebSocketSendHandshakeRequest event',
       async function() {
         ...
         const expectedRowData = [
           ...
           {title: undefined, value: 'connect @ socketsbay.com/test-websockets:314'},
