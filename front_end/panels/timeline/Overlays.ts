...
export class Overlays {
  ...
  #positionOverlay(overlay: TimelineOverlay, element: HTMLElement): void {
    switch (overlay.type) {
      ...
      case 'TIME_RANGE': {
        // TODO: calculate if time range is visible - can re-use logic for if an event is visible.
  ...
  #createElementForNewOverlay(overlay: TimelineOverlay): HTMLElement {
    ...
    if (overlay.type === 'TIME_RANGE') {
      ...
      component.canvasWidthPixels = this.#dimensions.charts.main?.widthPixels ?? 0;
