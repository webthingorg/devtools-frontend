...
import {buildStyledPropertyText, buildStyledRuleText, isFlexContainer} from './CSSRuleValidatorHelper.js';
...
const setupCSSRulesValidators = (): Map<String, CSSRuleValidator[]> => {
  const validators = [new AlignContentValidator(), new FlexItemValidator(), new FlexContainerValidator()];
