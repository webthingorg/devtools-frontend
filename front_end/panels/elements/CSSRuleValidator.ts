...
export abstract class CSSRuleValidator {
  ...
  abstract isRuleValid(
      computedStyles: Map<String, String>|null|undefined,
      parentsComputedStyles?: Map<String, String>|null|undefined): boolean;
...
export class AlignContentValidator extends CSSRuleValidator {
  ...
  isRuleValid(computedStyles: Map<String, String>|null|undefined): boolean {
...
const cssRuleValidators: CSSRuleValidator[] = [new AlignContentValidator(), new FlexItemValidator()];
const getCSSRuleValidatorsMap = (): Map<String, CSSRuleValidator[]> => {
  const validatorsMap = new Map<String, CSSRuleValidator[]>();
  for (const validator of cssRuleValidators) {
...
export const cssRuleValidatorsMap: Map<String, CSSRuleValidator[]> = getCSSRuleValidatorsMap();
