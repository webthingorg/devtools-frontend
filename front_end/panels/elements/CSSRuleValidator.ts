...
const MDN_LEARN_MORE_BASE_URL = 'https://developer.mozilla.org/en-US/docs/Web/CSS/';

const enum AuthoringHintType {
...
export class AuthoringHint {
  ...
  constructor(property: string, hintType: AuthoringHintType, hintMessage: string, possibleFixMessage: string|null, showLearnMore: boolean) {
    ...
    this.#learnMore = showLearnMore ? MDN_LEARN_MORE_BASE_URL + property : null;
  }
