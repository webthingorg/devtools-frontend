...
const UIStrings = {
  ...
  /**
    ...
    *@example {<code class="unbreakable-text"><span class="property">flex-wrap</span>: nowrap</code>} REASON_RULE_CODE
    *@example {<code class="unbreakable-text"><span class="property">align-content</span></code>} AFFECTED_RULE_CODE
    */
  ...
  /**
    ...
    *@example {<code class="unbreakable-text"><span class="property">flex-wrap</span>: nowrap</code>} REASON_RULE_CODE
    *@example {<code class="unbreakable-text"><span class="property">flex</span></code>} AFFECTED_RULE_CODE
    */
  ...
  /**
    ...
    *@example {<code class="unbreakable-text"><span class="property">display</span>: block</code>} EXISTING_PARENT_ELEMENT_RULE
    *@example {<code class="unbreakable-text"><span class="property">display</span>: flex</code>} TARGET_PARENT_ELEMENT_RULE
    */
