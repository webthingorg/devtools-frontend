...
export function resolveCSSExpressionWithVar(
  ...
  type VariableResolutionContext = {
    ...
    path: string[],
    // Whether there is a cycle resolving the variables or not.
    hasCycle: boolean,
  ...
  // TODO(ergunsh): Do not handle cycles properly for now.
  // We need to implement resolution based on here: https://www.w3.org/TR/css-variables/#cycles
  if (initialContext.hasCycle) {
    return null;
  }
