...
export class ElementsTreeExpandButton extends HTMLElement {
  ...
  #render(): void {
    // clang-format off
    // This button's textContent will be tested. It can't have any other characters like '\n'.
    LitHtml.render(LitHtml.html`<span
        class="button-content"
        @click=${this.#onButtonClick}><span class="dot"></span><span class="dot"></span><span class="dot"></span></span>`,
