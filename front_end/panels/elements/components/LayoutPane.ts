    ...
    await coordinator.write('LayoutPane render', () => {
      ...
      render(html`
        <details open>
          ...
          <div class="content-section" jslog=${VisualLogging.section().context('gridSettings')}>
          ...
          ${gridElements ?
            html`<div class="content-section" jslog=${VisualLogging.section().context('gridOverlays')}>
        ...
        ${flexContainerElements !== undefined ?
          ...
          <details open>
            ...
            ${flexContainerElements ?
              html`<div class="content-section" jslog=${VisualLogging.section().context('flexboxOverlays')}>
                <h3 class="content-section-title">
