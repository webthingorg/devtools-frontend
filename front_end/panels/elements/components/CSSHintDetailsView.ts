...
export class CSSHintDetailsView extends HTMLElement {
    static readonly litTagName = LitHtml.literal`devtools-authoring-hints`;
...
ComponentHelpers.CustomElements.defineComponent('devtools-authoring-hints', CSSHintDetailsView);

declare global {
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    interface HTMLElementTagNameMap {
      'devtools-authoring-hints': CSSHintDetailsView;
    }
}
