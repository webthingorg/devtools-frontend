...
export const decorateNodeLabel = function (node: SDK.DOMModel.DOMNode, parentElement: HTMLElement, tooltipContent?: string): void {
...
export const linkifyNodeReference = function (node: SDK.DOMModel.DOMNode | null, options: Common.Linkifier.Options | undefined = {
  tooltip: undefined,
...
export const linkifyDeferredNodeReference = function (deferredNode: SDK.DOMModel.DeferredDOMNode, options: Common.Linkifier.Options | undefined = {
  tooltip: undefined,
  preventKeyboardFocus: undefined,
}): Node {
