...
export class CSSWideKeywordMatch implements Match {
  ...
  resolveProperty(): SDK.CSSMatchedStyles.CSSVariableDeclaration|null {
    const resolvedProperty = this.matchedStyles.resolveGlobalKeyword(this.property, this.text);
    return resolvedProperty ? new SDK.CSSMatchedStyles.CSSVariableDeclaration(resolvedProperty) : null;
  }
