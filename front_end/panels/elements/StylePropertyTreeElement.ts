...
export function renderPropertyValue(
    propertyName: string, propertyValue: string, renderers: MatchRenderer<Match>[]): Node[] {
...
export class StylePropertyTreeElement extends UI.TreeOutline.TreeElement {
  ...
  private innerUpdateTitle(): void {
    ...
    this.valueElement = StylePropertyTreeElement.renderValueElement(this.name, this.value, renderers);
