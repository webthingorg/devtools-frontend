...
export class BezierRenderer extends BezierMatch {
  readonly #treeElement: StylePropertyTreeElement;
  constructor(
      treeElement: StylePropertyTreeElement, text: string,
      model: InlineEditor.CSSLinearEasingModel.CSSLinearEasingModel|UI.Geometry.CubicBezier|undefined) {
    super(text, model);
    this.#treeElement = treeElement;
  }
  ...
  static matcher(treeElement: StylePropertyTreeElement): BezierMatcher {
    return new BezierMatcher((text, propertyName) => new BezierRenderer(treeElement, text, propertyName));
  }
}
      ...
      switch (part.type) {
        ...
        case InlineEditor.CSSAnimationModel.PartType.EasingFunction:
          contentChild.appendChild(
              new BezierRenderer(
                  this, part.value,
                  InlineEditor.AnimationTimingModel.AnimationTimingModel.parse(part.value) ?? undefined)
                  .renderSwatch());
          break;
