...
export class StylePropertyTreeElement extends UI.TreeOutline.TreeElement {
  ...
  private computedStyles: Map<string, string>|null|undefined = null;
  private parentsComputedStyles: Map<string, string>|null|undefined = null;
  ...
  setComputedStyles(computedStyles: Map<string, string>|null|undefined): void {
    this.computedStyles = computedStyles;
  }

  setParentsComputedStyles(parentsComputedStyles: Map<string, string>|null|undefined): void {
  ...
  private getHintMessage(
      computedStyles: Map<string, string>|null|undefined,
      parentComputedStyles: Map<string, string>|null|undefined): string|null {
