...
export class FontEditorSectionManager {
  ...
  private readonly boundFontChanged:
      (event: Common.EventTarget.EventTargetEvent<{propertyName: string, value: string}>) => void;
  ...
  private fontChanged(event: Common.EventTarget.EventTargetEvent<{propertyName: string, value: string}>): void {
