...
export class ElementsTreeElementHighlighter {
  ...
  constructor(treeOutline: ElementsTreeOutline) {
    ...
    SDK.SDKModel.TargetManager.instance().addModelListener(SDK.OverlayModel.OverlayModel, SDK.OverlayModel.Events.HighlightNodeRequested, this._highlightNode, this);
    SDK.SDKModel.TargetManager.instance().addModelListener(SDK.OverlayModel.OverlayModel, SDK.OverlayModel.Events.InspectModeWillBeToggled, this._clearState, this);
  ...
  _highlightNodeInternal(node: SDK.DOMModel.DOMNode | null): void {
    ...
    if (this._currentHighlightedElement) {
      let currentTreeElement: ((UI.TreeOutline.TreeElement & ElementsTreeElement) | null) | ElementsTreeElement = this._currentHighlightedElement;
