...
export class ConsolePinPane extends UI.ThrottledWidget.ThrottledWidget {
  readonly #liveExpressionButton: UI.Toolbar.ToolbarButton;
  #pins: Set<ConsolePin>;
  readonly #pinsSetting: Common.Settings.Setting<string[]>;
...
export class ConsolePin {
  readonly #pinElement: Element;
  readonly #pinPreview: HTMLElement;
  #lastResult: SDK.RuntimeModel.EvaluationResult|null;
  #lastExecutionContext: SDK.RuntimeModel.ExecutionContext|null;
  #editor: UI.TextEditor.TextEditor|null;
  #committedExpression: string;
  #hovered: boolean;
  #lastNode: SDK.RemoteObject.RemoteObject|null;
  readonly #editorPromise: Promise<UI.TextEditor.TextEditor>;
  #consolePinNumber: number;
