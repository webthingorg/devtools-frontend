...
export class RecorderController extends LitElement {
  ...
  @state() accessor #currentRecordingSession: Models.RecordingSession.RecordingSession|undefined;
  @state() accessor #currentRecording: StoredRecording|undefined;
  @state() accessor #currentStep: Models.Schema.Step|undefined;
  @state() accessor #recordingError: Error|undefined;
  ...
  @state() accessor #isRecording: boolean;
  @state() accessor #isToggling: boolean;
  ...
  #replayAllowed = true;
  @state() accessor #recordingPlayer: Models.RecordingPlayer.RecordingPlayer|undefined;
  @state() accessor #lastReplayResult: Models.RecordingPlayer.ReplayResult|undefined;
  readonly #replayState: Components.RecordingView.ReplayState = {isPlaying: false, isPausedOnBreakpoint: false};

  @state() accessor #currentPage: Pages;
  @state() accessor #previousPage: Pages|undefined;
  #fileSelector?: HTMLInputElement;

  @state() accessor #sections: Models.Section.Section[]|undefined;
  @state() accessor #settings: Models.RecordingSettings.RecordingSettings|undefined;

  @state() accessor #importError: Error|undefined;

  @state() accessor #exportMenuExpanded: boolean;
  ...
  @state() accessor #extensionConverters!: Converters.Converter.Converter[];
  @state() accessor #replayExtensions!: Extensions.ExtensionManager.Extension[];

  @state() accessor #viewDescriptor: PublicExtensions.RecorderPluginManager.ViewDescriptor|undefined;
