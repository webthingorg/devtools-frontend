...
describeWithEnvironment('StepView', () => {
  ...
  describe('Step and section actions menu', () => {
    ...
    it('should dispatch "AddStep before" events on steps', async () => {
      ...
      getViewInput().handleStepAction.call(component, new Menus.Menu.MenuItemSelectedEvent('add-step-before'));
    ...
    it('should dispatch "AddStep after" events on steps', async () => {
      ...
      getViewInput().handleStepAction.call(component, new Menus.Menu.MenuItemSelectedEvent('add-step-after'));
      const event = await eventPromise;
    ...
    it('should dispatch "Remove steps" events on steps', async () => {
      ...
      getViewInput().handleStepAction.call(component, new Menus.Menu.MenuItemSelectedEvent('remove-step'));
      const event = await eventPromise;
    ...
    it('should dispatch "Add breakpoint" event on steps', async () => {
      ...
      getViewInput().handleStepAction.call(component, new Menus.Menu.MenuItemSelectedEvent('add-breakpoint'));
      const event = await eventPromise;
    ...
    it('should dispatch "Remove breakpoint" event on steps', async () => {
      ...
      getViewInput().handleStepAction.call(component, new Menus.Menu.MenuItemSelectedEvent('remove-breakpoint'));
      const event = await eventPromise;
    ...
    it('should dispatch copy step as JSON events', async () => {
      ...
      getViewInput().handleStepAction.call(component, new Menus.Menu.MenuItemSelectedEvent('copy-step-as-json'));
  ...
  describe('Breakpoint events', () => {
    it('should dispatch "Add breakpoint" event on breakpoint icon click if there is not a breakpoint on the step',
       async () => {
         ...
         getViewInput().onBreakpointClick.call(component);
         const event = await eventPromise;
