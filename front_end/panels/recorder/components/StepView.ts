  ...
  private render(): void {
    ...
    <style>
      ...
      .error {
        ...
        --override-error-text-color: #f00;
        --override-console-error-background-color: hsl(0deg 100% 97%);

        background: var(--override-console-error-background-color);
        color: var(--override-error-text-color);
      }

      .-theme-with-dark-background .error {
        --override-error-text-color: hsl(0deg 100% 75%);
        --override-console-error-background-color: hsl(0deg 100% 8%);
      }
