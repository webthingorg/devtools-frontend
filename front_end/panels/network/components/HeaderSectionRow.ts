...
export class HeaderValueChanged extends Event {
  static readonly eventName = 'headervaluechanged';
  headerValue: string;

  constructor(headerValue: string) {
    super(HeaderValueChanged.eventName, {});
...
export class HeaderSectionRow extends HTMLElement {
  ...
  #onInput(e: Event): void {
    ...
    this.dispatchEvent(new HeaderValueChanged(target.innerText));
  }
