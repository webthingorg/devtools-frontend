...
export class NetworkConfigView extends UI.Widget.VBox {
  ...
  static createUserAgentSelectAndInput(title: string): {
    ...
    const uaClientHintsBrand = addToTree('brand', i18nString(UIStrings.UABrand), ['Chrome', 'Chromium', 'Chroooomium']);
    const uaClientHintsVersion = addToTree('version', i18nString(UIStrings.UAVersion), []);
    ...
    addButtonContainer.appendChild(uaClientHintsMobileLabel);
    ...
    treeRoot.appendChild(new UI.TreeOutline.TreeElement(addButtonContainer, false));
