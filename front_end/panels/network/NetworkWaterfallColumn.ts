...
export class NetworkWaterfallColumn extends UI.Widget.VBox {
  ...
  static _buildRequestTimeRangeStyle(): Map<RequestTimeRangeNames, _LayerStyle> {
    ...
    styleMap.set(types.Connecting, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-connecting')});
    styleMap.set(types.SSL, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-ssl')});
    styleMap.set(types.DNS, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-dns')});
    styleMap.set(types.Proxy, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-proxy')});
    styleMap.set(types.Blocking, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-blocking')});
    styleMap.set(types.Push, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-push')});
    ...
    styleMap.set(types.Receiving, {
      fillStyle: themeSupportInstance.getComputedValue('--network-overview-receiving'),
      lineWidth: 2,
      borderColor: '#03A9F4',
    });
    styleMap.set(types.Waiting, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-waiting')});
    styleMap.set(
        types.ReceivingPush, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-receiving')});
    styleMap.set(
        types.ServiceWorker, {fillStyle: themeSupportInstance.getComputedValue('--network-overview-service-worker')});
    styleMap.set(
        types.ServiceWorkerPreparation,
        {fillStyle: themeSupportInstance.getComputedValue('--network-overview-service-worker')});
    styleMap.set(types.ServiceWorkerRespondWith, {
      fillStyle: themeSupportInstance.getComputedValue('--network-overview-service-worker-respond-with'),
    });
    return styleMap;
  }
