...
export class NetworkLogViewColumns {
  ...
  readonly #persistantSettings: Common.Settings.Setting<{
    [x: string]: {
      visible: boolean,
      title: string,
    },
  ...
  readonly #eventDividers: Map<string, number[]>;
  #eventDividersShown: boolean;
  #gridMode: boolean;
  #columns: Descriptor[];
  #waterfallRequestsAreStale: boolean;
  #waterfallScrollerWidthIsStale: boolean;
  readonly #popupLinkifier: Components.Linkifier.Linkifier;
  #calculatorsMap: Map<string, NetworkTimeCalculator>;
  #lastWheelTime: number;
  #dataGridInternal!: DataGrid.SortableDataGrid.SortableDataGrid<NetworkNode>;
  #splitWidget!: UI.SplitWidget.SplitWidget;
  #waterfallColumn!: NetworkWaterfallColumn;
  #activeScroller!: Element;
  #dataGridScroller!: HTMLElement;
  #waterfallScroller!: HTMLElement;
  #waterfallScrollerContent!: HTMLDivElement;
  #waterfallHeaderElement!: HTMLElement;
  #waterfallColumnSortIcon!: UI.Icon.Icon;
  #activeWaterfallSortId!: string;
  #popoverHelper?: UI.PopoverHelper.PopoverHelper;
  #hasScrollerTouchStarted?: boolean;
  #scrollerTouchStartPos?: number;
  constructor(
