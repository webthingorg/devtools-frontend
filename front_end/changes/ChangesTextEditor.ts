...
export class ChangesTextEditor extends TextEditor.CodeMirrorTextEditor.CodeMirrorTextEditor {
  ...
  updateDiffGutter(diffRows: Row[]): void {
    this.codeMirror().eachLine(
        /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */
        /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */
        /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */
        /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */
        /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */
        ...
        /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */ (
            ...
            /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */
            /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */
            /** @param {!CodeMirror.LineHandle} line */ /** @param {!CodeMirror.LineHandle} line */ line:
                CodeMirror.LineHandle): void => {
...
export class DevToolsAccessibleDiffTextArea extends TextEditor.CodeMirrorTextEditor.DevToolsAccessibleTextArea {
  reset(typing?: boolean|undefined): void {
    super.reset(typing);
