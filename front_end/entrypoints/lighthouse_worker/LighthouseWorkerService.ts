...
/**
 * LegacyLighthousePort is provided to Lighthouse as the CDP connection in legacyNavigation mode.
...
/**
 * ConnectionProxy speaks pure CDP between LH and frontend, proxying messages w/ a wrapper through notifyFrontendViaWorkerMessage
*/
...
const legacyPort = new LegacyLighthousePort();
