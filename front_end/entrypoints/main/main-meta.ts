...
const UIStrings = {
   ...
   */
  chromeThemeColors: 'Chrome theme colors',
  /**
   * @description Tooltip for the learn more link of the Chrome theme colors Setting.
   */
  matchChromeTheme: 'Match DevTools colors to your customized Chrome theme (when enabled)',
};
...
Common.Settings.registerSettingExtension({
  category: Common.Settings.SettingCategory.APPEARANCE,
  storageType: Common.Settings.SettingStorageType.SYNCED,
  title: i18nLazyString(UIStrings.chromeThemeColors),
  ...
  learnMore: {
    ...
    tooltip: i18nLazyString(UIStrings.matchChromeTheme),
  },
});
