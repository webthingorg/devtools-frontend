...
const UIStrings = {
   ...
   * @description Title of a setting under the Appearance category in Settings.
   */
  followBrowserThemeChanges: 'Follow browser theme changes',
};
...
Common.Settings.registerSettingExtension({
  category: Common.Settings.SettingCategory.APPEARANCE,
  storageType: Common.Settings.SettingStorageType.SYNCED,
  title: i18nLazyString(UIStrings.followBrowserThemeChanges),
  settingName: 'follow-browser-theme-changes',
