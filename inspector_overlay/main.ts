...
// @ts-ignore Importing CSS is handled in Rollup.
import wcoStyle from './tool_wco_overlay.css'; // eslint-disable-line rulesdir/es_modules_import
import {WCOOverlay} from './tool_wco_overlay.js';
...
const wcoOverlay = new WCOOverlay(window, wcoStyle);
