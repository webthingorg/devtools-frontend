...
type OverlayTypes = typeof overlays;
type OverlayTypeKey = keyof OverlayTypes;
let currentOverlay: OverlayTypes[OverlayTypeKey];
let platformName: string;

// Window has an additional dispatch function added, so retype as unknown first
(window as unknown as {dispatch: Function}).dispatch = (message: [a: string, b: OverlayTypeKey]) => {
