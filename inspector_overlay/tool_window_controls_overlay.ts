...
export function createDivOfIcons(icons: string[]): HTMLElement {
...
export function createHiddenToolBarRow(osType: string, location: string, icons: string[]): HTMLElement {
