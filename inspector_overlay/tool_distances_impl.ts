...
interface Style {
  [key: string]: string;
  'background-color': string, 'background-image': string, 'border-left-width': string, 'border-left-style': string,
      'border-left-color': string, 'border-right-width': string, 'border-right-style': string,
      'border-right-color': string, 'border-top-width': string, 'border-top-style': string, 'border-top-color': string,
      'border-bottom-width': string, 'border-bottom-style': string, 'border-bottom-color': string,
      'outline-width': string, 'outline-style': string;
...
interface DistanceInfo {
  style: Style, border: Quad, padding: Quad, content: Quad, boxes: number[][],
}
