...
import {buildPath, createPathForQuad, drawPathWithLineStyle, emptyBounds, fillPathWithBoxStyle, hatchFillPath, type BoxStyle, type LineStyle} from './highlight_common.js';
