...
class Plugin {
  ...
  _connect() {
    this._port = chrome.runtime.connect({name: 'CXXDWARFSymbols'});
...
chrome.experimental.devtools.languageServices.registerLanguagePluginExtension(
    new Plugin(), {language: 'WebAssembly', symbol_types: ['EmbeddedDWARF', 'ExternalDWARF']});
