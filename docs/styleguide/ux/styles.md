...
We define three sets of color token types, **reference/palette tokens**, **system
...
You can view all system tokens in their light and dark variant when running
...
(when DevTools is unfocused)
  ...
  * text: `--sys-color-on-neutral-container`
...
For colored icons, please use icon application color tokens: `--app-`. In case you need to add a new icon application color token, reference
