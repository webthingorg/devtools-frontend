...
1. Request approval to merge by adding the `Merge-Request-XX` label to the relevant crbug.
...
1. Once merge request approval is granted (see step 1), click the hamburger menu on the cherry-pick CL and select “Submit”.
1. Done.
