...
import {beforeWorker, collectCoverageFromPage, launchChrome, postFileTeardown, resetPages} from './hooks.js';
...
export const mochaHooks = {
  ...
  beforeAll: async function(this: Mocha.Suite) {
    ...
    this.timeout(0);
    await beforeWorker(Number(process.env.testServerPort));
  },
