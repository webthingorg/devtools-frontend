...
import {closeCurrentFrontendTargetPair, collectCoverageFromPage, postFileTeardown, preFileSetup, resetPagesBetweenTests} from './hooks.js';
...
export const mochaHooks = {
  ...
  afterEach: async function(this: Mocha.Suite) {
    ...
    if (!SHOULD_GATHER_COVERAGE_INFORMATION) {
      void closeCurrentFrontendTargetPair();
      return;
    }
