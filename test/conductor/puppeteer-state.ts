...
import {querySelectorShadowAll, querySelectorShadowOne, querySelectorShadowTextAll, querySelectorShadowTextOne, ariaQueryAll, ariaQueryOne} from './custom-query-handlers.js';
...
export const registerHandlers = () => {
  ...
  puppeteer.__experimental_unregisterCustomQueryHandler('aria');
  puppeteer.__experimental_registerCustomQueryHandler('aria', {
