...
(async function() {
  ...
  const request1 = SDK.NetworkRequest.create(0, 'https://foo.test/favicon.ico', page_url, 0, 0, null);
  SecurityTestRunner.dispatchRequestFinished(request1);
  const request2 = SDK.NetworkRequest.create(0, 'https://bar.test/bar.css', page_url, 0, 0, null);
  ...
  const request3 = SDK.NetworkRequest.create(0, detectedMainOrigin + '/favicon.ico', page_url, 0, 0, null);
