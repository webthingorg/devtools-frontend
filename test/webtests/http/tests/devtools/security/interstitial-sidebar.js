...
(async function() {
  ...
  const request1 = SDK.NetworkRequest.create(0, 'https://foo.test/', 'https://foo.test', 0, 0, null);
  request1.setSecurityState(Protocol.Security.SecurityState.Secure);
  SecurityTestRunner.dispatchRequestFinished(request1);

  const request2 = SDK.NetworkRequest.create(0, 'https://bar.test/foo.jpg', 'https://bar.test', 0, 0, null);
  ...
  const request3 = SDK.NetworkRequest.create(0, 'https://bar.test/foo.jpg', 'https://bar.test', 0, 0, null);
