...
describe('The Network Tab', async function() {
  ...
  it('can override userAgentMetadata', async () => {
    ...
    const getUserAgentMetaData = '(async () => { return { brands: navigator.userAgentData.brands, ' +
        'mobile: navigator.userAgentData.mobile, ...(await navigator.userAgentData.getHighEntropyValues( ' +
