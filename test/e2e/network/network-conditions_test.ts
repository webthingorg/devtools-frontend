...
describe('The Network Tab', async function() {
  ...
  it('can change accepted content encodings', async () => {
    ...
    const zstdCheckbox = await (await waitForAria('zstd', section)).toElement('input');
    ...
    await assertChecked(zstdCheckbox, true);
    ...
    await assertDisabled(zstdCheckbox, true);
    ...
    await assertDisabled(zstdCheckbox, false);
