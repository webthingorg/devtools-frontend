...
const RESULTS = [
  ...
  ...Array.from(Array(SIMPLE_PAGE_REQUEST_NUMBER), (_, i) => `image.svg?id=${i}/test/e2e/resources/network`),
];
...
describe('The Network Tab', async function() {
  // One of these tests reload panels repeatedly, which can take a longer time.
  this.timeout(20_000);
