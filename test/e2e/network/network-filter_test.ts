...
import {navigateToNetworkTab, setCacheDisabled} from '../helpers/network-helpers.js';
...
describe('The Network Tab', async function() {
  ...
  it('can filter by cache status in the log view', async () => {
    ...
    await navigateToNetworkTab('requests.html?num=10');
    await setCacheDisabled(false);
    await navigateToNetworkTab('requests.html?num=15');
