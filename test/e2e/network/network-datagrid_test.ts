...
import {navigateToNetworkTab, waitForSomeRequests} from '../helpers/network-helper.js';
...
describe('The Network Tab', async () => {
  ...
  it.skip('[crbug.com/1066813] shows Last-Modified', async () => {
    ...
    await waitForSomeRequests(3, '.last-modified-column');
