...
describe('The Network Tab', async function() {
  ...
  it('can persist requests', async () => {
    ...
    assert.strictEqual(firstPageRequestNames.length, 11, 'first assertion');
    ...
    await waitForFunction(async () => {
      ...
      return secondPageRequestNames.length === 11;
    });
    // const secondPageRequestNames = (await getAllRequestNames()).sort();
