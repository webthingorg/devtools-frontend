...
import {loadExtension, getResourcesPathWithFrontendHostname} from '../helpers/extension-helpers.js';
...
describe('The Debugger Language Plugins', async () => {
  ...
  it('can show C filenames after loading the module', async () => {
    ...
    const extension = await loadExtension(
        'TestExtension', `${getResourcesPathWithFrontendHostname()}/extensions/language_extensions.html`);
