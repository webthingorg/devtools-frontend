...
import {addBreakpointForLine, createNewSnippet, getBreakpointDecorators, getOpenSources, openSnippetsSubPane, openSourcesPanel, RESUME_BUTTON, typeIntoSourcesAndSave} from '../helpers/sources-helpers.js';
...
describe('Snippets subpane', () => {
  it('can stop on breakpoints', async () => {
    ...
    // Validate that line highlighted
    await waitFor('.cm-executionLine');
