...
describe('Expression evaluation', () => {
  ...
  it.repeat(  // eslint-disable-line rulesdir/no_repeated_tests
      100, 'evaluates a selected expression in the console', async () => {
  ...
  it.repeat(100, 'adds an expression to watches', async () => {  // eslint-disable-line rulesdir/no_repeated_tests
    console.log('a');                                            // eslint-disable-line no-console
