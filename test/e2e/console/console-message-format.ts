...
describe('The Console Tab', async () => {
  ...
  let consoleTabPageObject: ConsoleTabPageObject;
  ...
  beforeEach(async () => {
    ...
    consoleTabPageObject = new ConsoleTabPageObject(frontend);
    await headerPageObject.clickConsoleTab();
  });

  it('shows BigInts formatted', async () => {
    await resourcePageObject.navigateTo('/console/big-int.html');
  ...
  it('shows uncaught promises', async () => {
    await resourcePageObject.navigateTo('/console/uncaught-promise.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('shows structured objects', async () => {
    await resourcePageObject.navigateTo('/console/structured-objects.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('escapes and substitutes correctly', async () => {
    await resourcePageObject.navigateTo('/console/escaping.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('shows built-in objects', async () => {
    await resourcePageObject.navigateTo('/console/built-ins.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
...
error message
  ...
  it('shows primitives', async () => {
    await resourcePageObject.navigateTo('/console/primitives.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('can handle prototype fields', async () => {
    await resourcePageObject.navigateTo('/console/prototypes.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('can show DOM interactions', async () => {
    await resourcePageObject.navigateTo('/console/dom-interactions.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('can handle sourceURLs in exceptions', async () => {
    await resourcePageObject.navigateTo('/console/source-url-exceptions.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('can show stackoverflow exceptions', async () => {
    await resourcePageObject.navigateTo('/console/stack-overflow.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('can show document.write messages', async () => {
    await resourcePageObject.navigateTo('/console/document-write.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();
  ...
  it('can show verbose promise unhandledrejections', async () => {
    await resourcePageObject.navigateTo('/console/onunhandledrejection.html');
  ...
  it('raises an alert to string exception', async () => {
    await resourcePageObject.navigateTo('/console/alert-toString-exception.html');
    const messages = await consoleTabPageObject.retrieveConsoleMessages();

    assert.deepEqual(messages, ['Uncaught Exception in toString().']);
  });

  describe('shows messages from before', async () => {
    it('iframe removal', async () => {
      await resourcePageObject.navigateTo('/console/navigation/after-removal.html');
      const messages = await consoleTabPageObject.retrieveConsoleMessages();
    ...
    it('and after iframe navigation', async () => {
      await resourcePageObject.navigateTo('/console/navigation/after-navigation.html');
      const messages = await consoleTabPageObject.retrieveConsoleMessages();
