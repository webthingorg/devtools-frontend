...
import {click, getBrowserAndPages, tabForward, typeText, waitFor, waitForNone} from '../../shared/helper.js';
import {beforeEach, describe, it} from '../../shared/mocha-extensions.js';
import {CONSOLE_TAB_SELECTOR, CONSOLE_TOOLTIP_SELECTOR, focusConsolePrompt, waitForLastConsoleMessageToHaveContent} from '../helpers/console-helpers.js';
...
describe('The Console Tab', async () => {
  ...
  describe('triggers autocompletion for maps', () => {
    ...
    it('can select the first key result', async () => {
      ...
      const completionPromise = waitForNone(CONSOLE_TOOLTIP_SELECTOR);
      await tabForward();
