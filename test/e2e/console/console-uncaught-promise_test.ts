...
import {
  checkCommandStacktraceFunction,
  getLastConsoleMessages,
  navigateToConsoleTab,
  typeIntoConsoleAndWaitForResult,
} from '../helpers/console-helpers.js';

const checkCommandStacktrace = checkCommandStacktraceFunction();
...
describe('The Console Tab', async () => {
  it('is able to log uncaught promise rejections into console', async () => {
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest1',
    );
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest2',
    );
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest3',
    );
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest4',
    );
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest5',
    );
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest6',
    );
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest7',
    );
    ...
    await checkCommandStacktrace(
        ...
        'Stacktrace was not displayed correctly for promiseTest8',
    );
