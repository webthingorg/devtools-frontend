...
describe('Source Tab', async () => {
  ...
  it('hits breakpoint upon refresh', async () => {
    ...
    await testBreakpointAtPage(target, frontend, 'add.wasm', 'wasm/call-to-add-wasm.html', 5);
  ...
  it('hits two breakpoints that are set and activated seprately', async () => {
    ...
    await testBreakpointAtPage(target, frontend, 'add.wasm', 'wasm/call-to-add-wasm.html', 6);
