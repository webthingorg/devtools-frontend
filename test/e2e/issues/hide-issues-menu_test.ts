...
import {$$, assertNotNull, enableExperiment, getBrowserAndPages, goToResource, waitFor} from '../../shared/helper.js';
...
describe.only('Hide issues menu', async () => {
  ...
  it('should open a context menu upon clicking', async () => {
    ...
    assert.include(content, 'Hide this issue');
  });
