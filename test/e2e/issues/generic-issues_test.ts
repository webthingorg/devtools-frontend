...
import {assertNotNullOrUndefined, getTestServerPort, goToResource} from '../../shared/helper.js';
...
describe('Cross-origin portal post message issue', async () => {
  ...
  it('should display correct information', async () => {
    ...
    await expandIssue();
    const issueElement = await getIssueByTitle('Cross-origin portal post mesages are blocked on your site');
