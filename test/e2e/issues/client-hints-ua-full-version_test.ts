...
describe('Client Hint UA Full Version: Sec-CH-UA-Full-Version.', async () => {
  beforeEach(async () => {
    await goToResource('empty.html');
  });

  it('should report client hints ua full version deprecation issues', async () => {
