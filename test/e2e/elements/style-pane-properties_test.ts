...
import {assertContentOfSelectedElementsNode, getAriaLabelSelectorFromPropertiesSelector, getCSSPropertySwatchStyle, getDisplayedCSSPropertyNames, getDisplayedStyleRules, getSectionSubtutles, waitForElementsStyleSection, waitForStyleRule} from '../helpers/elements-helpers.js';
...
describe('The Styles pane', async () => {
  ...
  it('can display the source names for stylesheets', async () => {
    ...
    const subtitles = await getSectionSubtutles();
    assert.deepEqual(
