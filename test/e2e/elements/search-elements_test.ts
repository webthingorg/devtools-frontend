...
describe('The Elements tab', async () => {
  it('search is only performed when Enter is pressed when the setting is disabled', async () => {
  ...
  it('search is performed as the user types when the setting is enabled', async () => {
