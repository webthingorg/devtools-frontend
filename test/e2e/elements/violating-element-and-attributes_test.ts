...
import {goToResource, waitForMany, enableExperiment} from '../../shared/helper.js';
import {describe, it} from '../../shared/mocha-extensions.js';

/**
 * Skipping this test for now as it only works on non-headless chrome.
 */
describe.skip('Element has violating properties', async function() {
  beforeEach(async function() {
    await enableExperiment('violatingNodeOrAttributeIsHighlightedInStylesPanel');
