...
const loadEventListenersTestAndSelectTestButton = async (target: puppeteer.Page, frontend: puppeteer.Page) => {
...
describe('Event listeners in the elements sidebar', async () => {
  ...
  it('lists the active event listeners on the page', async () => {
    ...
    await loadEventListenersTestAndSelectTestButton(target, frontend);
