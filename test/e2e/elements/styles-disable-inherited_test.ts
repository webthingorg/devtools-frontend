...
import {goToResource, waitFor, waitForElementWithTextContent, click} from '../../shared/helper.js';
...
import {
  ...
  STYLES_PANE_SELECTOR,
} from '../helpers/elements-helpers.js';

describe('The Elements tab', async function() {
  it.only('does not break further style inspection if inherited style property was disabled', async () => {
    ...
    // await waitForNoMoreMutations(await waitFor(STYLES_PANE_SELECTOR));
    await click(`.enabled-button[aria-label="font-weight bold"]`);
