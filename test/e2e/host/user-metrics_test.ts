...
describe('User Metrics for CSS Editors in Styles Pane', () => {
  it('dispatch CssEditorOpened events', async () => {
    ...
    await frontend.evaluate(() => {
      ...
      self.Host.userMetrics.cssEditorOpened('colorPickerFontEditorEnabled');
      self.Host.userMetrics.cssEditorOpened('shadowEditorFontEditorEnabled');
      self.Host.userMetrics.cssEditorOpened('bezierEditorFontEditorEnabled');
    });
    ...
    await assertCapturedEvents([
      ...
      {
        name: 'DevTools.CssEditorOpened',
        value: 4,  // colorPickerFontEditorEnabled
      },
      {
        name: 'DevTools.CssEditorOpened',
        value: 5,  // shadowEditorFontEditorEnabled
      },
      {
        name: 'DevTools.CssEditorOpened',
        value: 6,  // bezierEditorFontEditorEnabled
      },
    ]);
  });
