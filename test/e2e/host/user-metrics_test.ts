...
import {clickSpanForDualScreen, startEmulationWithDualScreenFlag} from '../helpers/emulation-helpers.js';
...
describe('User Metrics', () => {
  ...
  it('dual screen emulation started and span button hit', async () => {
    ...
    await assertCapturedEvents([
      {
        ...
        value: 0,  // device selected
      },
      {
        name: 'DevTools.DualScreenDeviceEmulated',
        value: 1,  // span clicked
      },
    ]);
  });
