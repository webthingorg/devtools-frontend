...
describe('The Application Tab', async () => {
  ...
  describe('shows Session Storage keys and values', async () => {
    const {target} = getBrowserAndPages();
    let dataGridRowValues: object;
    ...
    step('=> storage data must be correct', async () => {
