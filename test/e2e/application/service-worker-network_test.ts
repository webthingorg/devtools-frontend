...
import {toggleConsoleDrawer} from '../helpers/quick_open-helpers.js';
...
const SERVICE_WORKER_NETWORK_SELECTOR = '[aria-label="Show network in drawer"]';
