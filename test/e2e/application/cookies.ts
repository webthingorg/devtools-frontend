...
import {doubleClickSourceTreeItem, getDataGridData, navigateToApplicationTab} from './helper';
...
describe('The Application Tab', async () => {
  ...
  it('shows cookies even when navigating to an unreachable page', async () => {
    ...
    await target.goto(`${resourcesPath}/application/unreachable.rawresponse`);
