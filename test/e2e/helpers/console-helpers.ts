...
export const CONSOLE_ANCHOR_SELECTOR = '.console-group-messages .source-code .console-message-anchor';
export const CONSOLE_MESSAGE_TEXT_AND_ANCHOR = '.console-group-messages .source-code';
export const CONSOLE_MESSAGES = '.console-message-stack-trace-wrapper';
...
export async function getCurrentConsoleMessages(
  ...
  const selector = withAnchor ? CONSOLE_MESSAGE_TEXT_AND_ANCHOR : CONSOLE_FIRST_MESSAGES_SELECTOR;
