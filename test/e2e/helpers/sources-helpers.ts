...
export const STEP_INTO_BUTTON = '[title="Step into next function call - F11 - Ctrl + ;"]';
export const STEP_OVER_BUTTON = '[title="Step over next function call - F10 - Ctrl + \'"]';
export const STEP_OUT_BUTTON = '[title="Step out of current function - Shift + F11 - Ctrl + Shift + ;"]';
