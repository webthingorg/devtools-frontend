...
import {expectVeEvents, veClick, veChange, veImpression} from './visual-logging-helpers.js';
...
//   // await waitFor('.service-worker-list');
//   await expectVeEvents([
//     veClick('Panel: resources > Pane: sidebar > Tree > TreeItem: application > TreeItem: manifest'),
//     veImpression('Pane', 'service-workers', []));
// }
...
export async function navigateToCookiesForTopDomain() {
  ...
  await expectVeEvents([
    ...
    veImpression('Pane', 'cookies', [veImpression('Section', 'empty-view', [veImpression('Link', 'learn-more')])]),
    ...
    veImpression('Pane', 'cookies-data', [
      ...
      veImpression('TableHeader', 'partition-key'),
      ...
      veImpression('TableRow', undefined, {optional: true}),
  ...
  return veImpression('Panel', 'resources', [
    veImpression('Pane', 'sidebar', [
      veImpression('Tree', undefined, [
        ...
        veImpression('TreeItem', 'storage', [
          veImpression('Expand'),
          veImpression('TreeItem', 'cache-storage', [veImpression('Expand', undefined, {optional: true})]),
          ...
          veImpression('TreeItem', 'shared-storage', [veImpression('Expand', undefined, {optional: true})]),
    ...
    veImpression('Pane', 'manifest', [
      veImpression('Section', 'empty-view', {optional: true}), // [veImpression('Link', 'learn-more')])
    ]),
  ]);
>>>>>>> ee6c421437 (Everything)
}
export function veImpressionForApplicationPanel() {
  return veImpression('Panel', 'resources', [
    veImpression('Pane', 'sidebar', [
