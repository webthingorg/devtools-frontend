...
export const assertButtonDisabled = async (spanButton: puppeteer.JSHandle<HTMLButtonElement>) => {
  await spanButton.evaluate((e: HTMLButtonElement) => {
    assert.isTrue(e.disabled);
  });
};

export const assertButtonEnabled = async (spanButton: puppeteer.JSHandle<HTMLButtonElement>) => {
  await spanButton.evaluate((e: HTMLButtonElement) => {
...
export const selectSpanButton = async () => {
...
export const clickSpanForDualScreen = async () => {
  ...
  await assertButtonEnabled(spanButton);
