...
import {getBrowserAndPages, getResourcesPath, waitFor, getFrontendHost} from '../../shared/helper.js';
...
export function getResourcesPathWithFrontendHostname() {
  return getResourcesPath(getFrontendHost());
}

export async function loadExtension(name: string, startPage?: string) {
  startPage = startPage || `${getResourcesPathWithFrontendHostname()}/extensions/empty_extension.html`;
