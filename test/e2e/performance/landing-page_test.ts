...
const ADVANCED_DETAILS_SELECTOR = '.dialog summary';
const OVERRIDE_FIELD_CHECKBOX_SELECTOR = '.dialog input[type="checkbox"]';
const OVERRIDE_FIELD_TEXT_SELECTOR = '.dialog input[type="text"]';
