...
describe('ComputedStyleProperty', () => {
  ...
  it('renders expanded vs. collapsed property correctly', () => {
    ...
    assert.exists(detailsElement, 'non-inherited property should be wrapped in a <details> element');
    assert.exists(summaryElement, 'non-inherited property should contain a <summary> element');
