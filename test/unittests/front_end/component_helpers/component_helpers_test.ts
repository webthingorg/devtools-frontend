  ...
  describe('setCSSProperty', () => {
    it('sets a property on the shadow root host element', () => {
      class TestComponent extends HTMLElement {
        ...
        constructor() {
          super();
          ComponentHelpers.SetCSSProperty.set(this.shadow, '--test-var', 'blue');
        }
      }
      ...
      const host = instance.shadow.host as HTMLElement;
      assert.strictEqual(host.style.getPropertyValue('--test-var'), 'blue');
    });
  });
});
