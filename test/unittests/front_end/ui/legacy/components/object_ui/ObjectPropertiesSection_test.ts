...
describeWithRealConnection('ObjectPropertiesSection', () => {
  async function setupTreeOutline(
      code: string, _accessorPropertiesOnly: boolean, _generatePreview: boolean, _nonIndexedPropertiesOnly?: boolean) {
    ...
    const {properties} =
        await result.object.getAllProperties(_accessorPropertiesOnly, _generatePreview, _nonIndexedPropertiesOnly);
