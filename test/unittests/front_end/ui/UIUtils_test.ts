...
describe('addReferrerToURL', () => {
  it('correctly adds referrer info to URLs', () => {
    ...
    assert.strictEqual(
        UI.UIUtils.addReferrerToURL('https://www.domain.com/route?utm_source=devtools#anchor' as Platform.DevToolsPath.UrlString),
        'https://www.domain.com/route?utm_source=devtools#anchor');
    assert.strictEqual(
        UI.UIUtils.addReferrerToURL('https://www.domain.com/route?key=value&utm_source=devtools#anchor' as Platform.DevToolsPath.UrlString),
        'https://www.domain.com/route?key=value&utm_source=devtools#anchor');
  });
});
...
describe('addReferrerToURLIfNecessary', () => {
  it('correctly adds referrer for web.dev and developers.google.com', () => {
    assert.strictEqual(
        UI.UIUtils.addReferrerToURLIfNecessary('https://web.dev/route' as Platform.DevToolsPath.UrlString), 'https://web.dev/route?utm_source=devtools');
    assert.strictEqual(
        UI.UIUtils.addReferrerToURLIfNecessary('https://developers.google.com/route#anchor' as Platform.DevToolsPath.UrlString),
        'https://developers.google.com/route?utm_source=devtools#anchor');
    assert.strictEqual(
        UI.UIUtils.addReferrerToURLIfNecessary('https://www.domain.com/web.dev/route' as Platform.DevToolsPath.UrlString),
        'https://www.domain.com/web.dev/route');
    assert.strictEqual(
        UI.UIUtils.addReferrerToURLIfNecessary('https://foo.developers.google.com/route#anchor' as Platform.DevToolsPath.UrlString),
