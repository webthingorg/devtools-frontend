...
interface VisibleTreeNodeFromDOM {
  key: string, children?: VisibleTreeNodeFromDOM[],
}
/**
...
describe('TreeOutline', () => {
  it('renders with all non-root nodes hidden by default', () => {
  ...
  describe('navigating with keyboard', () => {
    ...
    describe('pressing the END key', () => {
      it('takes the user to the last visible node if they are all expanded', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively(Number.POSITIVE_INFINITY);
      ...
      it('does not expand any closed nodes and focuses the last visible node', () => {
        const {shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
    ...
    describe('pressing the UP arrow', () => {
      it('does nothing if on the root node', () => {
        const {shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
      ...
      it('moves focus to the parent if there are no previous siblings', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively();
    ...
    describe('pressing the RIGHT arrow', () => {
      it('does nothing if it is on a node that cannot be expanded', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively(Number.POSITIVE_INFINITY);
      ...
      it('expands the node if on an expandable node that is closed and does not move focus', () => {
        const {shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
      ...
      it('moves focus into the child if pressed on an expanded node', () => {
        const {shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
    ...
    describe('pressing the LEFT arrow', () => {
      it('closes the node if the focused node is expanded', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively(Number.POSITIVE_INFINITY);
      ...
      it('moves to the parent node if the current node is not expanded or unexpandable', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively(Number.POSITIVE_INFINITY);
      ...
      it('does nothing when called on a root node', () => {
        const {shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
    ...
    describe('pressing the DOWN arrow', () => {
      it('moves down to the next sibling if the node is not expanded', () => {
        const {shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        const officeNode = getVisibleTreeNodeByText(shadowRoot, 'Offices');
      ...
      it('does not move if it is the last sibling and there are no parent siblings', () => {
        const {shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        const productsNode = getVisibleTreeNodeByText(shadowRoot, 'Products');
      ...
      it('moves down to the first child of the node if it is expanded', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively();
      ...
      it('moves to its parent\'s sibling if it is the last child', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively();
      ...
      it('is able to navigate high up the tree to the correct next parent\'s sibling', () => {
        const {component, shadowRoot} = renderTreeOutline({
          tree: basicTreeData,
        });
        component.expandRecursively(Number.POSITIVE_INFINITY);
