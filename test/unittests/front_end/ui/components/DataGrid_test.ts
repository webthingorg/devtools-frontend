...
describe('DataGrid', async () => {
  describe('rendering and hiding rows/columns', async () => {
  ...
  describe('data-grid renderers', async () => {
  ...
  describe('navigating with the keyboard', async () => {
  ...
  describe('adding new rows', async () => {
  ...
  describe('UIComponents.DataGridUtils.calculateColumnWidthPercentageFromWeighting', async () => {
  ...
  describe('#UIComponents.DataGridUtils.handleArrowKeyNavigation util', async () => {
    ...
    describe('navigating left', async () => {
    ...
    describe('navigating right', async () => {
    ...
    describe('navigating up', async () => {
      ...
      describe('when at least one column is sortable', async () => {
    ...
    describe('navigating down', async () => {
      describe('when at least one column is sortable', async () => {
        const sortableColumns = makeColumns();
        sortableColumns.forEach(col => {
          col.sortable = true;
