...
import {getHeaderCellForColumnId, getHeaderCells, getRowByIndex, getValuesOfRow, getValuesOfAllRows} from './DataGridHelpers.js';
...
describe.only('DataGrid', () => {
  describe('rendering and hiding rows/columns', () => {
    ...
    it('hides columns marked as hidden', () => {
      ...
      const rowValues = getValuesOfAllRows(component.shadowRoot, {onlyVisible: true});
