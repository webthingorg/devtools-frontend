...
describe('Dialog', () => {
  describe('positioning', () => {
    ...
    it.skip(
        '[https://crbug.com/1441801]: sets the max width and height correctly when the dialog\'s content dimensions exceed the viewport and the dialog is displayed as a modal',
        async () => {
