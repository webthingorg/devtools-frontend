...
describe('TextEditor', () => {
  describe('component', () => {
    ...
    it('sets an aria-label attribute', async () => {
      await initializeGlobalVars();
    ...
    it('can highlight whitespace', async () => {
      await initializeGlobalVars();
  ...
  describe('configuration', () => {
    ...
    it('can detect line separators', async () => {
      await initializeGlobalVars();
    ...
    it('handles dynamic reconfiguration', async () => {
      await initializeGlobalVars();
      const editor = new TextEditor.TextEditor.TextEditor(makeState(''));
      renderElementIntoDOM(editor);
