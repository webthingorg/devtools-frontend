...
const renderRequestLinkIcon = (data: RequestLinkIcon.RequestLinkIcon.Data): {
...
describe('RequestLinkIcon', () => {
  describe('with simple requests', () => {
    ...
    it('renders correctly without a request', () => {
      const {shadowRoot} = renderRequestLinkIcon({
    ...
    it('renders correctly with a request', () => {
      const {shadowRoot} = renderRequestLinkIcon({
    ...
    it('renders the request label correctly without a trailing slash', () => {
      const {shadowRoot} = renderRequestLinkIcon({
        request: mockRequest as unknown as SDK.NetworkRequest.NetworkRequest,
        displayURL: true,
      });
    ...
    it('renders the request label correctly with a trailing slash', () => {
      const {shadowRoot} = renderRequestLinkIcon({
    ...
    it('renders the request label correctly without a request', () => {
      const {shadowRoot} = renderRequestLinkIcon({
    ...
    it('the style reacts to the presence of a request', () => {
      const {shadowRoot} = renderRequestLinkIcon({
        request: mockRequest as unknown as SDK.NetworkRequest.NetworkRequest,
      });
    ...
    it('the style reacts to the absence of a request', () => {
      const {shadowRoot} = renderRequestLinkIcon({
        affectedRequest: {requestId: 'foo', url: 'https://alpha.beta/gamma'},
        requestResolver: failingRequestResolver as unknown as Logs.RequestResolver.RequestResolver,
      });
