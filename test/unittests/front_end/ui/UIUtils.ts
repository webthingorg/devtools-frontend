...
describe('addReferrerToURL', () => {
  it('correctly adds referrer info to URLs', () => {
    assert.equal(
        addReferrerToURL('https://www.domain.com/route'),
...
describe('addReferrerToURLIfNecessary', () => {
  it('correctly adds referrer for web.dev and developers.google.com', () => {
    assert.equal(
      addReferrerToURLIfNecessary('https://web.dev/route'),
    ...
    assert.equal(
      addReferrerToURLIfNecessary('https://www.domain.com/web.dev/route'),
