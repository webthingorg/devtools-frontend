...
interface MakeFrameOptions extends Partial<SDK.ResourceTreeModel.ResourceTreeFrame> {
  attributes?: {[x: string]: string};
}

const makeFrame = (overrides: MakeFrameOptions = {}): SDK.ResourceTreeModel.ResourceTreeFrame => {
