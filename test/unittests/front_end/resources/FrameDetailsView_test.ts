...
describe('FrameDetailsView', () => {
  ...
  it('renders report keys and values', async () => {
    ...
    const stackTrace =
        getElementWithinComponent(component, 'devtools-resources-stack-trace', Resources.FrameDetailsView.StackTrace);
    assertShadowRoot(stackTrace.shadowRoot);
    const expandableList =
        getElementWithinComponent(stackTrace, 'devtools-expandable-list', Resources.FrameDetailsView.ExpandableList);
