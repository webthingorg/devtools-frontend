...
export function createSection(
    ...
    matchedStyles: SDK.CSSMatchedStyles.CSSMatchedStyles, sectionName?: string, propertyNames?: string[]) {
  ...
  if (propertyNames) {
    ...
    style.hasActiveProperty.callsFake(name => propertyNames.includes(name));
  } else {
...
export function createBlockAndSection(
  ...
  block.sections = [createSection(stylesSidebarPane, matchedStyles, sectionName, propertyNames)];
