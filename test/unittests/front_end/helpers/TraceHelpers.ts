...
export async function loadTraceFileFromURL(
    context: Mocha.Context|Mocha.Suite|null, url: URL): Promise<TraceModel.TraceModel.TraceFileContents> {
...
export async function loadTraceFileFromFixtures(
    context: Mocha.Context|Mocha.Suite|null, name: string): Promise<TraceModel.TraceModel.TraceFileContents> {
