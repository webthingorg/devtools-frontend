...
export function prettyPrint(
    ...
    predicate:
        (node: TraceEngine.Helpers.TreeHelpers.TraceEntryNode, event: TraceEngine.Types.TraceEvents.RenderererEntry) =>
            boolean = () => true,
 ...
 */
export function makeMockRendererHandlerData(entries: TraceEngine.Types.TraceEvents.RenderererEntry[]):
