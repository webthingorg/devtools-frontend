...
import * as BreakpointManager from '../../../../front_end/models/breakpoints/breakpoints.js';
...
export function setUpEnvironment() {
  ...
  const breakpointManager = BreakpointManager.BreakpointManager.BreakpointManager.instance(
