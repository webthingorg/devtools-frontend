...
export function getComponentElement<T extends HTMLElement, V extends Element>(
...
export function getComponentElements<T extends HTMLElement, V extends Element>(
    component: T, selector: string, elementClass: Constructor<V>) {
  assertShadowRoot(component.shadowRoot);
