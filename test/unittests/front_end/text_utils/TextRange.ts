...
describe('TextRange', () => {
  it('can be instantiated successfully', () => {
    ...
    assert.equal(textRange.startColumn, startColumnTestVal, 'the start line was not set or retrieved correctly');
    assert.equal(textRange.endLine, endLineTestVal, 'the start line was not set or retrieved correctly');
    assert.equal(textRange.endColumn, endColumnTestVal, 'the start line was not set or retrieved correctly');
  });
});
