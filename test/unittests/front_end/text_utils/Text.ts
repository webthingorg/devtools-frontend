...
describe('Text', () => {
  ...
  it('should return NaN if the linenumber is out of range', () => {
    const text = new Text('\nLine 2\nLine 3\n');
    assert.isNaN(text.offsetFromPosition(10, 0));
  });

  it('should handle a linenumber of 0', () => {
    const text = new Text('\nLine 2\nLine 3\n');
    assert.equal(text.offsetFromPosition(0, 4), 4);
  });

  it('should wrap the column at the end of a line', () => {
    const text = new Text('\nLine 2\nLine 3\n');
  ...
  it('should return line 0', () => {
    const text = new Text('\nLine 2\nLine 3\n');
    assert.equal(text.lineAt(0), '');
  });
