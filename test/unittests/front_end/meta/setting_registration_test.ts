...
describe('Action registration', () => {
  before(async () => {
    Common.Settings.registerSettingExtension({
      ...
      title: () => settingTitle as Platform.UIString.LocalizedString,
      settingType: 'boolean',
      settingName,
      defaultValue: false,
      options: [
        {
          value: true,
          title: () => enableTitle as Platform.UIString.LocalizedString,
        },
        {
          value: false,
          title: () => disableTitle as Platform.UIString.LocalizedString,
        },
      ],
    });
