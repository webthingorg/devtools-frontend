...
describe('Color', () => {
  ...
  it('correctly detects and clips out-of-gamut colors', () => {
    ...
    assert.isFalse(Color.parse('color(xyz-d50 -1 1 1.5)')?.isClipped());
    assert.deepEqual(Color.parse('color(xyz-d50 -1 1 1.5)')?.asString(), 'color(xyz-d50 -1 1 1.5)');

    assert.isFalse(Color.parse('color(xyz-d65 -1 1 1.5)')?.isClipped());
    assert.deepEqual(Color.parse('color(xyz-d65 -1 1 1.5)')?.asString(), 'color(xyz-d65 -1 1 1.5)');

    assert.isFalse(Color.parse('color(xyz -1 1 1.5)')?.isClipped());
    ...
    assert.isFalse(Color.parse('color(srgb-linear 1.0001 1.0001 1.0001)')?.isClipped());
    assert.isFalse(Color.parse('color(srgb 1.0001 1.0001 1.0001)')?.isClipped());
    assert.isFalse(Color.parse('color(display-p3 1.0001 1.0001 1.0001)')?.isClipped());
    assert.isFalse(Color.parse('color(a98-rgb 1.0001 1.0001 1.0001)')?.isClipped());
    assert.isFalse(Color.parse('color(prophoto-rgb 1.0001 1.0001 1.0001)')?.isClipped());
    assert.isFalse(Color.parse('color(rec2020 1.0001 1.0001 1.0001)')?.isClipped());
  });
