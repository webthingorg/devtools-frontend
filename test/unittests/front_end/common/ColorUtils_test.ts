...
it('is able to find APCA threshold by font size and weight', () => {
  ...
  assert.deepEqual(Common.ColorUtils.getAPCAThreshold('97px', '100'), 80);
  assert.deepEqual(Common.ColorUtils.getAPCAThreshold('16px', '100'), null);
  assert.deepEqual(Common.ColorUtils.getAPCAThreshold('16px', '400'), 80);
  assert.deepEqual(Common.ColorUtils.getAPCAThreshold('16px', '900'), 60);
});
