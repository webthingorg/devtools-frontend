...
describe('Color', () => {
  ...
  it('defaults RGBA value to 0 if it was negative', () => {
    const color = new Color([-0.5, 0.5, 0.5, 0.5], 'testFormat', 'testColor');
  ...
  it('defaults RGBA value to 1 if it was above one', () => {
  ...
  it('returns null as a nickname if it did not recognize the color', () => {
    const color = new Color([0.5, 0.5, 0.5, 0.5], 'testFormat', 'testColor');
    const result = color.nickname();
  ...
  it('returns a color in a different format than the one it was set with', () => {
    const color = new Color([1, 0, 0, 1], 'rgb', 'testColor');
...
describe('Generator', () => {
  it('able to return the color for an ID if it was already set', () => {
