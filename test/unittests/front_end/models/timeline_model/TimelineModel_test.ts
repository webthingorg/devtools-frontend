...
describeWithEnvironment('TimelineModel', () => {
  ...
  describe('Track.syncLikeEvents', () => {
    ...
    const nonNestableAsyncEventPayloads = [
      {
        'args': {'startTime': 1112.7000000029802},
      ...
      {
        'args': {'startTime': 1412.8000000044703},
        'cat': 'blink.user_timing',
        'id': '0xf9950a85',
        'name': 'MyOtherMark',
        'ph': 'b',
      ...
      {
        'args': {'startTime': 1712.8999999985099},
        'cat': 'blink.user_timing',
        'id': '0xfbe4a4a7',
        'name': 'Zuck',
        'ph': 'b',
    ...
    const syncEventPayloads = [
      {
        'args': {'data': {'navigationId': 'D0D0C810A6749CA263EBE7593DC7AA3A', 'startTime': 1112.7000000029802}},
        'cat': 'blink.user_timing',
        'name': 'myMark',
        'ph': 'R',
        'pid': 25436,
      ...
      {
        'args': {'data': {'navigationId': 'D0D0C810A6749CA263EBE7593DC7AA3A', 'startTime': 1412.8000000044703}},
        'cat': 'blink.user_timing',
        'name': 'myOtherMark',
        'ph': 'R',
        'pid': 25436,
      ...
      {
        'args': {'data': {'navigationId': 'D0D0C810A6749CA263EBE7593DC7AA3A', 'startTime': 1712.8999999985099}},
        'cat': 'blink.user_timing',
        'name': 'zuck',
        'ph': 'R',
        'pid': 25436,
