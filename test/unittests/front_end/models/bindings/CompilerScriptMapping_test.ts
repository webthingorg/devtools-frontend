...
describeWithMockConnection('CompilerScriptMapping', () => {
  ...
  async function waitForUiSourceCode(
    ...
    const compilerScriptMapping = debuggerWorkspaceBinding.getCompilerScriptMapping(script.debuggerModel);
  ...
  it('can return the uiSourceCode of a specific target for a url', async () => {
