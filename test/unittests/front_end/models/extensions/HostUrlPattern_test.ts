...
describe('HostUrlPattern', () => {
  ...
  it('Matches all domains', () => {
    ...
    assert.isFalse(pattern.matchesUrl('https://www.google.com/' as Platform.DevToolsPath.UrlString));
    assert.isTrue(pattern.matchesUrl('filesystem:https://www.google.com/foobar/' as Platform.DevToolsPath.UrlString));
  });
