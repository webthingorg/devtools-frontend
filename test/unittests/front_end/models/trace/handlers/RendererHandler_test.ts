...
........`);
  ...
  describe('walkTree', () => {
    it('walks the tree down and then back up and calls onEntryStart and onEntryEnd', async () => {
      /**
       * |------------- Task A -------------||-- Task E --|
       *  |-- Task B --||-- Task D --|
       *   |- Task C -|
      ...
      TraceModel.Handlers.ModelHandlers.Renderer.walkTree(entryToNode, rootNode.entry, onEntryStart, onEntryEnd);
