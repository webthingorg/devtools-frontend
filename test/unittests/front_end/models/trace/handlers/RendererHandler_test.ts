...
-RunTask [0.003ms]`);
    ...
    it('builds a hierarchy using complete, begin and end trace events', async () => {
      ...
      const traceEvents = [
        ...defaultTraceEvents, makeBeginEvent('RunTask', 0),  // 0..10
        makeBeginEvent('RunMicrotasks', 1),                   // 1..4
        makeCompleteEvent('FunctionCall', 2, 1),              // 2..3
        makeEndEvent('RunMicrotasks', 4),                     // 1..4
        makeBeginEvent('Layout', 5),                          // 5..8
        makeEndEvent('Layout', 8),                            // 5..8
        makeEndEvent('RunTask', 10),                          // 0..10
      ];
