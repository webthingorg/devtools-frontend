...
describe('IssuesManager', () => {
  ...
  it('hides issues present in IssuesManager when setting is updated', () => {
    ...
    // Clicking "hide issue" updates the setting and calls the updatedHiddenIssues method of IssuesManager.
    // Here we are simulating a click on "hide issue" by manually updating hideIssueByCode setting
    // and calling updateHiddenIssues.
    HideIssueByCodeSetting.set({
      'HiddenStubIssue1': IssuesManager.IssuesManager.IssueStatus.Hidden,
    });
