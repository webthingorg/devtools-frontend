...
function assertSwatch(
  ...
  const swatchEl = swatch.shadowRoot.querySelector('.color-swatch') as HTMLElement;
  const swatchInnerEl = swatch.shadowRoot.querySelector('.color-swatch-inner') as HTMLElement;
  const slotEl = swatch.shadowRoot.querySelector('slot');
  assertNotNull(swatchEl);
  assertNotNull(swatchInnerEl);
...
describe('ColorSwatch', () => {
  it('can be instantiated successfully', () => {
    ...
    assert.instanceOf(swatch, HTMLElement, 'The swatch is an instance of HTMLElement');
  });
