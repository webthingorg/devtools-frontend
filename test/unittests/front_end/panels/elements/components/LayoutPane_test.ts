...
describeWithMockConnection('LayoutPane', async () => {
  ...
  // function makeNode(localName: string,  domId: string, domClasses: string,domModel: SDK.DOMModel.DOMModel) {
  //   return {
  //     ancestorUserAgentShadowRoot:()=>false,
  //     localName: ()=>localName,
  //     getAttribute:(attr)=>this.attrs[attr],
  //     attrs: {class: domClasses, id: domId}
  //     scrollIntoView:()=>{},
  //     highlight:()=>{},
  //     domModel: ()=>domModel,
  //
