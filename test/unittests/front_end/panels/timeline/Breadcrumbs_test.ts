...
describe('Timeline breadcrumbs', () => {
  it('can create breadcrumbs', () => {
    ...
    crumbs.addNewBreadcrumb(breadcrumb1);
    crumbs.addNewBreadcrumb(breadcrumb2);

    assert.deepEqual(crumbs.getBreacrumbsTraceWindows(), [initialTraceWindow, breadcrumb1, breadcrumb2]);
  });
  ...
  it('can remove breadcrumbs', () => {
    ...
    crumbs.removeBreadcrumbChildren(breadcrumb1);
    assert.deepEqual(crumbs.getBreacrumbsTraceWindows(), [initialTraceWindow, breadcrumb1]);
  });
  ...
  it('does not create a child breadcrumb with equal to the parent TraceWindow', () => {
    ...
    assert.deepEqual(crumbs.getBreacrumbsTraceWindows(), [initialTraceWindow]);
  });
