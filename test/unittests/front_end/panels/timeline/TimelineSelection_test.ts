...
describeWithEnvironment('TimelineSelection', () => {
  it('can be created with a frame', () => {
    ...
    assert.isTrue(Timeline.TimelineSelection.TimelineSelection.isFrameSelection(selection));
  });
  ...
  it('can be created with a network request', async () => {
    ...
    assert.isTrue(Timeline.TimelineSelection.TimelineSelection.isNetworkRequestSelection(selection));
  });
  ...
  it('can be created with an SDK trace event', async () => {
    ...
    assert.isTrue(Timeline.TimelineSelection.TimelineSelection.isTraceEventSelection(selection));
  });
  ...
  it('can be created with a range', async () => {
    ...
    assert.isTrue(Timeline.TimelineSelection.TimelineSelection.isRangeSelection(selection));
  });
});
