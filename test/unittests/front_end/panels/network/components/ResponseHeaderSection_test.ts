...
function checkHeaderSectionRow(
  ...
  const nameEditableComponent = row.shadowRoot.querySelector<NetworkComponents.HeaderSectionRow.EditableSpan>(
  ...
  const valueEditableComponent = row.shadowRoot.querySelector<NetworkComponents.HeaderSectionRow.EditableSpan>(
