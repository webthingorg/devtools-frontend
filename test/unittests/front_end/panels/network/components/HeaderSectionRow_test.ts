...
async function renderHeaderSectionRow(header: NetworkComponents.HeaderSectionRow.HeaderDescriptor): Promise<{
  ...
  const nameEditableComponent = component.shadowRoot.querySelector<NetworkComponents.HeaderSectionRow.EditableSpan>(
  ...
  const valueEditableComponent = component.shadowRoot.querySelector<NetworkComponents.HeaderSectionRow.EditableSpan>(
