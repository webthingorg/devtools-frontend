...
describeWithRealConnection('FrameDetailsView', () => {
  ...
  it('renders report keys and values', async () => {
    ...
    frame.getDebuggerId = () => executionContext.uniqueId as Protocol.Runtime.UniqueDebuggerId;
    ...
    assert.deepEqual(stackTraceText, ['function1\xA0@\xA0http://www.example.com/script.js:16']);
