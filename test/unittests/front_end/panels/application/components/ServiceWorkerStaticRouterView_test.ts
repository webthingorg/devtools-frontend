...
async function renderServiceWorkerStaticRouterView():
    Promise<ApplicationComponents.ServiceWorkerStaticRouterView.ServiceWorkerStaticRouterView> {
  const component = new ApplicationComponents.ServiceWorkerStaticRouterView.ServiceWorkerStaticRouterView();
...
describeWithLocale('ServiceWorkerStaticRouterView', () => {
  ...
  it('shows nothing with empty rules', async () => {
    const component = await renderServiceWorkerStaticRouterView();
