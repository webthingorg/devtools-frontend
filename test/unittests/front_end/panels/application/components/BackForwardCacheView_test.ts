...
describeWithMockConnection('BackForwardCacheView', () => {
  const tests = (targetFactory: () => SDK.Target.Target) => {
    ...
    beforeEach(() => {
      ...
      const maybeResourceTreeModel = target.model(SDK.ResourceTreeModel.ResourceTreeModel);
      assertNotNullOrUndefined(maybeResourceTreeModel);
      resourceTreeModel = maybeResourceTreeModel;
