...
async function testWarnings(
  ...
  const headers = [...infobar.shadowRoot.querySelectorAll('#contents devtools-report-section-header')].map(
      header => header.textContent?.trim());
  const sections = [...infobar.shadowRoot.querySelectorAll('#contents devtools-report-section')].map(
