...
class SharedStorageListener {
  ...
  changeEventsForStorage(storage: Resources.SharedStorageModel.SharedStorage):
      Array<Resources.SharedStorageModel.SharedStorage.SharedStorageChangedEvent>|null {
...
describeWithMockConnection('SharedStorageModel', () => {
  ...
  it('SharedStorage is instantiated correctly', () => {
    const sharedStorage = new Resources.SharedStorageModel.SharedStorage(sharedStorageModel, testOrigin);
