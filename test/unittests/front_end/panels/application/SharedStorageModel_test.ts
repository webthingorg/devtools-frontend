...
describeWithMockConnection('SharedStorageModel', () => {
  ...
  it('is accessible via SharedStorageForOrigin', async () => {
    ...
    const setEntrySpy = sinon.spy(sharedStorageModel.storageAgent, 'invoke_setSharedStorageEntry');
    const deleteEntrySpy = sinon.spy(sharedStorageModel.storageAgent, 'invoke_deleteSharedStorageEntry');
    const clearSpy = sinon.spy(sharedStorageModel.storageAgent, 'invoke_clearSharedStorageEntries');
  ...
  it('adds/removes SharedStorageForOrigin on SecurityOrigin events', async () => {
    ...
    const getMetadataSpy = sinon.spy(sharedStorageModel.storageAgent, 'invoke_getSharedStorageMetadata');
    const setTrackingSpy = sinon.spy(sharedStorageModel.storageAgent, 'invoke_setSharedStorageTracking');
