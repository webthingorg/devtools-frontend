...
describeWithMockConnection('AppManifestView', () => {
  const tests = (targetFactory: () => SDK.Target.Target) => {
    ...
    async function renderWithWarnings(manifest: string): Promise<string[]> {
      ...
      sinon.stub(view as any, 'appendImageResourceToSection')
          .resolves({imageResourceErrors: [], squareSizedIconAvailable: true});
      view.markAsRoot();
      view.show(document.body);
        ...
        "shortcuts" : [
          {
            ...
            "icons": [{ "src": "/icons/play-later.png", "sizes": "96x96" }]
          },
          {
            "name": "New event",
            "url": "/create/event",
    ...
    it('displays warnings for too many mobile screenshots', async () => {
      const actual = await renderWithWarnings(`{
        "screenshots": [
          ...
          {
            "src": "/images/screenshots/3-360x640.png",
            "type": "image/png",
            "sizes": "1080x1920"
          },
          {
            "src": "/images/screenshots/4-360x640.png",
            "type": "image/png",
            "sizes": "360x640"
          },
          {
            "src": "/images/screenshots/5-360x640.png",
            "type": "image/png",
            "sizes": "1080x1920"
          },
          {
            "src": "/images/screenshots/6-360x640.png",
            "type": "image/png",
            "sizes": "360x640"
          }
        ]
    ...
    it('displays warnings for too many desktop screenshots', async () => {
      const actual = await renderWithWarnings(`{
        "screenshots": [
          ...
          {
            "src": "/images/screenshots/7-360x640.png",
            "type": "image/png",
            "sizes": "360x640",
            "form_factor": "wide"
          },
          {
            "src": "/images/screenshots/8-360x640.png",
            "type": "image/png",
            "sizes": "1080x1920",
            "form_factor": "wide"
          },
          {
            "src": "/images/screenshots/9-360x640.png",
            "type": "image/png",
            "sizes": "360x640",
            "form_factor": "wide"
          }
    ...
    it('displays "form-factor", "platform" and "label" properties for screenshots', async () => {
      ...
      assert.deepStrictEqual(
          getCleanTextContentFromElements(screenshotSection, '.report-field-name'),
          ['Form factor', 'Label', 'Platform']);
      assert.deepStrictEqual(
          getCleanTextContentFromElements(screenshotSection, '.report-field-value'),
