...
describe('BreakpointView', () => {
  it('renders breakpoint groups as opened only if expanded is set to true', async () => {
  ...
  it('renders the filenames as group names', async () => {
    const {component, data} = await renderBreakpointView();
    const shadowRoot = component.shadowRoot;
    assertShadowRoot(shadowRoot);
  ...
  it('renders the breakpoints with their code snippet', async () => {
    const {component, data} = await renderBreakpointView();
    const shadowRoot = component.shadowRoot;
    assertShadowRoot(shadowRoot);
