...
describeWithMockConnection('NetworkNavigatorView', () => {
  ...
  describe('removing source codes selection throttling', () => {
    ...
    it('selects just once when removing multiple sibling source codes', () => {
      ...
      // Remove a.js and b.js nodes and verify that the selection is moved from 'a.js' to 'c.js', without
      // temporarily selecting 'b.js'.
      project.removeUISourceCodes([
        'http://example.com/a.js' as Platform.DevToolsPath.UrlString,
        'http://example.com/b.js' as Platform.DevToolsPath.UrlString,
      ]);
    ...
    it('selects parent after removing all children', () => {
      ...
      // Remove the 'a.js' and 'b.js' nodes and check the selection is not propagated forward to the siblings
      // as we remove them. Instead, the selection will be moved directly to the parent.
      project.removeUISourceCodes([
        'http://example.com/a.js' as Platform.DevToolsPath.UrlString,
        'http://example.com/b.js' as Platform.DevToolsPath.UrlString,
        'http://example.com/c.js' as Platform.DevToolsPath.UrlString,
      ]);
    ...
    it('selects sibling after removing folder children', async () => {
      ...
      // Remove a.js and b.js nodes.
      project.removeUISourceCodes([
        'http://example.com/d/a.js' as Platform.DevToolsPath.UrlString,
        'http://example.com/d/b.js' as Platform.DevToolsPath.UrlString,
      ]);
    ...
    it('selects sibling after removing individual folder children', async () => {
      ...
      project.removeUISourceCodes([
        'http://example.com/d/a.js' as Platform.DevToolsPath.UrlString,
        'http://example.com/e/b.js' as Platform.DevToolsPath.UrlString,
      ]);
      ...
      // Also note that nodeD is removed. Let us make that explicit.
      assert.strictEqual(exampleComNode.childCount(), 1);
      assert.strictEqual(exampleComNode.childAt(0), nodeC);
