...
describeWithEnvironment('BreakpointsSidebarController', () => {
  ...
  describe('getUpdatedBreakpointViewData', () => {
    ...
    it('correctly extracts conditional breakpoints', async () => {
      const condition = 'x < a';
      const testData = [
        createLocationTestData(TEST_JS_FILE, 3, 15, true /* enabled */, '', condition, false, condition),
      ];
    ...
    it('correctly extracts logpoints', async () => {
      ...
      const testData = [
        createLocationTestData(TEST_JS_FILE, 3, 15, true /* enabled */, '', condition, true, logDetail),
      ];
