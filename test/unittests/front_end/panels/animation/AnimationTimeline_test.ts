...
describeWithMockConnection('AnimationTimeline', () => {
  ...
  describe('Animation group nodes are removed', () => {
    ...
    beforeEach(() => {
      ...
      let resolveAnimationGroupSelectedFn: Function;
      waitForAnimationGroupSelected = () => new Promise(resolve => {
        resolveAnimationGroupSelectedFn = resolve;
      });
      sinon.stub(view, 'animationGroupSelectedForTest').callsFake(() => resolveAnimationGroupSelectedFn());
