...
const BYTE_CELL_SELECTOR = '.memory-inspector-byte-cell';
const TEXT_CELL_SELECTOR = '.memory-inspector-text-cell';
const ROW_SELECTOR = '.memory-inspector-view-row';
const ADDRESS_SELECTOR = '.memory-inspector-view-address';

describe('LinearMemoryViewer', () => {
  let memory: number[];

  function setComponentData(component: LinearMemoryViewer) {
    memory = [];
