...
import {assertElement, assertElements, assertShadowRoot, getComponentElement, getEventPromise, renderElementIntoDOM} from '../helpers/DOMHelpers.js';
...
describe('LinearMemoryViewer', () => {
  ...
  it('switches page view when set addresses are not in same view', async () => {
    ...
    const addressInView = getComponentElement(component, VIEWER_ADDRESS_SELECTOR, HTMLSpanElement);
