...
Generated by https://github.com/ChromeDevTools/performance-stories/tree/main/lots-of-network-requests. Loads 50 images from the placeholder API and an extra script and stylesheet. Trace was recorded on slow 3G throttling, so some of the requests have not even finished.
