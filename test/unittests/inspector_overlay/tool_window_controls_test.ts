...
describe('WindowControlsOverlay', () => {
  ...
  it('shows mac toolbar', () => {
    ...
    assert.isTrue(!macToolbarRight.classList.contains('hidden'), 'Expect the right mac toolbar to be shown');
    assert.isTrue(!macToolbarLeft.classList.contains('hidden'), 'Expect the left mac toolbar to be shown');
  });
  ...
  it('show windows toolbar', () => {
    ...
    assert.isTrue(!windowsToolbar.classList.contains('hidden'), 'Expect windows toolbar to be shown');
  });
  ...
  it('show linux toolbar', () => {
    ...
    assert.isTrue(!linuxToolBar.classList.contains('hidden'), 'Expect linux toolbar to be shown');
  });
