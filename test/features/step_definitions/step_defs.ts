...
import {store, click, getBrowserAndPages, resetPages, resourcesPath, waitFor} from '../../shared/helper.js';
...
(async function() {
  ...
  const resetPages = async (opts: {enabledExperiments?: string[], selectedPanel?: {name: string, selector?: string}} = {}) => {
