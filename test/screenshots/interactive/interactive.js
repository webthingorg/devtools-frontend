...
function makeChoice(which) {
  ...
  leftImage.classList.toggle('selected', which === 'left');
  rightImage.classList.toggle('selected', which === 'right');
  enableConfirmButton();
}
...
leftImage.addEventListener('click', () => makeChoice('left'));
rightImage.addEventListener('click', () => makeChoice('right'));
