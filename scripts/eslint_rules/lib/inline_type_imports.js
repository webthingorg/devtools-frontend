      ...
      'Program:exit'() {
        ...
        for (const [typeImportFilePath, typeImportNode] of typeImports) {
          ...
          if (!valueImportNodeForFilePath) {
            // At this point we have just a type import and no matching file import, but we still want to convert the import so that each imported reference uses the type modifier:
