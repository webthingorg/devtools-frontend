...
const MANUALLY_MIGRATE_ERROR_ESSAGE = 'Please manually migrate this file manually.';
...
constructor(){
  ...
  const root = createShadowRootWithCoreStyles(this, 
    {cssFile: 'ui/legacy/smallBubbles.css', delegatesFocus: undefined});
}
}`,
      filename: 'front_end/components/test.ts',
      errors: [{message: MIGRATION_ERROR_MESSAGE}, {message: MIGRATION_ERROR_MESSAGE}],
      output: `import smallBubblesStyles from './smallBubbles.css.js';
...
constructor(){
  const shadow = createShadowRootWithCoreStyles(this, 
    {cssFile: smallBubbleStyles, delegatesFocus: undefined});
  const shadow = createShadowRootWithCoreStyles(this, 
    {cssFile: smallBubblesStyles, delegatesFocus: undefined});
}
}`
    },
    {
