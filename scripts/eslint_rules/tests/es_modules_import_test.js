...
ruleTester.run('es_modules_import', rule, {
  ...
  invalid: [
    ...
    // the `ls` helper is not an exception in a JS file
    {
      ...
      errors: [{
        message:
            `Incorrect cross-namespace import: "../common/ls.js". Use "import * as Namespace from '../namespace/namespace.js';" instead. You may only import ls.js directly from TypeScript source files.`
      }],
    },
  ]
});
