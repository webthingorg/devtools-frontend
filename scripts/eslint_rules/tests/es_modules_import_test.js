...
ruleTester.run('es_modules_import', rule, {
  ...
  invalid: [
    ...
    // third-party modules are not exempt by default
    {
      ...
      errors: [{
        message:
            `Incorrect cross-namespace import: "../third_party/some-module/foo.js". Use "import * as Namespace from '../namespace/namespace.js';" instead. If the third_party dependency does not allow this update es_modules_import.js to make it exempt.`
      }],
    },
  ]
});
