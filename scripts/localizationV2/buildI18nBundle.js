...
function bundleI18n(shouldMinify) {
    let i18nBundle = browserify('i18n.js', { standalone: 'i18n' });
    ...
    let i18nBundleStream = i18nBundle.bundle();
    let writeStream = fs.createWriteStream((outputPath));
    writeStream.on('finish', async err => {
        await patchLibrary(outputPath, /g\.i18n/gi, 'i18n');
        await patchLibrary(outputPath, /\(function\(f\){if\(typeof exports===\"object\"/gi, 'let i18n={};(function(f){if(typeof exports==="object"');
        await patchLibrary(outputPath, /{}\]},{},\[1\]\)\(1\)(\n|\r)?}\);/gi, '{}]},{},[1])(1)\n});export {i18n};');
    });
