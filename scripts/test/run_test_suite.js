...
function executeTestSuite({
  ...
  console.log('Running', argumentsForNode.join(' '));
  //console.log('ENV', process.env);

  const result = childProcess.spawnSync(nodePath(), argumentsForNode, {encoding: 'utf-8', stdio: 'inherit', env:process.env, cwd});
