...
def run_tests(chrome_binary, ninja_build_name, no_text_coverage):
...
def run_unit_tests_on_ninja_build_target(ninja_build_name, no_text_coverage=True):
    chrome_binary = None
    ...
    errors_found = run_tests(chrome_binary, ninja_build_name, no_text_coverage)
    if errors_found:
...
def main():
    ...
    run_unit_tests_on_ninja_build_target(args.ninja_build_name, args.no_text_coverage)
