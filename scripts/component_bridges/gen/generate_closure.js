...
exports.generateClosureBridge = exports.generateTypeReferences = exports.generateClosureClass =
    exports.generateCreatorFunction = void 0;
...
const generateClosureForInterface = (state, interfaceName) => {
  ...
  if (ts.isInterfaceDeclaration(typeReferenceNode)) {
    ...
    const unionTypeConverted =
        typeReferenceNode.type.types.map(v => value_for_type_node_js_1.valueForTypeNode(v)).join('|');
