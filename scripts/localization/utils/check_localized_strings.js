...
// During migration process, we will update this when a directory is migrated, and remove it when the migration process is done
const migratedDirsSet = new Set(['coverage', 'settings']);
