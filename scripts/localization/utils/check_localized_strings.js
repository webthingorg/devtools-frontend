...
const migratedDirsSet = new Set([
  'animation',    'changes',    'coverage',    'developer_resources', 'devices',          'help',   'layers',
  'layer_viewer', 'lighthouse', 'media',       'performance_monitor', 'protocol_monitor', 'search', 'security',
  'settings',     'snippets',   'text_editor', 'web_audio',           'webauthn',
]);
