...
/* if you're working on this file you might find
 * parses a TypeScript file to look for calls to an ls function
 * https://ts-ast-viewer.com/ useful for debugging
*/
...
/**
 * takes a matched node that calls `ls` and turns it into a GRDP match
 */
