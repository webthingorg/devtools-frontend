...
console.log(`
export function renderCompareText(rating: MetricRating, compare: CompareRating|undefined, options: {metric: string, localValue: Element}): Element {
  const values = {
    PH1: options.metric,
...
console.log(`
export function renderDetailedCompareText(localRating: MetricRating, fieldRating: MetricRating|undefined, options: {metric: string, localValue: Element, fieldValue: Element, percent: string}): Element {
  const values = {
    PH1: options.metric,
    PH2: options.localValue,
