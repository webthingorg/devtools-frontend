...
describe('use_theme_colors', () => {
  ...
  it('adds a disable line as the autofix', async () => {
    ...
    assert.strictEqual(output, 'p { color: #fff000; /* stylelint-disable-line plugin/use_theme_colors */ }');
  });
  ...
  it('autofixes for bad variable usage', async () => {
    ...
    assert.strictEqual(
        output, 'p { color: var(--not-a-variable); /* stylelint-disable-line plugin/use_theme_colors */ }');
  });
  ...
  fill: var(--color-primary);
    ...
    assert.strictEqual(output, `p {
  color: #fff; /* stylelint-disable-line plugin/use_theme_colors */
  background-color: var(--not-real); /* stylelint-disable-line plugin/use_theme_colors */
  fill: var(--color-primary);
}`);
  });
